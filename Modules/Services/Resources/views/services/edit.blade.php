    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {!! Form::model($item,['method'=>'POST','route'=>['services.submitedit',$item->service_id],'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 {{ $errors->has('service_code') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::text('service_code', null, ['class' => 'form-control m-input', 'placeholder' => 'Nhập mã dịch vụ']) !!}
