        ...
        <div class="m-portlet__body">
            <div class="row">
                <div class="col-lg-12" style="text-align: right;">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        {{--</li>--}}
                        <li class="nav-item">
                            <a class="nav-link active show" href="{{route('shift.time-working-staff.index-shift')}}">
                                @lang('Theo ca')
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div id="autotable">
                ...
                <div class="table-content m--padding-top-30">
                    @if ($number_day <= 6)
                        @include('shift::time-working-staff.shift.list')
                    @else
                        @include('shift::time-working-staff.shift.list-month')
                    @endif
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/shift/time-working-staff/list.js?v='.time())}}" type="text/javascript"></script>
    <script src="{{asset('static/backend/js/shift/shift/script.js?v='.time())}}" type="text/javascript"></script>
    <script>
        $(document).ready(function () {
            
            $('#autotable').PioTable({
                baseUrl: laroute.route('shift.time-working-staff.list-shift-index')
            });
