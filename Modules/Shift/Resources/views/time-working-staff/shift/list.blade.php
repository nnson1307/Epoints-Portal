<div class="table-responsive" style="min-height: 300px;">
    <table class="table table-bordered m-table">
        <thead class="bg">
        <tr>
            <th class="tr_thead_list">{{__('CA LÀM')}}</th>
        ...
        @if(isset($LIST))
            @foreach ($LIST as $k => $v)
                <tr>
                    <td style="width: 200px;" rowspan="{{count($v['staff']) > 0 ? count($v['staff']) + 1 : 2}}">
                        <div class="row">
                            ...
                            <td>
                                ...
                                {{-- <div class="row">
                                    <div class="col-lg-6" style="text-align: left;">
                                        <i class="la la-bank"></i> {{$v1['branch_name']}}
                                    </div>
                                    <div class="col-lg-6" style="text-align: right;">
                                        <i class="la la-home"></i> {{$v1['department_name']}}
                                    </div>
                                </div> --}}
                            </td>
                            @foreach($v1['day'] as $k2 => $v2)
                                @if ($v2 != null)
                                    ...
                                    <td class="is_shift"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9" style="text-align: left; padding: 0px 0px 0px 5px;">
                                                {{$v2['shift_name']}}
                                            </div>
                                            <span class="dropdown">
                                                <a href="javascript:void(0)"
                                        ...
                                        <div style="text-align: center;">
                                            @if (\Carbon\Carbon::parse($v2['working_day'].' '.$v2['working_time'])->format('Y-m-d H:i') <= \Carbon\Carbon::now()->format('Y-m-d H:i'))
