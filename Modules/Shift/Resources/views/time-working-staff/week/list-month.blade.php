<div class="table-responsive" style="min-height: 300px;">
    <table class="table table-bordered m-table" style="table-layout: fixed;">
        <thead class="bg">
        <tr>
            <th class="tr_thead_list" width="220px;">{{__('Nhân viên')}}</th>

            @if (count($listDay) > 0)
                @foreach($listDay as $v)
                    <th class="tr_thead_list text-center"
                        style="width: 160px; color: {{$v['is_holiday'] == 1 ? "#ff0000": ""}} !important;">
                            ...
                            @switch (count($v1))
                                ...
                                <td class="un_shift">
                                    <a href="javascript:void(0)"
                                       onclick="index.showModalShift('{{$v['staff_id']}}', '{{$k1}}', 'list', '{{$v['shift_id']}}', '{{$listDay[$k1]['is_holiday']}}')"
                                                ...
                                                <span class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if (in_array('shift.time-working-staff.show-pop-shift', session('routeList')))
                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                               onclick="index.showModalShift('{{$v['staff_id']}}', '{{$k1}}', 'list')">
