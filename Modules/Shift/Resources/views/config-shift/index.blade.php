    ...
    <div class="m-portlet">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{route('config-noti.edit')}}"
                   class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn_add_pc btn-sm">
                    <span>
                        <span> {{ __('Chỉnh sửa cấu hình') }}</span>
                    </span>
                </a>
            </div>
        </div>
                            ...
                            <tr class="block_{{$item['manage_config_notification_id']}}">
                                ...
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['sf_timekeeping_notification_id']}}][is_email]" {{$item['is_email'] == 1 ? 'checked' : ''}} value="0">
                                        <span></span>
                                    </label>
                                ...
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['sf_timekeeping_notification_id']}}][is_noti]" {{$item['is_noti'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                ...
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_active]" {{$item['is_active'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                </td>
