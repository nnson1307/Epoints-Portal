<div class="modal fade show" id="modal-staff">
    <div class="modal-dialog modal-dialog-centered modal-lg-email-campaign" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="fa fa-plus-circle"></i> {{__('CHỌN NHÂN VIÊN')}}
                </h5>
            </div>
            <div class="modal-body" id="autotable-staff-pop">
                ...
                <div class="table-content m--margin-top-30">
                    @include('shift::work-schedule.pop.list-staff')
                </div>
            </div>
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="submit" onclick="view.submitChooseStaff()"
