                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="work_schedule_name" name="work_schedule_name"
                                   placeholder="@lang("Ca cho dân hành chính")">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="m-radio-inline">
                                <label class="m-radio m-radio--bold m-radio--state-success">
                                    <input type="radio" name="repeat" value="hard" checked> @lang('Cố định')
                                    <span></span>
                                </label>
                                {{--<label class="m-radio m-radio--bold m-radio--state-success">--}}
                                    {{--<input type="radio" name="repeat" value="monthly"> @lang('Hàng tháng')--}}
                                    {{--<span></span>--}}
                                {{--</label>--}}
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="note" name="note" rows="5"
                                      placeholder="@lang('Nhập ghi chú')"></textarea>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control shift_id" style="width:100%;" onchange="view.changeShift(this)">
                                            <option></option>
                                ...
                                <div class="col-lg-6 form-group">
                                    <label>@lang('Chi nhánh làm việc'):<span class="required"><b
                                                    class="text-danger">*</b></span></label>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-2 form-group">
                            <a href="javascript:void(0)" onclick="view.removeObjectShift(this)" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill"
                               title="@lang('Xoá')">
