                            ...
                            <div class="col-lg-3 ss--col-xl-4 ss--col-lg-12 form-group">
                                ...
                                <select name="staff" style="width: 100%" id="staff"
                                    ...
                                    @foreach($optionStaff as $key => $value)
                                        @if(Auth::user()->is_admin !=1 )
                                            @if(Auth::user()->staff_id == $value['staff_id'])
                            ...
                            <div class="col">
                                <div class="card card-raised bg-secondary text-white">
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                <div class="display-5 text-white">{{__('KHÁCH HÀNG ĐĂNG KÝ MỚI')}}</div>
                                                <div class="card-text" id="totalCustomer"></div>
                                            </div>
                                            <div class="icon-circle bg-white-50 text-secondary">
                                    ...
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                ...
                                                <div class="card-text">
                                                    <a href="javascript:void(0)" onclick="reportSale.showModalListOrders('all');" style="color: #fff;">
                                    ...
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                ...
                                                <div class="card-text">
                                                    <a href="javascript:void(0)" onclick="reportSale.showModalListOrders('paid');" style="color: #fff;">
                                                        <span id="totalOrderPay"></span>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                ...
                                                <div class="card-text">
                                                    <a href="javascript:void(0)" onclick="reportSale.showModalListOrders('paid-half');" style="color: #fff;">
                                                        <span id="totalOrderPayhafl"></span>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                ...
                                                <div class="card-text">
                                                    <a href="javascript:void(0)" onclick="reportSale.showModalListOrders('not-paid');" style="color: #fff;">
                                                        <span id="totalOrderNotPay"></span>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body px-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="me-2">
                                                ...
                                                <div class="card-text">
                                                    <a href="javascript:void(0)" onclick="reportSale.showModalListOrders('cancel');" style="color: #fff;">
                                                        <span id="totalOrderCancel"></span>
                                                    </a>
                                                </div>
                                            </div>
                    ...
                    <div class="m-form m-form--label-align-right">
                        <div class="row">
                            <div class="col-lg-3 ss--col-xl-4 ss--col-lg-12 form-group">
                                ...
                                <select name="staff-chart" style="width: 100%" id="staff-chart"
                                        class="form-control m_selectpicker">
                                    @if(Auth::user()->is_admin ==1 )
                                        <option value="">{{__('Tất cả nhân viên')}}</option>
                                    @endif
                            ...
                            <div class="col-lg-3 ss--col-xl-4 ss--col-lg-12 form-group">
                                ...
                                <div class="m-input-icon m-input-icon--right" id="m_daterangepicker_6">
                                    <input readonly="" class="form-control m-input daterange-picker"
                                           id="time-chart" name="time-chart" autocomplete="off"
                                           placeholder="{{__('Từ ngày - đến ngày')}}">
                                    <span class="m-input-icon__icon m-input-icon__icon--right">
                                <span><i class="la la-calendar"></i></span></span>
                                </div>
                            ...
                            {{-- <div class="col-lg-3 ss--col-xl-4 ss--col-lg-12 form-group">
                                ...
                                <select name="department" style="width: 100%" id="department"
                                        class="form-control m_selectpicker">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 form-group" style="padding-top: 10px; padding-left: 30px;">
                                                ...
                                                <div class="m-radio-inline">
                                                    <label class="m-radio">
                                                        <input type="radio" name="example_3" value="amount" onclick="reportSale.changeReportChartType(this);" checked> Theo doanh số
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio">
                                                        <input type="radio" name="example_3" value="receipt" onclick="reportSale.changeReportChartType(this);"> Theo doanh thu
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio">
                                                        <input type="radio" name="example_3" value="dept" onclick="reportSale.changeReportChartType(this);"> Theo công nợ
                                                        <span></span>
                                                    </label>
                                                </div>
                            ...
                            <div class="col-md-12 col-lg-6 form-group">
                                <div class="m-portlet ">
                                    <div class="m-portlet__body m-row--no-padding m-portlet__body--no-padding">
                                        <div class="row">
                                            <div class="col-lg-12 form-group" style="padding-top: 10px; padding-left: 30px;">
                                                <h3>{{__('Báo cáo bán hàng theo nhân viên')}}</h3>
                            ...
                            <div class="col-md-12 col-lg-6 form-group">
                                <div class="m-portlet ">
                                    <div class="m-portlet__body m-row--no-padding m-portlet__body--no-padding">
                                        <div class="row">
                                            <div class="col-lg-12 form-group" style="padding-top: 10px; padding-left: 30px;">
                                                <h3>{{__('Báo cáo số lượng đơn hàng xem theo chi nhánh')}}</h3>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report-sale/staff/script.js?v='.time())}}"></script>
@stop
