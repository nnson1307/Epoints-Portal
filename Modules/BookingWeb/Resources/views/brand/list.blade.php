<div class="row">
    @foreach($brand as $value)
        <div class="col-12">
            <div class="row">
                <div class="col-3">
{{--                    <img class="img-service" src="{{$value['avatar']}}">--}}
                    <img class="img-service" src="{{$value['avatar'] != null ? $value['avatar'] : asset('static/booking-template/image/default-placeholder.png')}}">
                </div>
                <div class="col-9 text-brand">
                    <p><strong>{{$value['branch_name']}}</strong></p>
                    <p><i class="fas fa-map-marker-alt"></i>  {{$value['address']}}</p>
                    <p><i class="fas fa-phone"></i>  {{$value['phone']}}</p>
