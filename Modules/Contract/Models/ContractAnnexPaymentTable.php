...
class ContractAnnexPaymentTable extends Model
{
    protected $table = "contract_annex_payment";
    protected $primaryKey = "contract_annex_payment_id";
    protected $fillable = [
        "contract_annex_payment_id",
        "contract_annex_id",
        "total_amount",
        "tax",
        "discount",
    ...
    public function getInfo($contractAnnexId)
    {
        return $this
            ->select(
                "{$this->table}.contract_annex_payment_id",
