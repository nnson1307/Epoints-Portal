            ...
            @foreach ($LIST as $key => $item)
                <tr class="tr-goods tr-goods-same">
                    <td class="td_action_{{$key+1}}">
                        ...
                        <button onclick="$(this).closest('.tr-goods').remove()"
{{--                                onclick="contractGoods.removeGoods(this)"--}}
...
@if($isReceipted != 1)
<button type="button" class="btn btn-outline-info btn-sm m-btn m-btn--custom btn-add-good-remove" onclick="contractGoods.addGoods()">
