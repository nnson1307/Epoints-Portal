        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row padding_row" style="padding-bottom: 10px;">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                                   id="file_excel" onchange="listContract.fileName()" type="file" style="display: none">
                        </div>
                    </div>
                </div>
                <div class="form-group m-form__group">
                    <a href="{{asset('static/backend/file/file_mau_hop_dong.xlsx')}}"
                ...
                <div class="form-group m-form__group export_error" style="display: none;">
                    <form id="form-error" action="{{route('contract.contract.export-error')}}" method="POST">
                        {{ csrf_field() }}
                        <div id="data_error">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="submit"
                            onclick="listContract.importExcel()"
