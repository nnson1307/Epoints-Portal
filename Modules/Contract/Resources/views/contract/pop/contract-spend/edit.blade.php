<div class="modal fade show" id="modal-edit-spend" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="fa fa-plus-circle"></i>
                    @lang('CHỈNH SỬA ĐỢT CHI')
                </h5>
            </div>
                ...
                <form id="form-edit">
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input" id="content_spend" name="content_spend" value="{{$item['content']}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group m-form__group col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input date_picker" readonly=""
                                       ...
                                       value="{{\Carbon\Carbon::parse($item['spend_date'])->format('d/m/Y')}}">
                                ...
                                <select class="form-control select" id="spend_by" name="spend_by"
                                    ...
                                    @foreach($optionStaff as $v1)
                                        <option value="{{$v1['staff_id']}}"
                                                {{$item['spend_by'] == $v1['staff_id'] ? 'selected': ''}}>{{$v1['staff_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input input_float" id="amount_spend" name="amount_spend"
                                       value="{{number_format($item['amount_spend'], isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group col-lg-6">
                            <label class="black_title">
                                ...
                                <select class="form-control select" id="payment_method_spend_id" name="payment_method_spend_id"
                                    ...
                                    @foreach($optionPaymentMethod as $v1)
                                        <option value="{{$v1['payment_method_id']}}"
                                                {{$item['payment_method_id'] == $v1['payment_method_id'] ? 'selected': ''}}>{{$v1['payment_method_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group m-form__group col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input date_picker" readonly=""
                                       id="invoice_date" name="invoice_date" value="{{\Carbon\Carbon::parse($item['invoice_date'])->format('d/m/Y')}}">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i
                                                class="la la-calendar-check-o glyphicon-th"></i></span>
                                </div>
                        ...
                        <div class="form-group m-form__group col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input" id="invoice_no" name="invoice_no" value="{{$item['invoice_no']}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" cols="3" id="note_spend" name="note_spend">{{$item['note_spend']}}</textarea>
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <div id="contract_revenue_files" class="row">
                            @if (count($spendFile) > 0)
                                @foreach($spendFile as $v)
                                    <div class="col-lg-12">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="button" onclick="contractSpend.edit('{{$item['contract_spend_id']}}')"
