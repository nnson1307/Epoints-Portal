<div class="modal fade show" id="modal-create-receipt" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-register">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <select class="form-control select" id="payment_method_receipt_id" name="payment_method_receipt_id"
                    ...
                    <div class="form-group div_append_payment_method"></div>
                    <div class="row">
                        <div class="form-group m-form__group col-lg-6">
                            <label class="black_title">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" cols="3" id="note_receipt" name="note_receipt"></textarea>
                        </div>
                    </div>
                    <div class="form-group m-form__group">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="button" onclick="contractReceipt.create()"
