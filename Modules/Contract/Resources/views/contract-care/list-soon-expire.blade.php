        ...
        <tr>
            <th class="tr_thead_list">
                <label class="m-checkbox m-checkbox--bold m-checkbox--state-success m--padding-top-5">
                    <input class="check_all" name="check_all" type="checkbox" onclick="expireContract.chooseAll(this, 'soon-expire')">
                    <span></span>
                </label>
            </th>
                        ...
                        <label class="m-checkbox m-checkbox--bold m-checkbox--state-success m--padding-top-5">
                            @if($item['care_status'] == 'new')
                                <input class="check_one"
                                       ...
                                       {{isset($arrContractSoonExpire[$item['contract_code']]) ? 'checked' : ''}}
                                       onclick="expireContract.choose(this, 'soon-expire')">
                                <span></span>
                            @else
                                <input class=""
                                       disabled
