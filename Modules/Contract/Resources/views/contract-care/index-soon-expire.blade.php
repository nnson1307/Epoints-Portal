...
@section('content')
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h2 class="m-portlet__head-text title_index">
                        <span><i class="fas fa-cog"></i> {{__('CHĂM SÓC HỢP ĐỒNG SẮP HẾT HẠN')}}</span>
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                <a href="javascript:void(0)" onclick="expireContract.perform('soon-expire')"
        ...
        <div class="m-portlet__body" id="autotable-soon-expire">
            ...
            <div class="table-content m--padding-top-15">
                @include('contract::contract-care.list-soon-expire')
