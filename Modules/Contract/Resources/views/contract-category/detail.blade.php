            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h2 class="m-portlet__head-text title_index">
                        <span><i class="fas fa-plus"></i> {{__('CHI TIẾT LOẠI HỢP ĐỒNG')}}</span>
                    </h2>
                </div>
            </div>
                    ...
                    <form id="form-create-cc" class="col-lg-3 form-group">
                            <div class="col-lg-12 row">
                                ...
                                <div class="form-group col-lg-3 float-right">
                                    ...
                                    <label style="margin: 0 0 0 10px">
                                        <input type="checkbox" disabled {{$item['is_actived'] == 1 ? 'checked' : ''}} class="manager-btn" name="is_actived" id="is_actived">
                                        <span></span>
                                    </label>
                                    </span>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input aria-describedby="basic-addon1" disabled
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control select" disabled  name="type_contract" id="type_contract" style="width: 100%">
