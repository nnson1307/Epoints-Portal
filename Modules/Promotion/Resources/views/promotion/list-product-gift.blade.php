                ...
                <tr>
                    ...
                    <td style="width:25%;">
                        <select class="form-control gift_object_id" style="width:100%;" {{$item['gift_object_type'] == null ? 'disabled' : ''}}
                                onchange="view.changeGift(this, '{{$item['object_code']}}')">
                            <option></option>
                    ...
                    <td>
                        <a href="javascript:void(0)" onclick="view.removeTr(this, '{{$item['object_code']}}', 'gift', '{{$item['object_type']}}')"
