...
<div class="col-lg-8 parent-col-style" style="overflow-y: scroll;height: 50%;max-height: 600px">
...
<div class="m-form__actions m--align-right col-lg-12 float-right">
    ...
    <button type="button" onclick="editDashboard(event)"
...
<script type="text/javascript">
    ...
    function editDashboard(e) {
        ...
        $.ajax({
            url: laroute.route('dashbroad.dashboard-config.edit-dashboard'),
            method: 'POST',
            dataType: 'JSON',
            data: {
    ...
    function drop(a, e) {
        ...
        console.log(data,currCol, $(a).attr('data-component-type') == $(`#${data}`).attr('data-widget-type'), currCol + parseInt($(`#${data}`).attr('data-col')) <= 12);
