    ...
    <div class="modal-content">
        ...
        <form class="modal-body">
            <div class="form-group m-form__group">
                ...
                <select name="department_id" class="form-control select2 select2-activ">
            ...
            <div class="form-group m-form__group">
                ...
                <div class="d-flex">
                    <label class="m-radio cus mr-3">
                        <input type="radio" name="type_view" value="kd" checked>{{ __('Kinh doanh') }}
                        <span></span>
                    </label>
                    <label class="m-radio cus">
                        <input type="radio" name="type_view" value="kt">{{ __('Kỹ thuật') }}
                        <span></span>
                    </label>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="input-group mr-3">
                                ...
                                <input type="text" name="partner_new" class="form-control percent-format"
                                    placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="partner_renew" class="form-control percent-format"
                                    placeholder="0">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
            ...
            <div class="form-group m-form__group">
                ...
                <div class="input-group">
                    <input type="text" name="installation_commission" class="form-control format-percent" placeholder="0">
                    <div class="input-group-append">
                        <span class="input-group-text">%</span>
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" onclick="SalaryCommissionConfig.addClose()"
