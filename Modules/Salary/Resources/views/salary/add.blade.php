    ...
    <form class="modal-body" id="addForm">
        <div class="form-group m-form__group">
            ...
            <div class="input-group date">
                <input type="text" class="form-control m-input month-picker-time-now"
                       placeholder="@lang('Chọn kỳ lương')" name="salary_period"
                       value="6/2000" autocomplete="off">
        ...
        <div class="form-group m-form__group">
            ...
            <div class="input-group date date-multiple">
                <input type="text" class="form-control m-input daterange-input" readonly
                       placeholder="@lang('Thời gian')" name="time">
                <div class="input-group-append">
        ...
        <div class="form-group m-form__group">
            ...
            <input type="text" name="name" class="form-control m-input"
                placeholder="{{ __('Nhập tên bảng lương') }}...">
        </div>
    ...
    <div class="modal-footer">
        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
            <div class="m-form__actions m--align-right">
                ...
                <button type="button" onclick="Salary.addClose()"
