<div id="modal-survey">
    <div class="modal fade" id="continue_survey" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-modal="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group kt-margin-b-10">
                        <h6 class="title">@lang('Xác nhận tiếp tục chương trình')</h6>
                        <p class="description">
                            {{ __('Khi xác nhận tiếp tục chương trình, chương trình sẽ được hoạt động cho đến khi kết thúc?') }}
                        </p>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="survey.changeStatus('{{ $detail['survey_id'] }}', 'continue')"
