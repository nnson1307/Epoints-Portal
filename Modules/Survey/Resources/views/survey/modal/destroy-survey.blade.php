<div id="modal-survey">
    <div class="modal fade" id="destroy_survey" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-modal="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group kt-margin-b-10">
                        <h6 class="title">@lang('Bạn có muốn xóa khảo sát không?')</h6>
                        <p class="description">
                            {{__("Khi khảo sát bị xóa, bạn sẽ không thể khôi phục lại được. Bạn có chắc chắn muốn xóa khảo sát này không?")}}</p>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="survey.destroy({{ $detail['survey_id'] }})"
