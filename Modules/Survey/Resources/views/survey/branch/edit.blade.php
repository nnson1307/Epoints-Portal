...
@section('after_style')
    <style>
        ...
        #itemGroupCustomerSeleted {
            display: flex;
            position: relative;
        }
        #itemGroupCustomerSeleted i {
            position: absolute;
            top: 2px;
            right: 2px;
            cursor: pointer;
...
@section('content')
    <div class="m-portlet  m-portlet--head-sm">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{ route('survey.index') }}" class="btn btn-primary color_button btn-search ml-2">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body">
                ...
                <div class="form-group">
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            ...
                            <label class="m-radio cus  mb-4">
                                <input type="radio" 
                                name="type_apply"
                                {{$detail->type_apply == 'customers' || $typeShowModalCustomerGroup != '' ? 'checked' : ''}} 
                                 onclick="branch.toggleApplyUser(this)"
                                    class="object_apply" 
                    ...
                    <div class="row form-group">
                        <div class="list_customer-button" style="display: none">
                            <div class="col-12 d-flex" style="gap:50px">
                                @php
                                $idCustomerGroupAuto = !empty($itemCustomerFilter) ? $itemCustomerFilter->id : '';
                                @endphp
                                <button onclick="branch.renderModalCustomerAuto({{$id}})" type="button"
                                    class="
                                btn btn-primary 
                            ...
                            <div class="col-12">
                                <button type="button" onclick="branch.renderModalCustomer()"
                                    class="
                                btn btn-primary 
                                color_button btn-search 
                                btn-store">
                        ...
                        <div class="list_staff-button row"  style="display: none">
                            ...
                            <div class="col-12">
                                <button onclick="branch.renderModalStaff()" type="button"
                                    class="
                                btn btn-primary 
                                color_button btn-search 
                                btn-store">
                    ...
                    <div class="list_apply">
                        <div class="list_customer-apply" style="display: none">
                            <div class="row list-search">
                                ...
                                <div class="col-3 form-group">
                                    <select class="form-control  ss-select2" style="width: 100%" id="customer_group" name="customer_group">
                                ...
                                <div class="col-3 form-group">
                                    <select class="form-control ss-select2" style="width: 100%" id="customer_source" name="customer_source">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <button type="button" onclick="branch.resetSearchItemSelectedCustomer()"
                                        class="btn btn-primary color_button kt-margin-r-5 color_button_destroy  btn-search"
    ...
    @include('survey::branch.popup.staff_auto')
@endsection
@section('after_script')
    <script>
        const UNIQUE = "{{ $unique }}";
        const IS_SHOW = 0;
        const TYPE_SHOW_CUSTOMER_GROUP = '{{$typeShowModalCustomerGroup}}'
    </script>
