        ...
        <tr>
            <th class="tr_thead_list" style="width: 20px">
                <label class="kt-checkbox kt-checkbox--bold">
                    <input type="checkbox" onclick="branch.checkedAllItemCustomer(this)">
                    <span></span>
                </label>
            </th>
                    ...
                    <td>
                        <label class="kt-checkbox kt-checkbox--bold">
                            <input class="checkbox_item" type="checkbox"
                                onclick="branch.checkedOneItemCustomer(this, '{{ $item['customer_id'] }}')"
                                {{ isset($itemTemp[$item['customer_id']]) ? 'checked' : '' }}>
                            <input type="hidden" value="{{ $item['customer_id'] }}" class="item_id">
                            <span></span>
                        </label>
                    </td>
...
@if (isset($list))
    {{ $list->links('survey::branch.helpers.paging-customer-popup') }}
@endif
