...
class SurveyAnswerQuestionTable extends Model
{
    ...
    /**
     * lấy danh sách câu trả lời theo phiên câu trả lời 
     * @param $listIdAnswer
     * @return mixed
     */

    public function getListAnswerQuestionByIdAnswer($listIdAnswer = [])
    {
        return $this->whereIn('survey_answer_id', $listIdAnswer)->get();
    }
}
