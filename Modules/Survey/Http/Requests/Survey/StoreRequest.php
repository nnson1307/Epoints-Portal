...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'survey_code' => 'required|regex:/(^[A-Za-z0-9]+$)+/|unique:survey,survey_code,null,survey_id,is_delete,0',
        ];
    ...
    public function messages() {
        ...
        // Số khảo sát trên mỗi cửa hàng tối đa -  Số khảo sát trên mỗi cửa hàng tối đa
        if (isset($params['config_turn']) && $params['config_turn'] == '1') {
            $messages['max_times.required'] = __('Vui lòng nhập số khảo sát trên mỗi cửa hàng tối đa.');
            $messages['max_times.numeric'] = __('survey::validation.branch_max_times_min');
