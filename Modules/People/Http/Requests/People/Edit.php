...
class Edit extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $arrValidate = [
            ...
            'code' => "required|max:15|unique:people,code,{$people_id},people_id,is_deleted,0",
            'birthday' => 'required|date_format:d/m/Y|before:now',
            'gender' => 'required',
            'temporary_address' => 'required|max:191',
            'permanent_address' => 'required|max:191',
            'id_number' => "nullable|min:9|max:12|regex:/^[0-9]+$/|unique:people,id_number,{$people_id},people_id,is_deleted,0",
    ...
    public function filters()
    {
        return [
            ...
            'birthday' => 'strip_tags|trim',
            'id_license_date' => 'strip_tags|trim',
            'temporary_address' => 'strip_tags|trim',
            'permanent_address' => 'strip_tags|trim',
            'hometown' => 'strip_tags|trim',
            'birthplace' => 'strip_tags|trim',
            'ethnic_id' => 'strip_tags|trim',
            'id_number' => 'strip_tags|trim',
            'elementary_school' => 'strip_tags|trim',
            'middle_school' => 'strip_tags|trim',
            'high_school' => 'strip_tags|trim',
            'from_18_to_21' => 'strip_tags|trim',
            'from_21_to_now' => 'strip_tags|trim',
            'union_join_date' => 'strip_tags|trim',
            'group_join_date' => 'strip_tags|trim',
            'specialized' => 'strip_tags|trim',
            'foreign_language' => 'strip_tags|trim',
        ];
    }
}