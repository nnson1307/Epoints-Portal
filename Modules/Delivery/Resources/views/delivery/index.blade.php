...
@section('title_header')
    <span class="title_header"><img
                ...
                style="height: 20px;"> @lang('QUẢN LÝ ĐƠN HÀNG CẦN GIAO')</span>
@stop
@section('content')
    <style>
        .modal-backdrop {
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang("DANH SÁCH ĐƠN HÀNG CẦN GIAO")
                    </h2>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search"
                                       placeholder="@lang("Nhập tên khách hàng hoặc mã đơn hàng")">
                            </div>
                        </div>
                ...
                <div class="table-content m--padding-top-30">
                    @include('delivery::delivery.list')
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    <script src="{{asset('static/backend/js/delivery/delivery/list.js?v='.time())}}" type="text/javascript"></script>
