...
@section('title_header')
    <span class="title_header"><img
                ...
                style="height: 20px;"> @lang('QUẢN LÝ NHÂN VIÊN GIAO HÀNG')</span>
@stop
@section('content')
    <style>
        .modal-backdrop {
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang("DANH SÁCH NHÂN VIÊN GIAO HÀNG")
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('user-carrier.create',session('routeList')))
                    <a href="{{route('user-carrier.create')}}"
                       class="btn btn-primary m-btn btn-sm color_button m-btn--icon m-btn--pill btn_add_pc">
                                    <span>
                                        <i class="fa fa-plus-circle"></i>
                                        <span> @lang('THÊM NHÂN VIÊN GIAO HÀNG')</span>
                                    </span>
                    </a>
                    <a href="{{route('user-carrier.create')}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search"
                                       placeholder="@lang("Nhập tên nhân viên hoặc số điện thoại")">
                ...
                <div class="table-content m--padding-top-30">
                    @include('delivery::user-carrier.list')
                </div>
            </div>
        </div>
    </div>
