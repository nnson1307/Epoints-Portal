...
@section('title_header')
    <span class="title_header"><img
                ...
                style="height: 20px;"> @lang('QUẢN LÝ ĐỊA CHỈ LẤY HÀNG')</span>
@stop
@section('content')
    <style>
        .modal-backdrop {
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search"
                                       placeholder="@lang("Nhập địa chỉ hoặc mã địa chỉ")">
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                ...
                <div class="table-content m--padding-top-30">
                    @include('delivery::pickup-address.list')
                </div>
            </div>
        </div>
    </div>
