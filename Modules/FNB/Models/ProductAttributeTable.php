...
class ProductAttributeTable extends Model
{
    ...
    protected $fillable = ['product_attribute_id', 'product_attribute_group_id',
        'product_attribute_label', 'product_attribute_code', 'created_by', 'updated_by','product_attribute_label_en','slug_en',
    ...
    public function getNameAttribute($arrAttributeId){
        return $this
            ->select(
                ...
                'product_attribute_groups.product_attribute_group_name'
            )
            ->join('product_attribute_groups','product_attribute_groups.product_attribute_group_id',$this->table.'.product_attribute_group_id')
            ->whereIn($this->table.'.product_attribute_id',$arrAttributeId)
            ->get();
    }
}