...
class OrderDetailTable extends Model
{
    ...
    public function getItem($id)
    {
        ...
        $ds = $this
            ->select(
                ...
                'order_details.note',
                'order_details.order_detail_id_parent',
    ...
    public function getListByOrderId($orderId){
        return $this
            ...
            ->whereNull($this->table.'.order_detail_id_parent')
            ->get();
    }

    public function getListFullByOrderId($orderId){
        return $this
            ->where($this->table.'.order_id',$orderId)
            ->get();
    }

    public function getListFullByOrderArrId($orderIdArr){
        return $this
            ->whereIn($this->table.'.order_id',$orderIdArr)
            ->get();
    }
