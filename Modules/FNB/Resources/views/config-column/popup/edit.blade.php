    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="    max-width: 700px;">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="title">CHỈNH SỬA KHU VỰC</h2>
                ...
                <div class="modal-body">
                    ...
                    <div class="note-plus">
                        <div class="form-group m-form__group">
                            <select class="form-control select2" id="branch" style="    width: 350px;"
                    ...
                    <div class="toggle-status">
                        <span class="note-font">Trạng thái:</span>
                        <label class="switch">
                            <input type="checkbox">
                            <span class="slider round"></span>
                        </label>
                        <span class="note-font">(Chọn để kích hoạt trạng thái)</span>
                    </div>
                </div>
            </form>
