    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="    max-width: 700px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="title" style="    color: #0067AC">{{__('THÊM KHU VỰC')}}</h2>
                                ...
                                <div class="form-group m-form__group" style="margin-bottom: 5px">
                                    <div class="input-group">
                                        <input id="config_content" name="name" type="text"
                                               class="form-control m-input class"
                                               placeholder='{{__('Nhập tên khu vực')}}'
                                               value=""
                                               aria-describedby="basic-addon1">
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="areas.saveNewAreas()">
