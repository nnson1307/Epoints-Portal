                                ...
                                <div>
                                    ...
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                        <label style="margin: 0 0 0 10px; padding-top: 4px">
                                            <input type="checkbox" disabled {{$detail['is_request_location'] == 1 ? 'checked' : ''}} class="manager-btn is_request_location" name="is_request_location">
                                            <span></span>
                                        </label>
                                    </span>
                                                </div>
                                        ...
                                        <div class="col-12 form-group expire_type is_request_location_block" style="display: {{$detail['is_request_location'] == 1 ? 'block' : 'none'}}">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-8">
                                                    <p class="mb-0">{{$detail['location_lat']}}</p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-3 offset-1 d-flex align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <p class="mb-0">{{$detail['location_lng']}}</p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-3 offset-1 d-flex align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <p class="mb-0">{{$detail['location_radius']}}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 form-group">
                                    ...
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                        <label style="margin: 0 0 0 10px; padding-top: 4px">
                                            <input type="checkbox"  class="manager-btn is_request_wifi" {{$detail['is_request_wifi'] == 1 ? 'checked' : ''}} disabled name="is_request_wifi" style="display: {{$detail['is_request_wifi'] == 1 ? 'checked' : ''}}">
                                            <span></span>
                                        </label>
                                    </span>
                                                </div>
...
{{--                                                    <input type="text" class="form-control" name="wifi_name" placeholder="{{__('Nhập tên wifi')}}">--}}
                                                    <p class="mb-0">{{$detail['wifi_name']}}</p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-3 offset-1 d-flex align-items-center">
                                        ...
                                        <div class="col-12 form-group">
                                            <form id="search-table">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <input type="text" name="search_created_at" onchange="configColumn.searchTable()" class="form-control daterange_picker_search" placeholder="{{__('Chọn thời gian')}}">
                                                    </div>
                                                    <div class="col-4">
                                                        <select class="form-control" name="search_table_id" onchange="configColumn.searchTable()">
                                                            <option value="">{{__('Chọn bàn')}}</option>
                                                            @foreach($listTable as $item)
                                                                <option value="{{$item['table_id']}}">{{$item['name']}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-5 block-shadow">
                        <div class="row ">
                            <div class="col-12 bg mb-3">
                                <p class="mb-0 pt-2 pb-2"><strong>{{__('Ảnh QR Code')}}</strong></p>
                            </div>
                            <div class="col-12">
                                <div class="row box-qr-code-download" id="box-qr-code-download">
