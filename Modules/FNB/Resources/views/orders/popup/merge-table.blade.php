...
<!-- Modal -->
<div class="modal fade" id="merge-table" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-1000 " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="title">GỘP BÀN</h2>
            ...
            <div class="modal-body">
                ...
                <div class="table-to">
                    <span class="note-font" style="    margin-top: 12px;margin-right: 20px;">Gộp đến bàn:</span>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="order.submitMergeTable()">
