    ...
    <div class="m-portlet m-portlet--head-sm">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <form action="{{route('fnb.orders.export-list')}}" method="post">
                    {{ csrf_field() }}
                    <button type="submit"
...
{{--                @endif--}}
                        ...
                        <div class="m-form m-form--label-align-right">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <a href="{{route('fnb.orders')}}" class="btn btn-refresh btn-primary color_button m-btn--icon mr-3">
                                        {{ __('XÓA BỘ LỌC') }}
    ...
    <form id="form-order-ss" target="_blank" action="{{route('fnb.orders.print-bill-not-receipt')}}" method="GET">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/fnb/order/index.js?v='.time())}}" type="text/javascript"></script>
    <script src="{{asset('static/backend/js/fnb/order/print-bill.js?v='.time())}}" type="text/javascript"></script>
    <script src="{{asset('static/backend/js/fnb/order/cancel.js?v='.time())}}" type="text/javascript"></script>
