    <div class="modal fade" id="popup-quota-add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content clear-form">
                ...
                <div class="modal-body">
                    <form id="frm-add-estimate">
                        <input type="hidden" id="branch_id" name="branch_id" value="{{ $branchId }}">
                        <div class="row">
                            <label class="form-check-label m-checkbox m-checkbox--air">
                                            <input type="checkbox" name="is_approve_week" value="1" id="is_approve_week" onclick="estimate.checkWeek(this);" checked>
                                            <span></span>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <select class="form-control" name="week[select_from]" id="selectWeekFrom" style="width: 100%">
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <select class="form-control" name="week[select_to]" id="selectWeekTo" style="width: 100%>
                                            @for($i = 1; $i <= $weeksInYear; $i++)
                                                @php
                                                    $week = Modules\Estimate\Libs\help\Help::getStartEndDateOfWeek($i);
                                                @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="week-estimate-money" name="week[estimate_money]" aria-describedby="basic-addon2" autocomplete="off">
                                            <div class="input-group-append">
                        ...
                        <div class="row">
                            <label class="form-check-label m-checkbox m-checkbox--air">
                                <input type="checkbox" name="is_approve_month" value="1" id="is_approve_month" onclick="estimate.checkMonth(this);">
                                <span></span>
                                <div class="pt-1"><b>{{ __('Theo tháng') }}</b></div>
                            </label>
                        </div>
                        <div class="row month-content" style="display:none">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-2 form-group">
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <select class="form-control" name="month[select_from]" id="selectMonthFrom" style="width:100%">
                                            @for($i = 1; $i <= 12; $i++)
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <select class="form-control" name="month[select_to]" id="selectMonthTo" style="width:100%">
                                            @for($i = 1; $i <= 12; $i++)
                                                <option value="{{ $i }}">{{ __('Tháng') }} {{ $i .'/'. \Carbon\carbon::now()->year}}</option>
                                            @endfor
                                        </select>
