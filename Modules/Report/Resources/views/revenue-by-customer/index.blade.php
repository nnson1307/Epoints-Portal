            ...
            <div class="m-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        @if(in_array('admin.report-revenue.customer.export-total', session()->get('routeList')))
                            <form action="{{route('admin.report-revenue.customer.export-total')}}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <input type="hidden" id="export_number_customer_total" name="export_number_customer_total">
                                <input type="hidden" id="export_customer_id_total" name="export_customer_id_total">
                        ...
                        @endif
                        @if(in_array('admin.report-revenue.customer.export-detail', session()->get('routeList')))
                            <form action="{{route('admin.report-revenue.customer.export-detail')}}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <input type="hidden" id="export_number_customer_detail" name="export_number_customer_detail">
                                <input type="hidden" id="export_customer_id_detail" name="export_customer_id_detail">
                                <button type="submit"
                                        class="btn btn-info btn-sm m-btn m-btn--icon m-btn--pill color_button m--margin-right-10">
                                        <span>
                                            <i class="la la-files-o"></i>
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-form m-form--label-align-right">
                        <div class="row">
                            <div class="col-lg-3 ss--col-xl-3 ss--col-lg-12 form-group">
                            ...
                            <div class="col-lg-3 ss--col-xl-3 ss--col-lg-12 form-group">
                                <select name="number_customer" style="width: 100%" id="number_customer"
                                        class="form-control m_selectpicker">--}}
                                    <option value="">{{__('Giới hạn khách hàng')}}</option>
                            ...
                            <div class="col-lg-3 ss--col-xl-3 ss--col-lg-12 form-group">
                                <select name="customer_id" style="width: 100%" id="customer_id"
                                        class="form-control m_selectpicker">--}}
                        ...
                        <div class="m--margin-top-5" id="" style="">
                            ...
                            <div id="autotable">
                                <form class="frmFilter">
                                    ...
                                    <input type="hidden" id="number_customer_detail" name="number_customer_detail">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/revenue/by-customer/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        $('#customer_id').select2();
        revenueByCustomer._init();
    </script>
@stop
