    ...
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{__('THỐNG KÊ CHI NHÁNH')}}
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('admin.report-growth.branch.export-total', session()->get('routeList')))
                    <form action="{{route('admin.report-growth.branch.export-total')}}" method="POST">
                        {{ csrf_field() }}
                ...
                @endif
                @if(in_array('admin.report-growth.branch.export-detail', session()->get('routeList')))
                    <form action="{{route('admin.report-growth.branch.export-detail')}}" method="POST">
                        {{ csrf_field() }}
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group m--margin-top-10">
                <div id="chart-growth-branch" style="min-width: 280px; height: 350px;"></div>
    ...
    <div class="form-group m-form__group row m--font-bold align-conter1">
        <div class="col-lg-4">
            <div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
                ...
                <div id="pie-chart-service-card-group"
                     style="min-width: 290px; height: 290px; max-width: 290px; margin: 0 auto"></div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
                <div class="form-group m-form__group ss--margin-bottom-0">
                    <label class="m--margin-top-20 ss--text-center ss--font-weight-400">
                        {{__('TỈ LỆ SỬ DỤNG THẺ DỊCH VỤ')}}
                    </label>
                </div>

                <div id="pie-chart-use-service-card"
                     style="min-width: 290px; height: 290px; max-width: 290px; margin: 0 auto"></div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="m-portlet m-portlet--bordered-semi m-portlet--full-height ">
                <div class="form-group m-form__group ss--margin-bottom-0">
                    <label class="m--margin-top-20 ss--text-center ss--font-weight-400">
                        {{__('TỈ LỆ SỬ DỤNG VOUCHER')}}
                    </label>
                </div>

                <div id="pie-chart-use-voucher"
                     style="min-width: 290px; height: 290px; max-width: 290px; margin: 0 auto"></div>
            </div>
        </div>
    </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/statistics/by-branch/script.js')}}"
            type="text/javascript"></script>
    <script>
        statisticBranch._init();
    </script>
@endsection
