    ...
    <div class="m-portlet m-portlet--head-sm">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang('BÁO CÁO DỰA TRÊN POSTCODE')
                    </h2>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            <div class="form-group row">
                ...
                <div class="col-xl-3 ss--col-xl-4 ss--col-lg-12 form-group">
                    <select class="form-control" id="delivery_cost" name="delivery_cost">
                        @foreach($optionDeliveryCost as $value)
                            <option value="{{$value['delivery_cost_code']}}">{{$value['delivery_cost_name']}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/base-on-postcode/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        reportPostcode._init();
    </script>
@stop
