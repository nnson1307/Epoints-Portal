...
{{--                @if(in_array('admin.report-revenue.service-group.export-total', session()->get('routeList')))--}}
                    <form action="{{route('admin.report-revenue.service-group.export-total')}}" method="POST">
                        {{ csrf_field() }}
...
{{--                @endif--}}
{{--                @if(in_array('admin.report-revenue.service-group.export-detail', session()->get('routeList')))--}}
                    <form action="{{route('admin.report-revenue.service-group.export-detail')}}" method="POST">
                        {{ csrf_field() }}
...
{{--                @endif--}}
        ...
        <div class="m-portlet__head">
            <ul class="nav nav-tabs m-0 align-items-center">
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.report-revenue.service-group')}}">{{__('Theo nhóm dịch vụ')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.report-revenue.service')}}">{{__('Theo dịch vụ')}}</a>
                </li>
            </ul>
        </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/revenue/by-service-group/script.js')}}"
            type="text/javascript"></script>
    <script>
        revenueByServiceGroup._init();
    </script>
@stop
