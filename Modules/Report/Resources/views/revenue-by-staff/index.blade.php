            ...
            <div class="m-portlet">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                {{__('BÁO CÁO DOANH THU THEO NHÂN VIÊN')}}
                            </h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        @if(in_array('admin.report-revenue.staff.export-total', session()->get('routeList')))
                            <form action="{{route('admin.report-revenue.staff.export-total')}}" method="POST">
                                {{ csrf_field() }}
                        ...
                        @endif
                        @if(in_array('admin.report-revenue.staff.export-detail', session()->get('routeList')))
                            <form action="{{route('admin.report-revenue.staff.export-detail')}}" method="POST">
                                {{ csrf_field() }}
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-form m-form--label-align-right">
                        <div class="row">
                            <div class="col-xl-3 ss--col-xl-3 ss--col-lg-12 form-group">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/revenue/by-staff/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        revenueByStaff._init();
    </script>
@stop
