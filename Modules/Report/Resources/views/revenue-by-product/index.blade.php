    ...
    <div class="m-portlet">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                @if(in_array('admin.report-revenue.product.export-total', session()->get('routeList')))
                    <form action="{{route('admin.report-revenue.product.export-total')}}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <input type="hidden" id="export_number_product_total" name="export_number_product_total">
                ...
                @endif
                @if(in_array('admin.report-revenue.product.export-detail', session()->get('routeList')))
                    <form action="{{route('admin.report-revenue.product.export-detail')}}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <input type="hidden" id="export_number_product_detail" name="export_number_product_detail">
                        <button type="submit"
                                class="btn btn-info btn-sm m-btn m-btn--icon m-btn--pill color_button m--margin-right-10">
                                        <span>
                                            <i class="la la-files-o"></i>
        ...
        <div class="m-portlet__body">
            <div class="m-form m-form__group m-form--label-align-right">
                <div class="row">
                    ...
                    <div class="col-lg-3 form-group">
                        <select name="number_product" style="width: 100%" id="number_product"
                                class="form-control m_selectpicker">--}}
            ...
            <div class="form-group m-form__group m--margin-top-10">
                ...
                <div id="autotable">
                    <form class="frmFilter">
                        ...
                        <input type="hidden" id="number_product_detail" name="number_product_detail">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/report/revenue/by-product/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        revenueByProduct._init();
    </script>
@stop
