                                            ...
                                            <div class="input-group">
                                                <select name="kpi_criteria_id" id="kpi_criteria_id" class="form-control m-input ss--select-2" style="width: 100%">
                                                    @foreach ($CRITERIA_LIST as $criteriaItem)
                                                        ...
                                                        data-unit="{{ $criteriaItem['unit_name'] }}"
                                                        data-name="{{ $criteriaItem['kpi_criteria_name'] }}">{{ __($criteriaItem['kpi_criteria_name']) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                            <div class="m-form__actions m--align-right">
                                ...
                                <button type="button" onclick="EditKpiNote.closeModal()" id="btn-save-criteria"
