    ...
    <div class="m-portlet" id="autotable">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools nt-class">
                @if (in_array('kpi.marketing.budget.day', session('routeList')))
        ...
        <div class="card-header tab-card-header ">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('kpi.marketing.budget.month') }}">Theo tháng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active show" href="{{ route('kpi.marketing.budget.day') }}">Theo ngày</a>
                </li>
            </ul>
        </div>
        ...
        <div class="m-portlet__body">
            <form class="frmFilter bg">
                ...
                <div class="row padding_row">
                    ...
                    <!-- Chọn tháng -->
                    <div class="col-lg-3 form-group">
                        <input type="date" name="effect_time" id="effect_time" class="form-control">
                    </div>

                    <!-- Button tìm kiếm -->
                    <div class="col-lg-3">
                        <div class="form-group m-form__group">
                            <a href="{{route('kpi.marketing.budget.day')}}" class="btn btn-refresh ss--button-cms-piospa m-btn--icon mr-3">
                                {{ __('XÓA BỘ LỌC') }}
            ...
            <div class="table-content m--padding-top-30">
                @include('kpi::budget-marketing.components.list-day')
            </div>
        </div>
    </div>

    <!-- Popup chỉnh sửa ngân sách -->
    @include('kpi::budget-marketing.components.edit-day')
    @include('kpi::budget-marketing.components.add-day')
@endsection

@section('after_script')
    <script src="{{ asset('static/backend/js/kpi/budget/script-day.js?v=' . time()) }}" type="text/javascript">
    </script>
@stop
