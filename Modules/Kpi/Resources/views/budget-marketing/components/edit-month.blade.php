    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content clear-form">
            ...
            <div class="modal-body">
                ...
                <form id="frm-edit-criteria" data-route="{{ route('kpi.marketing.budget.month.update') }}">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="criteria-content">
                                    ...
                                    <div class="row modal-row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="month" name="effect_time" id="effect_time" 
                                                value="{{ date('Y-m') }}" min="{{ date('Y-m') }}" class="form-control" disabled>
                                            </div>
                                        </div>
                                    </div>
