    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content clear-form">
            ...
            <div class="modal-body">
                ...
                <form id="frm-add-budget" data-route="{{ route("kpi.marketing.budget.day.submit") }}">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="m-form__group">
                                <div class="criteria-content">
                                    ...
                                    <div class="row modal-row">
                                        <div class="col-12">
                                            <label class="font-weight-bold">{{ __('Ngày áp dụng') }}: </label> <b class="text-danger">*</b>
                                            <div class="input-group">
                                                <input type="date" name="effect_time" id="add_effect_time" value="{{ date('Y-m-d') }}" min="{{ date('Y-m-d') }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
