    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content clear-form">
            ...
            <div class="modal-body">
                ...
                <form id="frm-add-budget" data-route="{{ route("kpi.marketing.budget.month.submit") }}">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="criteria-content">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <div class="radio-row" style="display: inline-block;">
                                                    <input type="radio" id="department_add_allocate" name="budget_allocation">
                                                    <label for="budget_allocation">{{ __('Phòng ban') }}</label>
                                                </div>
            
                                                <div class="radio-row" style="display: inline-block;">
                                                    <input type="radio" id="team_add_allocate" name="budget_allocation">
                                    ...
                                    <div class="row modal-row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <select name="department_id" id="add_department_id" class="form-control">
                                    ...
                                    <div class="row modal-row team-row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <select name="team_id" id="add_team_id" class="form-control">
                                    ...
                                    <div class="row modal-row">
                                        <div class="col-12">
                                            <label class="font-weight-bold">{{ __('Ngân sách tháng') }}: </label> <b class="text-danger">*</b>
                                            <div class="input-group input-currency" style="padding-left: 0px;">
                                                <input id="add_budget" name="budget" type="text" class="form-control m-input class"
                                    ...
                                    <div class="row modal-row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="month" name="effect_time" id="add_effect_time" value="{{ date('Y-m') }}" min="{{ date('Y-m') }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
