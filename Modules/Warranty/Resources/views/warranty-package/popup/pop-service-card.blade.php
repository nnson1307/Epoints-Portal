        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="fa fa-plus-circle"></i> {{__('THÊM THẺ DỊCH VỤ')}}
                </h5>
            </div>
            <div class="modal-body" id="autotable">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group m-form__group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="search_keyword" placeholder="{{__('Nhập tên hoặc mã sản thẻ dịch vụ')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="table-content m--margin-top-30">
                    @include('promotion::promotion.popup.list-service-card')
                </div>
            </div>
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="submit" onclick="view.submitChoose('service_card')"
