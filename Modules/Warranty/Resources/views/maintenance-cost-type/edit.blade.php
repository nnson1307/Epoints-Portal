            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang('CHỈNH SỬA LOẠI CHI PHÍ PHÁT SINH')
                    </h2>
                </div>
            </div>
        ...
        <div class="m-portlet__body">
            ...
            <form id="formEdit">
                    <input type="text" class="form-control m-input"
                           name="maintenance_cost_type_id" value="{{$item["maintenance_cost_type_id"]}}" hidden>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input"
                                       name="maintenance_cost_type_name_vi" value="{{$item["maintenance_cost_type_name_vi"]}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input"
                                       name="maintenance_cost_type_name_en" value="{{$item["maintenance_cost_type_name_en"]}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
        ...
        <div class="modal-footer">
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" onclick="maintenanceCostType.save()"
