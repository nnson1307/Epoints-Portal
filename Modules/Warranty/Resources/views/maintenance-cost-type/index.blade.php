...
@section('title_header')
    <span class="title_header"><img
        ...
        {{__('DANH SÁCH LOẠI CHI PHÍ PHÁT SINH')}}
    </span>
@endsection
@section('content')
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h2 class="m-portlet__head-text title_index">
                        <span><i class="la la-server"></i> {{__('DANH SÁCH LOẠI CHI PHÍ PHÁT SINH')}}</span>
                    </h2>
                            ...
                            <div class="form-group m-form__group">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search"
                                           placeholder="{{__('Nhập tên loại chi phi phát sinh')}}">
                                </div>
                            </div>
                        </div>
...
{{--                 @include('helpers.filter')--}}
            ...
            <div class="table-content m--padding-top-15">
                @include('warranty::maintenance-cost-type.list')
