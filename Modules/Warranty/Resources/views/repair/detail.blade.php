                    ...
                    <div class="col-lg-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="staff_id" name="staff_id" disabled
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="object_type" name="object_type" disabled
                                            style="width:100%;"
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input" id="object_status" name="object_status"
                                       value="{{$item['object_status']}}" disabled>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
...
{{--                                                </span>--}}
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control m-input" id="repair_cost" name="repair_cost"
                                       ...
                                       onchange="view.loadAmountPay()" disabled>
                            </div>
                            <div class="col-lg-6">
                                <label class="black_title">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea class="form-control" id="repair_content" name="repair_content" rows="5" disabled>{{$item['repair_content']}}</textarea>
                        </div>
                        <div class="form-group m-form__group">
                            <label class="black_title">
                                @lang('Trạng thái'):
                    ...
                    <table class="table table-striped m-table m-table--head-bg-default" id="table-maintenance-cost">
                        ...
                        @if (count($cost) > 0)
                            @foreach($cost as $k => $v)
                                <tr class="tr_code">
                                    <td>
                                        <select class="form-control maintenance_cost_type" style="width: 100%" disabled>
                                            <option></option>
                                    ...
                                    <td>
                                        <input type="text" class="form-control cost cost_{{$k+1}}" disabled
                    ...
                    <div class="m-section__content">
                        <div class="table-responsive">
                            <table class="table table-striped m-table m-table--head-bg-default">
                                <thead class="bg">
                                <tr>
                                    <th class="tr_thead_list">@lang('HÌNH THỨC THANH TOÁN')</th>
                                    <th class="tr_thead_list">@lang('TIỀN THANH TOÁN')</th>
                                    <th class="tr_thead_list">@lang('NGÀY THANH TOÁN')</th>
                                </tr>
                                </thead>
                                <tbody style="font-size: 12px">
                                @if(isset($getPayment) && $getPayment != null)
                                    <tr>
                                        <td>{{$getPayment['payment_method_name']}}</td>
                                        <td>
                                            {{number_format($getPayment['total_amount'], isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}
                                        </td>
                                        <td>{{\Carbon\Carbon::parse($getPayment['payment_date'])->format('d/m/Y H:i')}}</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                ...
                <div class="m-form__actions m--align-right">
                    ...
                    @if(!in_array($item['status'], ['cancel', 'finish']))
                        @if(!(isset($item['payment_status']) && $item['payment_status'] != null))
                            <a type="button" href="{{route('repair.edit', $item['repair_id'])}}"
