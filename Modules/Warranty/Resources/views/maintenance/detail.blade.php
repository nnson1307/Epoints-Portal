                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="customer_code" name="customer_code"
                                        onchange="view.chooseCustomer(this)" style="width:100%;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="object_type" name="object_type"
                                            style="width:100%;"
                                            onchange="view.changeType(this)" disabled>
                                        <option></option>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input" id="object_status" name="object_status" value="{{$item['object_status']}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control m-input" readonly=""
                                       ...
                                       name="date_estimate_delivery" disabled
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea class="form-control" id="maintenance_content" name="maintenance_content" rows="5" disabled>{{$item['maintenance_content']}}
                            </textarea>
                        </div>
                        <div class="form-group m-form__group">
                            <label class="black_title">
                                ...
                                <tr class="tr_code">
                                    <td>
                                        <select class="form-control maintenance_cost_type" style="width: 100%"
                                                onchange="view.changeCostType(this)" disabled>
                                            <option></option>
                    ...
                    <div class="m-section__content">
                        <div class="table-responsive">
                            <table class="table table-striped m-table m-table--head-bg-default">
                                <thead class="bg">
                                <tr>
                                    <th class="tr_thead_list">HÌNH THỨC THANH TOÁN</th>
                                    <th class="tr_thead_list">TIỀN THANH TOÁN</th>
                                    <th class="tr_thead_list">Ngày thanh toán</th>
                                </tr>
                                </thead>
                                <tbody style="font-size: 12px">
                                @if(count($receiptDetail) > 0)
                                    @foreach($receiptDetail as $v)
                                        <tr>
