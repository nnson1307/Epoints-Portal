            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang("DANH SÁCH PHIẾU BẢO TRÌ")
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('maintenance.create',session('routeList')))
                    ...
                    <a href="{{route('maintenance.create')}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                ...
                <div class="table-content m--padding-top-30">
                    @include('warranty::maintenance.list')
                </div>
            </div>
        </div>
    </div>
