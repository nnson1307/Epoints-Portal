...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'maintenance_cost_type_name_vi' => 'required|max:191|unique:maintenance_cost_type,maintenance_cost_type_name_vi,'.',maintenance_cost_type_id,is_delete,0',
            'maintenance_cost_type_name_en' => 'required|max:191|unique:maintenance_cost_type,maintenance_cost_type_name_en,'.',maintenance_cost_type_id,is_delete,0',
        ];
    }
