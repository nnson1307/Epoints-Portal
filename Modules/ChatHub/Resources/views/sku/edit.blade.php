...
<div class="m-portlet m-portlet--head-sm">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                ...
                <h2 class="m-portlet__head-text">
                    @lang('chathub::sku.index.EDIT_SKU')
                </h2>
            </div>
        </div>
    ...
    <form id="form">
        ...
        <div class="m-portlet__body" id="autotable">
            <input type="hidden" name="sku_id" class="form-control m-input hidden" id="sku_id" value="{{$sku['sku_id']}}">
            <div class="col-lg-12">
                <div class="form-group m-form__group">
                    <label class="black_title">
                        @lang('chathub::sku.index.NAME'):<b class="text-danger">*</b>
                    </label>
                    <input type="text" name="sku_name" class="form-control m-input" id="sku_name" value="{{$sku['sku_name']}}">
            ...
            <div class="col-lg-12">
                <div class="form-group m-form__group">
                    ...
                    <input type="text" name="entities" class="form-control m-input" id="entities" value="{{$sku['entities']}}">
                    <span class="error-name"></span>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="form-group m-form__group">
                    ...
                    <div class="input-group">
                        <select class="form-control" style="width: 100%" id="sku_status" name="sku_status">
                            ...
                            <option value="0" @if($sku['sku_status']==0) selected @endif>@lang('chathub::sku.index.UNACTIVE')</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="m-portlet__foot">
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" class="btn btn-success color_button son-mb  m-btn m-btn--icon m-btn--wide m-btn--md btn-add-close m--margin-left-10" onclick="sku.Edit()">
                        <span>
