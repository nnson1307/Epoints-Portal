<div class="modal" id="editFile" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title  ss--title m--font-bold">
                    ...
                    @lang('chathub::message.index.FILE_UPLOAD')
                </h4>
                            ...
                            <div class="m-dropzone dropzone dz-clickable"
                                ...
                                <div class="m-dropzone__msg dz-message needsclick">
                                    <h3 href="javascript:void(0);" class="m-dropzone__msg-title text-tile">
                                        @lang('chathub::message.index.FILE_SELECT')
                                    </h3>
                                </div>
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m--align-right">
                        ...
                        <div class="btn-group">
                            <button type="button"
                                    class="btn ss--button-cms-piospa ss--btn m-btn m-btn--icon m-btn--wide m-btn--md btn-save-file m--margin-left-10 m--margin-bottom-5 btn-primary">
							<span>
