<div class="modal" id="modal-message-create-deal" >
...
{{--                                       value="{{number_format($item['amount'], isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}">--}}
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    <button type="button" onclick="dealMessage.cancelSaveDeal()"
                    ...
                    <button type="button" onclick="dealMessage.saveDeal()"
