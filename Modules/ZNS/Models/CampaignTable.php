...
class CampaignTable extends Model
{
    ...
    protected $table = 'zns_campaign';
    protected $primaryKey = 'zns_campaign_id';
    ...
    {
        return $this->hasMany('Modules\ZNS\Models\LogTable', 'zns_campaign_id', 'zns_campaign_id')->count();
    }

    public function countSendSuccess()
    {
        return $this->hasMany('Modules\ZNS\Models\LogTable', 'zns_campaign_id', 'zns_campaign_id')
            ->where("zns_log.status", '=', "sent")->count();
    }
