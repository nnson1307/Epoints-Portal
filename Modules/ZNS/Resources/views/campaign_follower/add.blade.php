        ...
        <div class="m-portlet__body">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="form-group m-form__group">
                        <select name="zns_template_id" class="form-control">
                            ...
                            @foreach ($template_option as $key => $value)
                                <option value="{{$key}}"
                                        {{ isset($params["zns_template_id"]) && $params["zns_template_id"] == $key? ' selected':'' }}
                                >{{$value}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group m-form__group">
                        <iframe class="innerIframe d-block border-0" src="" name="innerIframe" id="content_zns"
            ...
            {{--            </div>--}}
            <div class="row">
                <div class="col-lg-3 d-flex align-items-center m-0">
                    <label>
...
@section('after_script')
    ...
    <script src="{{ asset('static/backend/js/zns/campaign_follower/add.js?v=' . time()) }}"
