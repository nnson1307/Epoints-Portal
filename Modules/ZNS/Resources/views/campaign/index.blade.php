...
{{--                        <a href="{{ route('zns.campaign.add',['campaign_type'=>'broadcast']) }}" class="dropdown-item"--}}
{{--                           type="button">{{__('Tạo chiến dịch Zalo BroadCast')}}</a>--}}
                    </div>
                </div>
            </div>
        </div>
        <div class="d-flex m-portlet__head">
            <ul class="nav nav-tabs m-0 align-items-center justify-content-center">
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('zns.campaign')}}">{{__('ZNS Template API')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('zns.campaign-follower')}}">{{__('ZNS FOLLOWER API')}}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 form-group">
                                    <div class="d-flex">
                                        <a href="{{ route('zns.campaign') }}" class="btn btn-clear-form btn-refresh ss--button-cms-piospa m-btn--icon mr-3">
                                            {{ __('XÓA BỘ LỌC') }}
...
@section('after_script')
    <script src="{{asset('static/backend/js/zns/campaign/list.js?v='.time())}}" type="text/javascript"></script>
@stop
