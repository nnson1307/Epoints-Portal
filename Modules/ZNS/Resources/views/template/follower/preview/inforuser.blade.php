        ...
        <div class="card  last-msg card--oa">
            <div class="oa-msg-header">
                <div class="oa-msg-header__img"
                     style="background-image: url('{{isset($item->image)?$item->image:asset('uploads/admin/service_card/default/hinhanh-default3.png')}}'); background-position: center center; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"></div>
                <div class="oa-msg-header__title">{{isset($item->title_show)?$item->title_show:''}}</div>
                <div class="oa-msg-header__desc">{{isset($item->sub_title)?$item->sub_title:''}}</div>
            </div>
        </div>
    </div>
</div>