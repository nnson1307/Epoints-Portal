            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{ __('THÊM THỦ CÔNG') }}
                        <input type="hidden" name="zalo_campaign_follower_id" value="{{isset($params['zalo_campaign_follower_id'])?$params['zalo_campaign_follower_id']:''}}">
                    </h3>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9">
                    <div class="form-group m-form__group">
                        <input id="template_name" name="template_name" type="text" class="form-control"
                               placeholder="{{ __('Nhập tên template') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="m-portlet__foot">
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                <div class="m-form__actions m-form__actions--solid m--align-right">
                    ...
                    <button type="button" onclick="follower.add()"
...
@section('after_script')
    <script src="{{ asset('static/backend/js/zns/template/add-follower.js?v=' . time()) }}"
