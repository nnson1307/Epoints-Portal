            ...
            <div class="modal-body">
                <form id="form-edit">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                <select id="approve_level_2" readonly="true" name="approve_level_2" placeholder="Chọn phòng ban" class="form-control m_selectpicker" {{ isset($dataDetail['staff_id_approve_level2']) && $dataDetail['staff_id_approve_level2'] != '' ? '' : 'disabled'  }}>
                                    <option 
                                        value="">@lang('Chọn phòng ban')
                                    </option>
                                    @foreach($arrDepartment as $objDepartment)
                                        <option 
                                            value="{{$objDepartment['department_id']}}" {{ $objDepartment['department_id'] == ($dataDetail['department_id'] ?? '') ? 'selected' : '' }}>{{$objDepartment['department_name']}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                <select id="approve_level_2" readonly="true" name="approve_level_2" placeholder="Chọn người duyệt" class="form-control m_selectpicker" {{ isset($dataDetail['staff_id_approve_level2']) && $dataDetail['staff_id_approve_level2'] != '' ? '' : 'disabled'  }}>
                                    <option 
