                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="m-wizard__nav">
                            <div class="m-wizard__steps" style="margin-top: 0px">
                                <div class="steps_2">
                        ...
                        <div class="m-form__section m-form__section--first">
                            <div class="container" style="max-width: 900px;">
                                <div class="m-portlet__body">
                                    <h4 class="type_of_criteria">Điều kiện tính hoa hồng:<b class="text-danger">*</b>
                                    </h4>
                                    <span>Đơn hàng đã thanh toán (toàn phần) thành công:</span>
                                    <div>
                                        <span class="m-switch m-switch--icon m-switch--success m-switch--sm"
                                            ...
                                            <span> &nbsp Bao gồm phí vận chuyển</span>
                                        </span>
                                    </div>
                                    &nbsp
                                    <h4 class="type_of_criteria">Công thức tính:<b class="text-danger">*</b></h4>
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm"
                                          style="align-items: center;display: flex;}">
                                            <label style="margin: 0 0 0 0px; padding-top: 0px">
                                                <input type="checkbox"
                                            ...
                                            <span> &nbsp Trên mỗi đơn hàng</span>
                                        </span>
                                    <div class="m-portlet__body" style="padding: 1rem 0rem;">
                                        <div class="table-responsive">
                                            <table class="table table-striped m-table ss--header-table">
                                                <thead>
                                                <tr class="ss--nowrap">
                                                    <th class="ss--font-size-th ss--text-center">Hoa hồng cho 1 sản
                                                        phẩm/dịch vụ/thẻ dịch vụ:<b class="text-danger">*</b></th>
                                                    <th class="ss--font-size-th ss--text-center">Giá trị hoa hồng tối
                                                        đa
                                                    </th>
                                                ...
                                                <tr class="ss--font-size-13 ss--nowrap">
                                                            ...
                                                            <div class="input-group-append">
                                                                <div class="btn-group btn-group-toggle"
                                                                    ...
                                                                    <label class="btn btn-secondary active">
                                                                        <input type="radio" name="config-operation-1"
                                                                               checked="" value="0"> VNĐ </label>
                                                    ...
                                                    <td style="width:300px">
                                                        <div class="input-group" style="padding-left: 0px;">
                                                            <input type="text"
                                                                   class="form-control m-input numeric_child"
                                                                   id="max-order-1" name="max-order" value="0"
                                                                   aria-invalid="false">
