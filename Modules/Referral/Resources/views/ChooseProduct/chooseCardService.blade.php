        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <a href="{{route('Referral.commissionConditionCardService')}}"
                        ...
                        <div class="m-form__section m-form__section--first">
                            <div class="container" style="max-width: 900px;">
                                <div class="m-portlet__body" >
                                    <h3 class="type_of_criteria">Chọn thẻ dịch vụ</h3>
                                    <form class="frmFilter ss--background">
                                        <div class="row ss--bao-filter">
                                            <div class="col-lg-3" style="flex: 0 0 33.3333%;max-width: 33.3333%;">
                                            ...
                                            <div class="col-lg-3" style="flex: 0 0 33.3333%;max-width: 33.3333%;">
                                                <div class="form-group m-form__group">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select2">
                                                            <option value="">Chọn thẻ dịch vụ</option>
                                                            <option value="1">Giá trị 1</option>
                                                            <option value="2">Giá trị 2</option>
                                                            <option value="3">Giá trị 3</option>
                                                            <option value="4">Giá trị 4</option>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped m-table ss--header-table">
                                            ...
                                            <tr class="ss--nowrap">
                                                ...
                                                <th class="ss--font-size-th ">{{__('Nhóm thẻ dịch vụ')}}</th>
                                                <th class="ss--font-size-th ss--text-center">{{__('Tên thẻ dịch vụ')}}</th>
                                                <th class="ss--font-size-th ss--text-center">{{__('Giá thẻ(VNĐ)')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
