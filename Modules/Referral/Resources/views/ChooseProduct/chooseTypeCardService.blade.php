        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <a href="{{route('referral.commissionConditionTypeCardService')}}"
                        ...
                        <div class="m-form__section m-form__section--first">
                            <div class="container" style="max-width: 900px;">
                                <div class="m-portlet__body" >
                                    <h3 class="type_of_criteria">Chọn nhóm thẻ dịch vụ</h3>
                                    <form class="frmFilter ss--background">
                                        <div class="row ss--bao-filter">
                                            <div class="col-lg-3" style="flex:50%;max-width: 50%;">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped m-table ss--header-table">
                                            <thead>
                                            <tr class="ss--nowrap ss--text-center">
                                                <th >#</th>
                                                <th >{{__('Hành động')}}</th>
                                                <th >{{__('Nhóm thẻ dịch vụ')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr class="ss--font-size-13 ss--nowrap ss--text-center ">
                                                <td >#</td>
                                                <td>
