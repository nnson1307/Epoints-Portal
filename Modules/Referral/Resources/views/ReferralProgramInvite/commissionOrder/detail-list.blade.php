...
{{--                    <td>--}}
{{--                        @if($item['status'] != 'reject' && (!isset($listMemberInPaymentMember[$item['referral_member_id']]) || $listMemberInPaymentMember[$item['referral_member_id']]['status'] == 'reject') )--}}
...
{{--                            <a href="javascript:void(0)" onclick="referralProgramInvite.showReject({{$item['referral_program_invite_id']}})"><img src="{{asset('static/backend/images/edit_affiliate.png')}}"></a>--}}
{{--                        @endif--}}
{{--                    </td>--}}
