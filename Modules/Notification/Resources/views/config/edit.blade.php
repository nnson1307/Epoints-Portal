                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            @if (in_array($item['key'], ['order_status_A', 'order_status_B', 'order_status_C', 'order_status_D', 'order_status_I', 'order_status_S', 'order_status_W']))
                                <a href="javascript:void(0)"
                                   ...
                                   style="color: black;" onclick="index.append_para_txa('[order_code]')">{{__('Mã đơn hàng')}}</a>
                            @elseif(in_array($item['key'], ['appointment_A', 'appointment_C', 'appointment_R', 'appointment_W', 'appointment_U']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[branch_name]')">{{__('Chi nhánh')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[time]')"> {{__('Thời gian đặt')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[date]')">{{__('Ngày đặt')}}</a>
                                @if($item['key'] == 'appointment_U')
                                    <a href="javascript:void(0)"
                                       class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                       style="color: black;" onclick="index.append_para_txa('[appointment_code]')">{{__('Mã lịch hẹn')}}</a>
                                @endif
                            @elseif(in_array($item['key'], ['service_card_expired', 'service_card_nearly_expired', 'service_card_over_number_used']))
                                ...
                                @if($item['key'] != 'service_card_over_number_used')
                                    <a href="javascript:void(0)"
                                       class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                       style="color: black;" onclick="index.append_para_txa('[expired_date]')">{{__('Ngày hết hạn')}}</a>
                                @endif
                            @elseif(in_array($item['key'], ['customer_ranking', 'customer_W']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[name]')">{{__('Tên khách hàng')}}</a>
                            @elseif(in_array($item['key'], ['delivery_W']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[delivery_history_code]')">{{__('Mã giao hàng')}}</a>
                            @elseif(in_array($item['key'], ['is_remind_use']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[name]')">{{__('Tên khách hàng')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[object_type]')">{{__('Loại đối tượng')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_txa('[object_name]')">{{__('Tên đối tượng')}}</a>
                            @endif
                        </div>
                        <div class="form-group">
                            <label>
                        ...
                        <div class="form-group row">
                            @if (in_array($item['key'], ['order_status_A', 'order_status_B', 'order_status_C', 'order_status_D', 'order_status_I', 'order_status_S', 'order_status_W']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[order_code]')">{{__('Mã đơn hàng')}}</a>
                            @elseif(in_array($item['key'], ['appointment_A', 'appointment_C', 'appointment_R', 'appointment_W', 'appointment_U']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[branch_name]')">{{__('Chi nhánh')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[time]')"> {{__('Thời gian đặt')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                ...
                                @if($item['key'] == 'appointment_U')
                                    <a href="javascript:void(0)"
                                       class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                       style="color: black;" onclick="index.append_para_ck('[appointment_code]')">{{__('Mã lịch hẹn')}}</a>
                                @endif
                            @elseif(in_array($item['key'], ['service_card_expired', 'service_card_nearly_expired', 'service_card_over_number_used']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                ...
                                @if($item['key'] != 'service_card_over_number_used')
                                    <a href="javascript:void(0)"
                                       class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                       style="color: black;" onclick="index.append_para_ck('[expired_date]')">{{__('Ngày hết hạn')}}</a>
                                @endif
                            @elseif(in_array($item['key'], ['customer_ranking', 'customer_W']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[name]')">{{__('Tên khách hàng')}}</a>
                            @elseif(in_array($item['key'], ['delivery_W']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[delivery_history_code]')">{{__('Mã giao hàng')}}</a>
                            @elseif(in_array($item['key'], ['is_remind_use']))
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[name]')">{{__('Tên khách hàng')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[object_type]')">{{__('Loại đối tượng')}}</a>
                                <a href="javascript:void(0)"
                                   class="btn m--margin-left-10 btn-sm ss--btn-parameter ss--font-weight-200"
                                   style="color: black;" onclick="index.append_para_ck('[object_name]')">{{__('Tên đối tượng')}}</a>
                            @endif
                        </div>
                    </div>
                </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/notification/config/script.js')}}"
