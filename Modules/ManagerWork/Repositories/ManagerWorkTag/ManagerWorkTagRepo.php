...
namespace Modules\ManagerWork\Repositories\ManagerWorkTag;
...
class ManagerWorkTagRepo implements ManagerWorkTagInterface
{
    protected $mManageWorkTag;
    public function __construct(ManagerWorkTagTable $managerWorkTagTable){
        $this->mManageWorkTag = $managerWorkTagTable;
    }
    public function getListByWork($listId){
        return $this->mManageWorkTag->getListTagByWork($listId);
    }
