    ...
    <div class="m-portlet">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{route('manager-work.manage-config.notification.edit')}}"
        ...
        <div class="m-portlet__body p-0">
            <ul class="nav nav-tabs nav-pills mb-3" role="tablist" style="margin-bottom: 0;">
                ...
                <li class="nav-item">
                    <a class="nav-link active">{{ __('managerwork::managerwork.work') }}</a>
                </li>
                <li class="nav-item">
                    ...
                    <table class="table table-striped m-table ss--header-table ss--nowrap">
                        ...
                        @foreach($listNotiConfig as $key => $item)
                            <tr class="block_{{$item['manage_config_notification_id']}}">
                                <input type="hidden" id="manage_config_notification_message" name="noti[{{$item['manage_config_notification_id']}}][manage_config_notification_id]" value="{{$item['manage_config_notification_id']}}">
                                ...
                                <td>{{$key + 1}}</td>
                                <td>{{$item['manage_config_notification_title']}}</td>
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_mail]" {{$item['is_mail'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                ...
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_noti]" {{$item['is_noti'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                ...
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_created]" {{$item['is_created'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                </td>
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_processor]" {{$item['is_processor'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                </td>
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_support]" {{$item['is_support'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                </td>
                                <td>
                                    <label class="m-checkbox m-checkbox--state-success mt-0">
                                        <input type="checkbox" disabled name="noti[{{$item['manage_config_notification_id']}}][is_approve]" {{$item['is_approve'] == 1 ? 'checked' : ''}} value="1">
                                        <span></span>
                                    </label>
                                </td>
                            </tr>
