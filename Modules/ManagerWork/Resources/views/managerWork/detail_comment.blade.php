                    ...
                    <td>
                        ...
                        <p class="mb-0">
                            @if(\Illuminate\Support\Facades\Session::has('is_staff_work_project') == false || \Illuminate\Support\Facades\Session::get('is_staff_work_project') == 1)
                                <a href="javascript:void(0)" class="reply_message" onclick="Comment.showFormChat({{$item['manage_comment_id']}})">{{ __('managerwork::managerwork.answer') }} </a>
                            @endif
...
@endif
<script src="{{asset('static/backend/js/manager-work/managerWork/detail-work-comment.js')}}"></script>
