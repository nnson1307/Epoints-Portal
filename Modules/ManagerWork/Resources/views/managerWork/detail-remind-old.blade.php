...
@section('content')
    ...
    <div class="m-portlet m-portlet--head-sm tab_work_detail">
        <nav class="nav">
            ...
            <a class="nav-link active" href="{{route('manager-work.detail-remind',['id' => $detail['manage_work_id']])}}">{{ __('managerwork::managerwork.remind') }}</a>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/manager-work/managerWork/detail-work-remind.js')}}"></script>
