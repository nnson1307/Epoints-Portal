...
@section('content')
    ...
    <div class="m-portlet m-portlet--head-sm tab_work_detail pb-5">
        <nav class="nav">
            ...
            <a class="nav-link active" href="{{route('manager-work.detail-document',['id' => $detail['manage_work_id']])}}">{{ __('managerwork::managerwork.document') }}</a>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/manager-work/managerWork/detail-work-document.js?v='.time())}}"></script>
