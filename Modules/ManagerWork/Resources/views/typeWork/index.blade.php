...
@section('content')
    <div class="m-portlet" id="autotable">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{ __('DANH SÁCH LOẠI CÔNG VIỆC') }}
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                <div class="d-flex">
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modalAdd" onclick="TypeWork.clear()"
                        class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn_add_pc btn-sm">
                        <span>
                            <i class="fa fa-plus-circle"></i>
                            <span> {{ __('THÊM LOẠI CÔNG VIỆC') }}</span>
                        </span>
                    </a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#modalAdd" onclick="TypeWork.clear()"
        ...
        <div class="m-portlet__body">
                ...
                <div class="ss--bao-filter">
                    <div class="row">
                        ...
                        <div class="col-lg-3 form-group">
                            <div class="d-flex">
                                <button onclick="TypeWork.refresh()" class="btn  btn-refresh ss--button-cms-piospa m-btn--icon mr-3">
                                    {{ __('Xóa bộ lọc') }}
                                    <i class="fa fa-eraser" aria-hidden="true"></i>
                                </button>
                                <button onclick="TypeWork.search()" class="btn ss--button-cms-piospa m-btn--icon">
                                    {{ __('TÌM KIẾM') }}
                                    <i class="fa fa-search"></i>
                                </button>
                            </div>
            ...
            <div class="table-content">
                @include('manager-work::typeWork.list')
    ...
    <div class="modal fade" id="modalAdd" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-work::typeWork.add')
        </div>
    </div>
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-work::typeWork.edit')
        </div>
    </div>
    <div class="modal fade" id="modalView" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-work::typeWork.view')
        </div>
    </div>
@stop
@section('after_script')
    ...
    <script src="{{ asset('static/backend/js/manager-work/typeWork/list.js?v=' . time()) }}" type="text/javascript"></script>
@stop
