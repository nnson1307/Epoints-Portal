<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title ss--title m--font-bold">
            ...
            {{__('CHỈNH SỬA LOẠI CÔNG VIỆC')}}
        </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
    <div class="modal-body">
        <input type="hidden" name="manage_type_work_id_hidden">
        ...
        <div class="form-group m-form__group div_avatar">
            ...
            <label for="getFile-edit" class="btn btn-sm m-btn--icon color">
                <span>
            ...
            <input accept="image/svg+xml,image/jpeg,image/png,image/jpeg,jpg|png|jpeg"
                data-msg-accept="{{ __('Hình ảnh không đúng định dạng') }}" id="getFile-edit" type="file"
    ...
    <div class="modal-footer">
        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
            <div class="m-form__actions m--align-right">
                ...
                <button type="button" onclick="TypeWork.submitEdit()"
