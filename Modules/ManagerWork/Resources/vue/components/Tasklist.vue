<template>
    <div>
        <div v-if="collapsedTaskItem">
            <div class="collapse-task" @click.prevent="collapseItemTask" :style="{borderColor: this.list.manage_color_code}">
                <div class="collapse-task-header" >
                    <a href="#" aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-angle-down" aria-hidden="true"></i>
                    </a>
                    <p class="board-name">{{ this.list.manage_status_name }} ({{ this.list.count }})</p>
                </div>
            </div>
        </div>
        <div v-show="!collapsedTaskItem" class="task-board" :style="{borderColor: this.list.manage_color_code}">
...
export default {
    ...
    methods: {
        ...
        deleteWholeTaskList() {
            ...
            console.log("deleteWholeTaskList");
            const payload = {
                boardId: this.board.id,
                listId: this.list.id
            };
