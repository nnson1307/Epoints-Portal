                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control m-input"
                                       ...
                                       placeholder="@lang('Nhập tên nhóm')" value="{{$item['team_name']}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group">
                            <label class="black_title">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="department_id" name="department_id">
                                    ...
                                    @foreach($optionDepartment as $v)
                                        <option value="{{$v['department_id']}}" {{$item['department_id'] == $v['department_id'] ? 'selected' : ''}}>{{$v['department_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button type="button" onclick="edit.save('{{$item['team_id']}}')"
