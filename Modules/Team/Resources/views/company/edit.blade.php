                ...
                <div class="form-group m-form__group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control m-input"
                               ...
                               placeholder="@lang('Nhập tên công ty')" value="{{$item['company_name']}}">
                    </div>
                </div>
                <div class="form-group m-form__group">
                    <label class="black_title">
                    ...
                    <div class="input-group">
                        <textarea class="form-control m-input" id="description" name="description" cols="5">{{$item['description']}}</textarea>
                    </div>
                </div>
                <div class="form-group m-form__group">
                    <label class="black_title">
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button type="button" onclick="edit.save('{{$item['company_id']}}')"
