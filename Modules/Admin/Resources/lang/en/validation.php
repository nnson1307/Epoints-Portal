...
return [
    ...
    'product_suggest' => [
        'goi_y' => 'Suggestion ',
        'product_using' => ' according to the type of product that is duplicated',
        'service_using' => ' according to the type of service that is duplicated',
        'input_quantity' => 'Please enter quantity for suggestion ',
        'input_time' => 'Please choose a time for the suggestion ',
        'input_tags' => 'Please select tags for suggestions ',
        'no_choose_config' => 'Select at least 1 condition for the suggested product configuration'
    ]
];
