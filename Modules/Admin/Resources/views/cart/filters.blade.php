<div class="frmFilter ss--background m--margin-bottom-30 ajax ajax-cart-list-form hu-first-uppercase ajax"
     method="POST" action="{{route('admin.cart.ajax-list')}}
        ">
    <div class="ss--bao-filter">
        <div class="row">
            ...
            <div class="col-lg-4 form-group">
                <div class="form-group m-form__group row align-items-center">
                    <div class="col-lg-12 input-group">
                        <select class="form-control m-input select2" name="customer_id">
            ...
            <div class="col-lg-4 form-group">
                <div class="form-group m-form__group row align-items-center">
                    <div class="col-lg-12 input-group">
                        <select class="form-control m-input select2" name="branch_id">
            ...
            <div class="col-lg-2 form-group">
                <button class="btn ss--button-cms-piospa m-btn--icon submit submit-list-cart"
                    data-current_page=1
                >
                    {{__('TÌM KIẾM')}}
