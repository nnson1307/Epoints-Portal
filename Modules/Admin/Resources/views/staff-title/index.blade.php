...
@section('content')
    <div class="m-portlet" id="autotable">
        ...
        <div class="m-portlet__body">
                        ...
                        <div class="col-lg-4 form-group">
                            <div class="m-form__group">
                                <div class="input-group">
                                    <input type="hidden" name="search_type" value="staff_title_name">
            ...
            <div class="table-content">
                @include('admin::staff-title.list')
    ...
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            @include('admin::staff-title.edit')
        </div>
    </div>
@stop
@section('after_script')
    <script src="{{asset('static/backend/js/admin/staff-title/list.js')}}" type="text/javascript"></script>
@stop