        ...
        <form action="{{ route('admin.faq-group.store') }}" method="POST" id="form-submit">
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control{{ $errors->has('faq_group_title_vi') ? ' is-invalid' : '' }}" required
                               type="text" name="faq_group_title_vi" id="faq_group_title_vi" placeholder="{{__('Nhập tên nhóm hỗ trợ (VI)')}}" value="{{ $detail['faq_group_title_vi'] }}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control{{ $errors->has('faq_group_title_en') ? ' is-invalid' : '' }}" required
                               type="text" name="faq_group_title_en" id="faq_group_title_en" placeholder="{{__('Nhập tên nhóm hỗ trợ (EN)')}}" value="{{ $detail['faq_group_title_en'] }}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input type="number" min="1" value="{{ $detail['faq_group_position'] }}"
                    ...
                    <div class="col-10">
                        ...
                        <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                <label style="margin: 0 0 0 10px; padding-top: 4px">
                                    <input type="checkbox" class="manager-btn" {{$detail['is_actived'] == 1 ? "checked" :""}} name="is_actived">
                                    <span></span>
                                </label>
                         </span>
                    </div>
            ...
            <input type="hidden" id="faq_group_id" name="faq_group_id" value="{{$detail['faq_group_id']}}">
        </form>
    </div>
@endsection
@section("after_style")
