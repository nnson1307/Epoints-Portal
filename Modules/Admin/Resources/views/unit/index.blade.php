            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        {{__('DANH SÁCH ĐƠN VỊ TÍNH')}}
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('admin.unit.submitadd',session('routeList')))
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/unit/script.js?v='.time())}}" type="text/javascript"></script>
