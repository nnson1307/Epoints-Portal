    ...
    <div class="m-datatable__pager m-datatable--paging-loaded clearfix">
            ...
            <ul class="m-datatable__pager-nav" style="float: right">
                ...
                @else
                    ...
                    <li>
                        <a title="Previous" class="m-datatable__pager-link m-datatable__pager-link--prev"
                           ...
                           onclick="GetList.listProductInventory('{{ $paginator->currentPage() - 1 }}')">
                ...
                @foreach ($elements as $element)
                    ...
                    @if (is_string($element))
                        <li>
                            <a disabled="disabled" title="More pages"
                               class="m-datatable__pager-link m-datatable__pager-link--more-next m-datatable__pager-link--disabled">
                            ...
                            @if ($page == $paginator->currentPage())
                                <li>
                                    <a class="m-datatable__pager-link m-datatable__pager-link--active"
                                       ...
                                       onclick="GetList.listProductInventory('{{$page}}')">
                                        {{ $page }}
                                    </a>
                                </li>
                            @else
                                <li>
                                    <a class="m-datatable__pager-link"
                                       data-page="{{ $page }}"
                                       onclick="GetList.listProductInventory('{{$page}}')">
                                        {{ $page }}
                                    </a>
                ...
                @else
                    ...
                    <li>
                        <a title="Last" class="m-datatable__pager-link m-datatable__pager-link--last"
                           ...
                           onclick="GetList.listProductInventory('{{ $paginator->lastPage() }}')">
                            <i class="la la-angle-double-right"></i>
                        </a>
                    </li>
                @endif
        ...
        <div class="m-datatable__pager-info" style="float: left">
            <span class="m-datatable__pager-detail">
                @lang('Hiển thị') {{ $paginator->firstItem() }}
                - {{ $paginator->lastItem() }} @lang('của') {{ $paginator->total() }}
            </span>
        </div>
    </div>
</div>
