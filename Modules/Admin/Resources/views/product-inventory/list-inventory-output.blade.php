...
<div id="autotable2">
    <form class="frmFilter m--margin-bottom-20">
        <div class="row m--margin-bottom-20">
            ...
            <div class="col-lg-6">
                @if(Auth::user()->is_admin==1||in_array('admin.inventory-output.add',session('routeList')))
                    <a href="javascript:void(0)"
{{--                       onclick="location.href='{{route('admin.inventory-output.add')}}'"--}}
                        onclick="InventoryOut.showPopup()"
            ...
            <div class="row ss--bao-filter">
                ...
                <div class="col-lg-6 form-group">
                    <div class="m-input-icon m-input-icon--right">
                        <input onkeyup="InventoryOut.removeAllInput(this)" class="form-control m-input daterange-picker"
                               id="created_at2"
...
<script src="{{asset('static/backend/js/admin/inventory-output/list.js?v='.time())}}" type="text/javascript"></script>
