    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {!! Form::model($item,['method'=>'POST','route'=>['admin.order-reason-cancel.submitedit',$item->order_reason_cancel_id],'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <input type="submit" class="btn btn-success"
                                           style="width: 100px; margin-right: 10px" value="Lưu lại"></input>
                                    <a href="{{ route('admin.order-reason-cancel') }}"
                                       style="width: 100px;margin-right: 10px" class="btn btn-secondary">Cancel</a>
