    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {!! Form::open(['method' => 'post','route' => 'order-payment-type.add', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 {{ $errors->has('order_payment_type_name') ? ' has-danger' : '' }}">
                            ...
                            @if ($errors->has('order_payment_type_name'))
                                ...
                                <br>
                            @endif
                            <span class="m-form__help">{{__('Vui lòng nhập tên hình thức thanh toán')}} </span>
                        </div>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-8">
                            {!! Form::textarea('order_payment_type_description', null, ['style'=>'max-height : 100px;','class' => 'form-control m-input','placeholder' => 'Nhập ghi chú']) !!}
