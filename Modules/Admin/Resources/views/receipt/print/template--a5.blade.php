        ...
        <section class="sheet">
            <div id="PrintArea">
                <div class="widhtss">
                    ...
                    <div class="mm-mauto">
                        <h4 class="text-center font-size-15">{{__('HÓA ĐƠN THANH TOÁN CÔNG NỢ')}}</h4>
                        ...
                        <div class="coll-7">
                            @if($configPrintBill['is_show_order_code']==1)
                                <div class="roww text-left">
                                    <div>
                                        <span class="ss-font-size-10">{{__('Mã hóa đơn')}}: {{$debt['debt_code']}}
                                        </span>
                                    </div>
                                </div>
                            @endif
                            ...
                            <td colspan="5">
                                <div class="row_custom">
                                    ...
                                    <div class="coll-4 text-right" style="font-size: 15px; font-weight: bold;">
                                        {{number_format($amount_bill, isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}} {{__('VNĐ')}}
                                    </div>
                                </div>
                            </td>
                        </tr>
                                    ...
                                    <div class="coll-8" style="font-size: 15px;">
                                        ...
                                        @if (isset($receipt_detail) && $receipt_detail != null)
                                            @foreach($receipt_detail as $paymentMethod)
                                                <span style="margin-left: 15px;">{{$paymentMethod['payment_method_name']}}</span>
                                            @endforeach
                                        @endif
                                    </div>
                                    <div class="coll-4 text-right" style="font-size: 15px;">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="row_custom">
                                        ...
                                        <div class="coll-4 text-right" style="font-size: 15px; font-weight: bold;">
                                            {{number_format($amount_bill-($totalCustomerPaid), isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}} {{__('VNĐ')}}
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="mm-mauto tientong font-size-15 roww" style="margin-top: 2px !important;">
                        {{__('TỔNG TIỀN KHÁCH TRẢ')}} {{__('VIẾT BẰNG CHỮ')}}: <span class="first-text-upper">
                            {{$text_total_amount_paid}} {{__('đồng')}}.</span>
                    </div>
                    @if($receipt['note']!='' && $receipt['note']!=null)
                        <div class="mm-mauto tientong font-size-15 roww" style="margin-top: 2px !important;">
                            {{__('Ghi chú')}}: <span class="">
                            {{$receipt['note']}}
                        </span>
                        </div>
                    @endif
