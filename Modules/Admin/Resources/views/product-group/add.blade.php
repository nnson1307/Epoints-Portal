    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                <!--begin::Form-->
                {!! Form::open(['route' => 'product-group.submitadd', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/product_group/dropzone.js')}}" type="text/javascript"></script>
