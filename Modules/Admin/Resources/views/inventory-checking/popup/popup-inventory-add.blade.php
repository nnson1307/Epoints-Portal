<div class="modal fade" id="popup-add-checking" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title ss--title m--font-bold">
                    <i class="fa fa-plus-circle ss--icon-title m--margin-right-5"></i>
                    {{__('TẠO PHIẾU KIỂM KHO')}}
                </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group m-form__group">
                    <input readonly class="form-control" value="{{$code}}" id="checking-code" type="text" style="display: none">
                ...
                <div class="form-group m-form__group">
                    ...
                    <div class="input-group">
                        <textarea placeholder="{{__('Nhập lý do kiểm kho')}}" rows="3" cols="40" name="description" id="description"
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 pr-0">
                                ...
                                <input accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                                       id="file_excel" onchange="InventoryChecking.fileName()" type="file" style="display: none">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group m-form__group">
                    <a href="{{ asset('static/backend/file/inventory/inventory_checking.xlsx') }}"
            ...
            <form id="form-data-error" action="{{route('admin.inventory-checking.export-add-inventory-checking-error')}}" method="GET"></form>
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button type="button" onclick="InventoryChecking.addInventory()"
