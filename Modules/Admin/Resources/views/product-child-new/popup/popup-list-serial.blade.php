            ...
            <form id="form-list-serial">
                ...
                <div class="modal-body">
                    <div class="ss--background">
                        <div class="row ss--bao-filter2">
                            ...
                            <div class="col-4 text-right pb-3">
                                <button type="button" onclick="detailProduct.removeSearchSerialPopup()" class="btn btn-primary color_button btn-search">
                                    {{ __('XÓA BỘ LỌC') }}
                                    <i class="fa fa-eraser" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-primary color_button btn-search" onclick="detailProduct.changePageSerialPopup(1)">
                    ...
                    <div class="block-list-serial mt-3">
                        @include('admin::product-child-new.append.list-serial')
                    </div>
                </div>
