            ...
            <div class="col-xl-6 order-2 order-xl-1">
                <div class="form-group m-form__group row align-items-center">
                    <div class="input-group col-xs-10">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="button" onclick="Voucher.FilterServiceCard('{{isset($object) ? implode(",",$object) :null}}')">
            ...
            <div class="col-xl-3 order-2 order-xl-1">
                <div class="form-group m-form__group row align-items-center">
                    <div class="input-group">
                        {!! Form::select("service_card_type",[
                            ""=>__("Tất cả"),
                            "money"=>__("Tiền"),
                            "service"=>__("Dịch vụ")
                        ],(isset($param) ? $param["service_card_type"] : ""),["class"=>"form-control service_card_type","autocomplete"=>"off","onchange"=>"Voucher.FilterServiceCard('".(isset($object) ? implode(",",$object) :null)."')"]); !!}
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="m-checkbox m-checkbox--solid" style="margin-bottom: 14px">
                                <input type="checkbox" @if(isset($object) && in_array($item->service_card_id, $object)) checked @endif autocomplete="off" class="ckb-item" name="service_card_id[]" value="{{$item->service_card_id}}">
                                <span></span>
                            </label>
                        </td>
                    </tr>
