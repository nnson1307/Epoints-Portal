        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title title_index">
                    @lang("THÊM THÔNG TIN NGƯỜI LIÊN HỆ")
                </h4>
            </div>
                ...
                <form id="form-person-contact">
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <input id="person_name" name="person_name" type="text" class="form-control m-input class">
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
                        ...
                        <div class="input-group">
                            <input id="person_phone" name="person_phone" type="text" class="form-control m-input class">
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
                        ...
                        <div class="input-group">
                            <input id="person_email" name="person_email" type="text" class="form-control m-input class">
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" onclick="detail.storePersonContact('{{$customer_id}}')"
