        ...
        <div class="modal-content">
                ...
                <form id="form-note">
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <textarea id="note_detail" name="note_detail" class="form-control m-input class" cols="5" rows="5">{{$info['note']}}</textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" onclick="detail.updateNote('{{$info['customer_note_id']}}')"
