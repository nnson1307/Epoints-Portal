            ...
            <div class="m-widget4  m-section__content" id="load">
                <form id="form-receipt">
                    <div class="modal-body">
                        ...
                        <div class="form-group m-form__group payment_method">
                            <div class="row mt-3 method payment_method_CASH" style="margin-bottom: 2rem">
                                <label class="col-lg-4 font-15">@lang('Tiền mặt'):<span
                                ...
                                <div class="input-group input-group col-lg-6" style="height: 30px;">
                                    <input onkeyup="indexDebt.changeAmountReceipt(this)" style="color: #008000" class="form-control m-input" placeholder="{{__('Nhập giá tiền')}}"
                                           ...
                                           name="payment_method" id="payment_method_CASH" value="{{$totalDebt}}">
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-lg-3 w-me-40  font-15">{{__('Tổng công nợ')}}:</label>
                            <div class="col-lg-9 w-me-40 ">
                                <span class="font-15 font-weight-bold cl_receipt_amount"
                                      style="float: right;color: red">{{number_format($totalDebt, isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}</span>
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-lg-3 w-me-40 font-15">{{__('Tổng tiền thanh toán')}}:</label>
                            <div class="col-lg-9 w-me-40">
                                <span class="font-15 font-weight-bold cl_amount_all"
                                      style="float: right;">{{number_format($totalDebt, isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}</span>
                    ...
                    <span>
                        ...
                        <button type="button" onclick="customer.submitQuickReceiptDebt('{{$customerId}}', 1, 'debt')"
                                class="btn btn-primary color_button son-mb  m-btn m-btn--icon m-btn--wide m-btn--md m--margin-left-10"><span>{{__('THANH TOÁN & IN CÔNG NỢ')}}</span></button>
                        <button type="button" onclick="customer.submitQuickReceiptDebt('{{$customerId}}', 0, '')"
