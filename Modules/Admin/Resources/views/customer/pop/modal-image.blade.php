<div class="modal fade show" id="modal-image-customer" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <form id="form-img">
                    <div class="form-group m-form__group ">
                        ...
                        <div class="m-dropzone dropzone dz-clickable" action="{{route('admin.upload-image')}}" id="dropzoneCustomer">
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit w-100">
                    <div class="m-form__actions m--align-right">
                        <button type="button" onclick="$('#modal-image-customer').modal('hide');"
                        ...
                        <button class="btn btn-success color_button son-mb  m-btn m-btn--icon m-btn--wide m-btn--md
                            m--margin-left-10" onclick="customer.submitImageCustomer()">
							<span>
