                    ...
                    @else
                        ...
                        @if(in_array('admin.customer_appointment.submitModalAdd',session('routeList')))
                            <a href="javascript:void(0)"
                               onclick="customer_appointment.click_modal('{{Carbon\Carbon::now()->format('d/m/Y')}}', '{{$item['customer_id']}}')"
                        ...
                        {{-- @if(in_array('customer-lead.create',session('routeList')))
                            <button type="button"
                                    onclick="callCenter.showModalCreateLead('{{$item['customer_id']}}', 'customer')"
            ...
            <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="form-group m-form__group">
                                <div class="row">
                                    <div class="col-lg-7">
                                        <div class="form-group m-form__group">
                                            <span style="font-weight: bold;font-size: 15px">{{$item['full_name']}}</span>
                                        </div>
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">
                                                <i class="fa fa-birthday-cake icon_color"></i>
                                        ...
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">
                                                <i class="la la-phone icon_color"></i> {{$item['phone1']}}
                                            </span>
                                        </div>
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">
                                                <i class="la la-map-marker icon_color"></i>
                                        ...
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">
                                                <i class="la la-envelope icon_color"></i>
                                                    @if($item['email']!=null)
                                                    {{$item['email']}}
                                                @else
                                                    @lang("Trống")
                                        ...
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">
                                                <i class="la la-facebook icon_color"></i>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="form-group m-form__group">
                                            <a class="btn btn-sm color_code">
                                                @lang("Mã KH"): {{$item['customer_code']}}
                                            </a>
                                        </div>
                                        <div class="form-group m-form__group">
                                                <span class="sz_dt">
                                                    @lang("Hạng"): <span style="font-weight: 800">
                                                    {{$item['member_level_name'] != null ? __($item['member_level_name']) : ''}}
                                                    </span>
                                                    @if($item['member_level_name'] != null)
                                                        @if($item['member_level_id'] == 1)
                                                            <i class="fa flaticon-presentation icon_color"></i>
                                                        @elseif($item['member_level_id'] == 2)
                                                            <i class="fa flaticon-confetti icon_color"></i>
                                                        @elseif($item['member_level_id'] == 3)
                                                            <i class="fa flaticon-medal icon_color"></i>
                                                        @elseif($item['member_level_id'] == 4)
                                        ...
                                        <div class="form-group m-form__group">
                                                <span class="sz_dt">
                                                    @lang("Điểm"):
                                                    <span style="font-weight: 800">{{$item['point']}}</span>
                                                </span>
                                        </div>
                                        <div class="form-group m-form__group">
                                            <div class="progress">
                                                <div title="{{$item['point']}}" class="progress-bar" role="progressbar"
                                                     style="width: {{$item['point']}}%;" aria-valuenow="25"
                                                     aria-valuemin="0" aria-valuemax="{{$memberLevel['point']}}">
                                                    {{$item['point']}}
                                                </div>
                                            </div>
                                        </div>
                                        <div style="text-align:right;">
                                            <span class="color" style="font-size: 1.1rem">
                                                {{__($memberLevel['name'])}}
                                            </span>
                                        </div>
                                        <div class="form-group m-form__group">
                                            <span class="sz_dt">@lang("Nhóm khách hàng"): {{$item['group_name']}} </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="form-group row">
                        <div class="col-lg-5">
                            <div class="form-group m-form__group">
                                <span class="sz_dt">@lang("Công nợ")
                                    : <strong>{{number_format($amountDebt)}} @lang('đ')</strong>
                                </span>
                            </div>
                            <div class="form-group m-form__group">
                                <span class="sz_dt">@lang("Tiền trong ví")
                                    : <strong>{{number_format($customer_money)}} @lang('đ')</strong></span>
                            </div>
                            <div class="form-group m-form__group">
                                <span class="sz_dt">@lang("Hoa hồng")
                                    : <strong>{{number_format($commission_money)}} @lang('đ')</strong></span>&nbsp;
                        ...
                        <div class="col-lg-7">
                            <div class="form-group m-form__group">
                                <span class="sz_dt">@lang("Nguồn khách hàng"): {{$item['customer_source_name']}}</span>
                            </div>
                            <div class="form-group m-form__group">
                                <span class="sz_dt">@lang("Người giới thiệu")
                                    : {{$itemRefer != null ? $itemRefer['full_name_refer'] : ''}}</span>
                            </div>
                            <div class="form-group m-form__group">
                                <label>@lang('Ảnh kèm theo'):</label>
                            </div>
                            ...
                            <div class="form-group m-form__group">
                                <label>@lang('File kèm theo'):</label>
                    ...
                    <div class="form-group m-form__group">
                        <span class="sz_dt">{{__('Ghi chú')}}: {{$item['note']}}</span>
                    </div>
                </div>
            </div>
