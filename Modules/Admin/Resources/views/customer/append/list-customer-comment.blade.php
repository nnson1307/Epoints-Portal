    ...
    <div class="row scroll-chat">
        <table class="table table-message table-message-main">
            ...
            @foreach($listComment as $item)
                <tr class="tr_{{$item['customer_comment_id']}}">
                    <td>
                    ...
                    <td>
                        ...
                        <p class="mb-0"><a href="javascript:void(0)" class="reply_message" onclick="CustomerComment.showFormChat({{$item['customer_comment_id']}})">{{ __('managerwork::managerwork.answer') }} </a> {{\Carbon\Carbon::parse($item['created_at'])->diffForHumans(\Carbon\Carbon::now()) }}</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border-top: none;">
                        <table class="table-message">
                            <tbody class="tr_child_{{$item['customer_comment_id']}}">
