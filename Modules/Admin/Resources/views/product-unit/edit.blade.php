    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                <!--begin::Form-->
                {!! Form::model($item, ['method' => 'post','class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed','route' => ['product-unit.submitedit',$item->product_unit_id]]) !!}
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 {{ $errors->has('product_unit_name') ? ' has-danger' : '' }}" >
                            ...
                            <span class="m-form__help">
									Vui lòng nhập tên đơn vị sản phẩm
								</span>
                        </div>
                        <label class="col-lg-2 col-form-label">
                            {{__('Trạng thái')}}:
                    ...
                    <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8{{ $errors->has('product_unit_description') ? ' has-danger' : '' }}">
                                {!! Form::textarea('product_unit_description', $item['product_unit_description'], ['style'=>'max-height:100px;','class' => 'form-control m-input', 'placeholder' => 'Nhập thông tin mô tả']) !!}
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/product-unit/list.js')}}" type="text/javascript"></script>
@stop
