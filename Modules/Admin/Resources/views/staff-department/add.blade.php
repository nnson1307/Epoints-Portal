    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {!! Form::open(['route'=>'admin.staff-department.submitadd','class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                        ...
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <a href="{{ route('admin.staff-department') }}" class="btn btn-secondary">Cancel</a>
