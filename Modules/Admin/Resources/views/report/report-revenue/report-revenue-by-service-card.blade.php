    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__body">
            <div class="m-form m-form__group m-form--label-align-right">
                <div class="row">
                    <div class="col-lg-3 align-conter1 ss--text-white form-group">
                        <div class="tongtien">
                            <div class="m-demo__preview ss--padding-30">
                    ...
                    <div class="col-lg-3 form-group">
                        <select name="number-service-card" style="width: 100%" id="number-service-card"
                                class="form-control m_selectpicker">--}}
            ...
            <div class="form-group m-form__group m--margin-top-10">
                <div id="container" style="min-width: 280px; height: 273px;" class="load_ajax"></div>
            </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/admin/report/report-revenue/by-service-card.js   ')}}"
