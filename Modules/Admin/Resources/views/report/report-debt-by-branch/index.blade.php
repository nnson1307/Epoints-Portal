            ...
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group">
                        <div class="m--margin-top-5 load_ajax" id="container" style="min-width: 280px; height: 273px;"></div>
                    </div>
                </div>
            </div>
            <!--end::Portlet-->
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/admin/report/report-debt/report-branch.js')}}" type="text/javascript"></script>
    <script>
