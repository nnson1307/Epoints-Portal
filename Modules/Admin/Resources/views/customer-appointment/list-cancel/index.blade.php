    ...
    <div class="m-portlet m-portlet--head-sm" >
        ...
        <div class="m-portlet__body" id="autotable">
                ...
                <div class="row padding_row">
                    ...
                    <div class="col-lg-3 form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-5 form-group">
                                <a href="javascript:void(0)" onclick="list_cancel.refresh()"
            ...
            <div class="table-content m--padding-top-30">
                @include('admin::customer-appointment.list-cancel.list')
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/customer-appointment/list-cancel.js')}}" type="text/javascript"></script>
@stop
