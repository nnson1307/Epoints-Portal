        ...
        <div class="modal-content">
                        ...
                        <div class="input-group">
                            <select class="form-control" id="staff_id" name="staff_id" disabled
                                ...
                                @foreach($optionStaff as $v)
                                    <option value="{{$v['staff_id']}}" {{$v['staff_id'] == $item['staff_id'] ? 'selected' : ''}}>
                                        {{$v['full_name']}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input" id="staff_money" name="staff_money"
                                value="{{number_format($item['staff_money'], isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}">
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="button" onclick="edit.save('{{$item['id']}}')"
