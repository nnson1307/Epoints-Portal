            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{__('DANH SÁCH NGUỒN KHÁCH HÀNG')}}
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('customer-source.add',session('routeList')))
        ...
        <div class="m-portlet__body">
            ...
            <form class="frmFilter ss--background">
                <div class="row ss--bao-filter">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group m-form__group">
                            <button onclick="customerSource.search()"
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/customer-source/list.js?v='.time())}}"
