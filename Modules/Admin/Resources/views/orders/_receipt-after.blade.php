                ...
                <div class="col-lg-5">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="m-input-icon m-input-icon--left">
                            <span class="">
                                    <input id="search" name="search" autocomplete="off" type="text" onkeyup="order.searchItem('search',event)"
                    ...
                    <div id="list-product">
                        <div class="demo-index m-scrollable m-scroller ps ps--active-y" data-scrollbar-shown="true" data-scrollable="true" data-height="300" style="overflow:hidden; height: 300px">
                                    ...
                                    <table class="table table-striped m-table m-table--head-bg-default" id="table_add">
                                        ...
                                        @foreach($order_detail as $key=>$item1)
                                            ...
                                            <tr class="tr_table {{in_array($item1['object_type'], ['product_gift', 'service_gift', 'service_card_gift']) ? 'promotion_gift' : ''}}">
                                                ...
                                                <td class="td_vtc td_vtc_{{$item1['order_detail_id']}}"  style="width: 115px;">
                                                ...
                                                <td class="td_vtc" style="width: 200px;">
                                                    <select class="form-control staff" name="staff_id"
                                                        ...
                                                        @foreach($staff_technician as $key => $value)
                                                            <option value="{{$key}}" {{in_array($key, $item1['staff_id'])  ? 'selected' : '' }}>{{$value}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                        ...
                        @if($is_payment_order == 1)
                            <div class="form-group col-lg-4">
                                <button type="button" onclick="processPayment.editPaymentAction('{{$paymentType}}')" id="btn_order"
                                        class="btn btn-metal btn-lg m-btn son-mb m-btn m-btn--icon wd_type m-btn--wide m-btn--md" style="background-color: #FF794E">
                                    {{__('THANH TOÁN')}}
                                </button>
                            </div>
                        @endif
