        ...
        <div class="subpage">
            ...
            <div class="form-group row_custom clearfix">
                ...
                <div class="col-print-5">
                    ...
                    <span class="font-size-14">
                        <strong>@lang('Ngày giờ bán')
                            :</strong> {{\Carbon\Carbon::parse($order['created_at'])->format('d/m/Y H:i:s')}}
                    </span> <br>
                    <span class="font-size-14">
                ...
                <table class="table table-bordered">
                    ...
                    @if (isset($order_detail) && count($order_detail) > 0)
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                {{number_format($totalDiscountDetail, isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}
                            </td>
                            <td>
