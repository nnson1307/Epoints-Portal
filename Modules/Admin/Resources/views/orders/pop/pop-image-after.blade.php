<div class="modal fade show" id="modal-image-after" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <form id="form-img">
                    <div class="form-group m-form__group ">
                        ...
                        <div class="m-dropzone dropzone dz-clickable" action="{{route('admin.upload-image')}}" id="dropzoneAfter">
                    ...
                    <div class="row" style="display:flex;justify-content:center;" id="up-image-after-temp">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit w-100">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button class="btn btn-success color_button son-mb  m-btn m-btn--icon m-btn--wide m-btn--md
                            m--margin-left-10" onclick="detail.saveImage('{{$order['order_code']}}', 'after')">
							<span>
