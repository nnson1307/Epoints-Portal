                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            ...
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Avenir,Time,sans-serif;font-size:26px;color:#222222;'><span
                                                                                                class="specbundle2"><span
                                                                                                    class="font1">
								  {{__('Thanh toán đơn hàng thành công')}}
								  </span></span></p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td valign='top' align='center'>
                                                                <div class="contentEditableContainer contentImageEditable">
                                                                    <div class="contentEditable">
                                                                        <img src="{{asset('uploads/admin/template-email/line.png')}}" width='251'
                                                                             height='43' alt=''
                                                ...
                                                <table style="width:100%;border:1px solid black;border-collapse: collapse;">
                                                    <thead>
                                                    <tr style="border:1px solid black;border-collapse: collapse;padding: 15px;font-weight:bold;">
                                                        <td>{{__('STT')}}</td>
