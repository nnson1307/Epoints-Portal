    ...
    <tr>
        <td>
            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0" style="background: #ccc">
                ...
                <tr>
                    <td>
                        <table bgcolor="#fff" class="top " width="100%" align="left" cellpadding="0"
                               cellspacing="0"
                               style="padding:10px 10px 10px 10px; text-align:right;background-image: url({{asset('static/backend/images/template-email/header-line.png')}});background-position: top;background-repeat: no-repeat;background-size: 100%;">
                ...
                <tr>
                    <td>
                        <table bgcolor="{{'#'.$config_template->background_header}}" class="top" width="100%"
                            ...
                            <tbody>
                            <tr>
                                <td style="text-align:center; font-family: sans-serif;width: 70%;text-align: left;padding-left: 10px;">
                                    <span class="size_title"
                                          style="font-size:14px;font-weight: bold; color:{{'#'.$config_template->color_header}};text-transform: uppercase;vertical-align: middle;">
                                        {{$title}}
                                    </span>
                                </td>
                                <td style="font-size: 16px; color:#929292;font-family: sans-serif;width: 30%;text-align: center;">
                                    ...
                                    @endif
                                    <span class="size_title"
                                          style="font-weight: bold; color:{{'#'.$config_template->color_header}};text-transform: uppercase;">
                                        {{$spa_info->name}}
                                    </span>
                                </td>
                            </tr>
                ...
                <tr>
                    ...
                    <td style="background: #f4f4f4;padding-right: 20px;padding-left: 20px;">
                        <table width="100%" align="left" cellpadding="0" cellspacing="0"
                               style="background: {{'#'.$config_template->background_body}};">
                            <tr>
