...
<table width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td>
            <table width="900" align="center" cellpadding="0" cellspacing="0" style="background: #ccc">
                <tbody>
            ...
            <table width="900" align="center" cellpadding="0" cellspacing="0" style="background: #ccc">
                ...
                <tr style="width: 100%;">
                    ...
                    <td class="table_info" valign="top"
                        style="background: {{'#'.$config_template->background_body}};padding-right: 20px;padding-left: 20px;padding-top: 10px;padding-bottom: 20px;border-right: 1px dashed #ccc;">
                        <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <td class="footer-responsive"
                                    ...
                                    @else
                                        <img src="{{asset('static/backend/images/template-email/logo-slider.png')}}"
                                             ...
                                             height="70px"><br>
                                    @endif
                                    <span style="font-weight: bold; color:{{'#'.$config_template->color_body}};text-transform: uppercase;">{{$spa_info->name}}</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left"
                                    ...
                                    <span class="font_res"
                                          style="margin-bottom: 10px;font-size: 14px;font-weight: bold;color:{{'#'.$config_template->color_body}};text-transform: uppercase;">{{$title}}</span><br>
                            ...
                            @if($type=='paysuccess')
                                <tr>
                                        ...
                                        <table width="100%" style="margin-bottom: 15px;border-collapse: collapse;">
                                            ...
                                            @foreach($order_detail as $key=>$value)
                                                <tr style="border-bottom: 1px dashed #ccc;">
                                                    ...
                                                    <td style="width: 160px;padding-right: 15px;line-height: 16px;padding:10px 20px 10px 0;">
                                                        {{$value['object_name']}}
                                                    </td>
                                    ...
                                    <td class="footer-responsive" align="left"
                                                ...
                                                <tr style="border-bottom: 1px dashed #ccc;width: 100%;">
                                                    <td>
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td style="padding-top:5px;font-size: 11px;">
                                                                    @if($value['object_type']=='service')
                                                                        <span><strong>@lang('Dịch vụ')
                                                                                : {{$value['object_name']}}</strong></span>
                                                                        <br>
                                                                    @elseif($value['object_type']=='product')
                                                                        <span><strong>@lang('Sản phẩm')
                                                                                : {{$value['object_name']}}</strong></span>
                                                                        <br>
                                                                    @elseif($value['object_type']=='service_card')
                                                                        <span><strong>@lang('Thẻ dịch vụ')
                                                                                : {{$value['object_name']}}</strong></span>
                                                                        <br>
                                                                    @else
                                                            ...
                                                            <tr>
                                                                <td style="font-size: 11px;width: 80px;">{{__('Giá')}}
                                                                    :
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-size: 11px;width: 80px;">{{__('Số lượng')}}
                                                                    :
                                                                </td>
                                                                <td style="font-size: 11px;">
                                                            ...
                                                            <tr>
                                                                <td style="font-size: 11px;width: 80px;">{{__('Giảm')}}
                                                                    :
                                                                </td>
                                                                <td style="font-size: 11px;">
                                            ...
                                            <tr style="border-bottom: 1px dashed #ccc;">
                                                <td style="width: 100%;">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size: 11px;width: 80px;">{{__('Tổng tiền')}}
                                                                :
                                                            </td>
                                                            <td style="font-size: 11px;">
                                            ...
                                            <tr>
                                                <td style="padding-left:10px;">
                                                    <table>
                                                        ...
                                                        <tr class="footer-responsive font_res">
                                                            <td>
                                                                <span class="size">{{__('Kỹ thuật viên phục vụ')}}
                                                                    :</span>
                                ...
                                <td style="background: #fff;">
                                    <table width="100%" align="left" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <!-- Row container for Intro/ Description -->
                                            <td align="left"
                                                style="font-size: 13px; font-style: normal; font-weight: 100; color: black; line-height: 1.8; text-align:center; padding:0 20px 0 20px; font-family: sans-serif;background: {{'#'.$config_template->background_footer}};">
                                                <table class="border-footer" width="100%"
                                                    ...
                                                    <tr class="footer-responsive">
                                                        <td style="text-align: left;padding-top: 10px;">
                                                            <span style="font-size:13px;font-weight: bold;">{{__('Địa chỉ')}}
                                                                :</span>
                                                            ...
                                                            <span style="font-size: 13px;"><strong>{{__('Điện thoại')}}
                                                                    :</strong> {{$spa_info->phone}}</span><br>
                                                            {{--<span style="font-size: 13px;"><strong>{{__('Website')}}:</strong> www.piospa.com</span><br>--}}
                                                            <span style="font-size:13px;font-weight: bold;">{{__('Thời gian làm việc')}}
                                                                :</span><br>
                    ...
                    <td class="table_address" style="background: #fff;" valign="top">
                        <table class="tb_res" width="100%" cellpadding="0" cellspacing="0"
                               style="background: {{'#'.$config_template->background_header}};float: left;">
                            <tr>
                                <!-- Row container for Intro/ Description -->
                                <td style="font-size: 13px; font-style: normal; font-weight: 100; color: black; line-height: 1.8; text-align:center; padding:10px 20px 0px 20px; font-family: sans-serif;border-bottom: 1px dashed #ccc;">
                                    @if($spa_info->logo!=null)
                                        <img src="{{asset($spa_info->logo)}}" width="90px" height="70px"><br>
                                    @else
                                        <img src="{{asset('static/backend/images/template-email/logo-slider.png')}}"
                                    ...
                                    <span class="size_title"
                                          style="font-size:16px;font-weight: bold; color:{{'#'.$config_template->color_header}};text-transform: uppercase;">
                                        {{$spa_info->name}}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    style="font-size: 14px; font-style: normal; font-weight: 100; color:{{'#'.$config_template->color_header}}; line-height: 1.8; text-align:justify; padding:10px 20px 0px 20px; font-family: sans-serif;">
                                    ...
                                    <span>{{__('Điện thoại')}}: <strong>{{$spa_info->phone}}</strong></span><br>
