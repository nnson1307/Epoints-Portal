            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0" style="background: #ccc">
                ...
                <tr>
                    ...
                    <td style="background: #55ccb9;padding-right: 20px;padding-left: 20px;">
                        <table width="100%" align="left" cellpadding="0" cellspacing="0" style="background: {{'#'.$config_template->background_body}};">
                            <tr>
                                ...
                                @if($config_template->image!=null)
                                    <td style="font-style: normal;  line-height: 1.8; text-align:center; padding:10px 20px 0px 20px; font-family: sans-serif;height: 100px;vertical-align: middle;background-image: url({{asset($config_template->image)}});background-size:  cover;">
                                        <span style="font-size: 14px;color: #fff;font-weight: bold;text-transform: uppercase;">{{$title}}</span>
                                    </td>
                                @else
                                ...
                                <td align="left" class="font_res"
                                    ...
                                    @if($type=='print_card')
                                        @foreach($content_sent as $item)
                                            <img class="img-card" src="{{asset($item)}}" style="margin-bottom: 15px;width: 80%;"/>
                                        @endforeach
                                    @else
                                        {!! $content !!}
                                    @endif
                                                ...
                                                <tr style="border-bottom: 1px dashed #ccc;width: 100%;">
                                                    <td>
                                                        <table style="width: 100%;">
                                                            ...
                                                            <tr>
                                                                <td style="padding-bottom: 5px;font-size: 11px;width: 80px;">{{__('Thành tiền')}}:
                                                                </td>
                    ...
                    <td style="background: #55ccb9;padding-right: 20px;padding-left: 20px;">
                        <table width="100%" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                                <!-- Row container for Intro/ Description -->
                                <td align="left"
                                    style="font-size: 13px; font-style: normal; font-weight: 100;  line-height: 1.8; text-align:center; padding:0 20px 0 20px; font-family: sans-serif;background: {{'#'.$config_template->background_footer}};">
