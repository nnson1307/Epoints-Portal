        ...
        @if(isset($LIST))
            @foreach ($LIST as $key => $value)
                <tr>
                    ...
                    <td style="text-align: center" class="ss--nowrap">{{$value['created_by']}}</td>
                    <td style="text-align: center"
                        class="ss--nowrap">{{(new DateTime($value['created_at']))->format('d/m/Y')}}</td>
                    <td style="text-align: center" class="ss--nowrap">{{$value['sent_by']}}</td>
                    <td style="text-align: center"
                        class="ss--nowrap">{{($value['time_sent'] != null)?(new DateTime($value['time_sent']))->format('d/m/Y'):''}}</td>
                    <td style="text-align: center" class="ss--nowrap">
                        {{$value['totalMessage']}}
                    </td>
