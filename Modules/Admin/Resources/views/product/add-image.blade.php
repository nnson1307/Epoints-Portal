                    ...
                    <div class="input-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 ss--padding-left-0">
                            <div class="m-dropzone dropzone m-dropzone--primary dz-clickable"
                                 action="{{route('admin.upload-image')}}" id="dropzoneImageProduct">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m--align-right">
                        <button data-dismiss="modal"
                                class="m--margin-bottom-5 btn btn-metal m-btn m-btn--icon m-btn--wide m-btn--md ss--btn">
						<span>
                        ...
                        <div class="btn-group">
                            <button class="btn ss--button-cms-piospa ss--btn m-btn m-btn--icon m-btn--wide m-btn--md btn-save-image m--margin-left-10 m--margin-bottom-5">
							<span>
