    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                <!--begin::Form-->
                {!! Form::model($item, ['method' => 'post','route' => ['order-delivery-type.edit', $item->order_delivery_type_id],'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 {{ $errors->has('order_delivery_type_name') ? ' has-danger' : '' }}" >
                            ...
                            @if ($errors->has('order_delivery_type_name'))
                                ...
                                <br>
                            @endif
                            <span class="m-form__help">{{__('Vui lòng nhập tên trạng thái giao hàng')}}</span>
