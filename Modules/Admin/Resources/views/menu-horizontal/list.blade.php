            ...
            <td>
                @if ($item['is_actived'])
                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                        <label style="margin: 0 0 0 10px; padding-top: 4px">
                            <input type="checkbox"
                                   onchange="listMenu.changeStatus('{{$item['admin_menu_function_id']}}', 0, '{{$item['admin_menu_category_id']}}')"
                                   name="" checked>
                            <span></span>
                        </label>
                    </span>
                @else
                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                        <label style="margin: 0 0 0 10px; padding-top: 4px">
                            <input type="checkbox"
                                   onchange="listMenu.changeStatus('{{$item['admin_menu_function_id']}}', 1, '{{$item['admin_menu_category_id']}}')"
                                   name="">
                            <span></span>
                        </label>
                    </span>
