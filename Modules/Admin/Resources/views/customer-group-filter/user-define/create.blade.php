                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            {{ __('TẠO MỚI NHÓM KHÁCH HÀNG TỰ ĐỊNH NGHĨA') }}
                        </h3>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-3 form-group">
                        <input type="text" name="define_full_name_1" id="define_full_name_1" class="form-control"
                            placeholder="{{ __('Họ tên khách hàng') }}" value="">
                    </div>
                    <div class="col-lg-3 form-group">
                        <input type="text" name="define_phone_1" id="define_phone_1" class="form-control"
                            placeholder="{{ __('Số điện thoại') }}" value="">
                    </div>
                    <div class="col-lg-3 form-group">
...
@section('after_script')
    <script src="{{ asset('static/backend/js/admin/user-group/add-user-group-define.js') }}" type="text/javascript">
    </script>
@stop
