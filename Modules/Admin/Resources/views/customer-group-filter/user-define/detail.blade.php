            ...
            <div class="m-portlet__body">
                <div class="form-group">
                    ...
                    <input class="form-control" id="name" autocomplete="off"
                           placeholder="{{__('Nhập tên nhóm khách hàng')}}" name="name" type="text" readonly
                    value="{{$data['name']}}">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/admin/user-group/edit-user-group-define.js')}}"
