<div class="table-responsive">
    <table class="table table-striped m-table m-table--head-bg-default">
        ...
        <tr>
            ...
            <th class="tr_thead_list">{{__('LOẠI ĐƠN HÀNG')}}</th>
            ...
            @foreach ($LIST as $key => $item)
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($item['order_source_id'] == 3)
                            <a class="m-link" target="_blank" title="{{__('Chi tiết')}}"
                               href="{{route('fnb.orders.detail',$item['order_id'])}}">
                                {{$item['order_code']}}
                            </a>
                        @endif
                    </td>
                        <td>
                            {{isset($item['order_source_name']) ? $item['order_source_name'] : ''}}
                        </td>
                    <td>
