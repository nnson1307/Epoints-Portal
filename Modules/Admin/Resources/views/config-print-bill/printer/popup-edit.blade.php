        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="fa fa-plus-circle"></i> @lang('Cập nhật máy in')
                </h5>
            </div>
                    ...
                    <div class="row">
                                ...
                                <div class="input-group m-input-group">
                                    <select class="form-control" id="branch_id" name="branch_id">
                                        @foreach($optionBranch as $v)
                                            <option {{$printer->branch_id == $v['branch_id']?'selected':''}} value="{{$v['branch_id']}}">{{$v['branch_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="black_title">
                                <select name="template" id="template" class="form-control class-select2"
                                        style="width: 100%">
                                    <option {{$printer->template=='k80'?'selected':''}} value="k80">K80</option>
                                    <option {{$printer->template=='k58'?'selected':''}} value="k58">K58</option>
                                    <option {{$printer->template=='A5'?'selected':''}} value="A5">A5</option>
                                    <option {{$printer->template=='A4'?'selected':''}} value="A4">A4</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" class="form-control m-input" id="printer_port" name="printer_port"
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="input-group row">
                                    ...
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                        <label>
                                            <input id="is_default"
                                                   {{$printer->is_default==1?'checked':''}}
                                                   value="{{$printer->is_default==1?'on':'off'}}"
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="input-group row">
                                    ...
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                        <label>
                                            <input id="is_actived"
                                                   {{$printer->is_actived==1?'checked':''}}
                                                   value="{{$printer->is_actived==1?'on':'off'}}"
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    ...
                    <button type="button" onclick="edit.save({{$printer->print_bill_device_id}})"
