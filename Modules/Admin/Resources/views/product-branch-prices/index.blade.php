    ...
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{__('QUẢN LÝ GIÁ SẢN PHẨM')}}
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('admin.product-branch-price.config',session('routeList')))
                    <a href="{{route('admin.product-branch-price.config')}}"
                       class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn_add_pc btn-sm">
                        <span>
						    <i class="fa fa-plus-circle m--margin-right-5"></i>
							<span>{{__('CẤU HÌNH GIÁ SẢN PHẨM')}}</span>
                        </span>
                    </a>
                    <a href="{{route('admin.product-branch-price.config')}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill
        ...
        <div class="m-portlet__body" id="autotable">
            ...
            <div class="table-content m--padding-top-30">
                ...
                @include('admin::product-branch-prices.list')
                {{--                        </div>--}}
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/admin/product-branch-prices/script.js?v='.time())}}"
