            ...
            <div class="m-portlet__body">
                ...
                @switch($detail['type'])
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-10">
                            <input type="text" id="value" name="value" value="{{$detail['value']}}"
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-10 form-group">
                            <select class="form-control select-fix" name="value" id="value">
                    ...
                    @foreach($configDetail as $item)
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-4 config-detail">
                                <input type="number" name="{{$item['key']}}" class="form-control input-number input-config-detail" {{$detail['value'] == 0 ? "disabled" :""}} value="{{$item['value']}}">
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m--align-right">
                        ...
                        <a href="javascript:void(0)"
                           onclick="edit.updateConfigByType({{$detail['config_id']}}, '{{$detail['type']}}')"
