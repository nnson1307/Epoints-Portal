<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title ss--title m--font-bold">
            ...
            {{__('CHỈNH SỬA CA LÀM VIỆC')}}
        </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
    <div class="modal-body">
        <input type="hidden" id="shift-id-hidden">
        <div class="form-group">
            <label>
                {{__('Thời gian bắt đầu')}}:<b class="text-danger">*</b>
            </label>
            <div class="m-input-icon m-input-icon--right">
                <input id="start-time-edit" readonly="" type="text" class="form-control"
                       placeholder="{{__('Nhập thời gian bắt đầu')}}">
                <span class="m-input-icon__icon m-input-icon__icon--right">
                                    <span><i class="la la-clock-o"></i></span></span>
            </div>
            <span class="err error-start-time-edit"></span>
        </div>
        <div class="form-group">
            <label>
            ...
            <div class="m-input-icon m-input-icon--right">
                <input type="text" readonly="" id="end-time-edit" class="form-control"
                       placeholder="{{__('Nhập thời gian kết thúc')}}">
                <span class="m-input-icon__icon m-input-icon__icon--right">
                                    <span><i class="la la-clock-o"></i></span></span>
            </div>
            <span class="err error-end-time-edit"></span>
        </div>
        {{--<div class="form-group">--}}
        {{--<label>--}}
        {{--Trạng thái :--}}
        ...
        {{--<input id="is-actived-edit" type="checkbox">Hoạt động--}}
        {{--<span></span>--}}
        {{--</label>--}}
        {{--</div>--}}
        {{--</div>--}}
