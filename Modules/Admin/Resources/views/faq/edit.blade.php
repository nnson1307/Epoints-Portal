        ...
        <form action="{{ route('admin.faq.store') }}" method="POST" id="form-submit">
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control{{ $errors->has('faq_group_title') ? ' is-invalid' : '' }}" value="{{$detail['faq_title_vi']}}"
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control{{ $errors->has('faq_group_title') ? ' is-invalid' : '' }}" value="{{$detail['faq_title_en']}}"
            ...
            <input type="hidden" name="faq_id" id="faq_id" value="{{$detail['faq_id']}}">
        </form>
    </div>
@endsection
@section("after_style")
