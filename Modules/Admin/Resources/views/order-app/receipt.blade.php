                                                ...
                                                <td colspan="2" class="td_staff">
                                                    <select class="form-control staff staff_{{$key+1}}" name="staff_id"
                                                        ...
                                                        @foreach($staff_technician as $value)
                                                            <option value="{{$value['staff_id']}}" {{in_array($value['staff_id'], $item1['staff_id'])  ? 'selected' : '' }}>{{$value['full_name']}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                ...
                                <select class="form-control"
                                    ...
                                    @foreach($customer_refer as $key => $value)
                                        @if($value['customer_id'] != 1)
                                            <option value="{{$value['customer_id']}}" {{$item['refer_id'] == $value['customer_id'] ? 'selected':''}}>{{$value['full_name']}}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
