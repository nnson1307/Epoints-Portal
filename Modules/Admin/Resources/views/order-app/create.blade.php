...
@section('content')
    ...
    {{--    @include('admin::orders.modal-address-contact')--}}
    <!--begin::Portlet-->
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="form-group row m--margin-left-5 m--margin-right-5"
                        ...
                        <div class="col-lg-6 bdr">
                            ...
                            <div class="form-group row m--margin-right-5">
                                <select class="form-control" id="refer_id" name="refer_id" style="width:100%;">
                                    <option></option>
                                    @foreach($customer_refer as $value)
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row m--margin-left-5">
                                <div class="m-list-timeline__items">
                                    <div class="m-list-timeline__item sz_bill">
                    ...
                    <div class="row">
                        @if($is_payment_order == 1)
                            <div class="form-group col-lg-4">
                                <button type="button" onclick="processPayment.createPaymentAction('order-online')"
                                        id="btn_order"
    ...
    <input type="hidden" id="customer_contact_code">
    <input type="hidden" id="custom_price" name="custom_price" value="{{$customPrice}}">
    <input type="hidden" id="receive_at_counter" value="0">
...
@section('after_script')
        ...
        <div class="col-lg-8">
            <div class="form-group">
                ...
                <span class="m-widget4__title m-font-uppercase">{{__('Khách vãng lai')}}
                                <span class="m-badge m-badge--success vanglai"
                                      data-toggle="m-tooltip" data-placement="top" title=""
                                      data-original-title="Khách mới"></span>
                                </span>
        ...
        <div class="col-lg-8">
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    ...
                    <span class="m-badge m-badge--success vanglai"
                          data-toggle="m-tooltip" data-placement="top" title=""
                          data-original-title="Thành viên"></span>
                     </span>
                    <br>
                    ...
                    @lang('Hạng'): {member_level_name} {icon}
                    </span>
                    <br>
                    <span class="m-widget4__title">
                    ...
                    {{--                       href="javascript:void(0)" onclick="create.modal_address_contact()" title="edit-address">--}}
                    {{--                        <i class="la la-edit"></i>--}}
                    {{--                    </a>--}}
                    <input type="hidden" id="customer_id" value="{customer_id}">
                    <div id="popup-customer-contact"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
    ...
    <script type="text/template" id="active-card-tpl">
        <a href="javascript:void(0)" onclick="order.modal_card({id})"
           class="m-btn m-btn--pill m-btn--hover-brand btn btn-sm btn-secondary active-a"><i class="la la-plus"></i>
            {{__('Thẻ dịch vụ đã mua')}}</a>
    </script>
    ...
    <script src="{{asset('static/backend/js/admin/order-app/create.js?v='.time())}}" type="text/javascript"></script>
    <script src="{{asset('static/backend/js/admin/order-app/customer-address.js?v='.time())}}"
            type="text/javascript"></script>
    ...
    <script type="text/template" id="payment_method_tpl">
        <div class="row mt-3 method payment_method_{id}">
            ...
            <div class="input-group input-group-sm col-lg-6" style="height: 30px;">
                ...
                <div class="input-group-append">
                    <button type="button" style="display: {style-display}"
                            onclick="vnpay.createQrCode(this, 'order_online')"
