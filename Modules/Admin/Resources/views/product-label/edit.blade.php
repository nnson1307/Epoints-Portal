    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {!! Form::model($item,['method'=>'POST','route'=>['admin.product-label.submitedit',$item->product_label_id],'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 {{ $errors->has('product_label_name') ? ' has-danger' : '' }}">
                            {!! Form::text('product_label_name', null, ['class' => 'form-control m-input', 'placeholder' => 'Nhập mã']) !!}
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-8{{ $errors->has('product_label_description') ? ' has-danger' : '' }}">
                            {!! Form::textarea('product_label_description', $item['product_label_description'], ['style'=>'max-height:100px;','class' => 'form-control m-input', 'placeholder' => 'Nhập thông tin mô tả']) !!}
