<div class="modal fade ajax people-detail-modal ajax-people-edit-form" method="POST" action="{{route('people.people.ajax-edit')}}" role="dialog">
    <style>
                    ...
                    <div class="m-form__group form-group col-1">
                        ...
                        <div class="row form-group m-form__group m-widget19">
                            <div class="m-widget19__pic">
                                <img class="m--bg-metal  m-image  img-sd" id="blah" height="150px" src="{{$item['avatar']??'https://vignette.wikia.nocookie.net/recipes/images/1/1c/Avatar.svg/revision/latest/scale-to-width-down/480?cb=20110302033947'}}" alt="Hình ảnh">
                            </div>
                        </div>
                    </div>
                    <div class="col-11 info"><div class="row">

                        <div class="col-6 m-portlet m-portlet--head-sm m-0">
                            <div class="m-portlet__head" xonclick="$(this).parent().find('.m-portlet__body').toggleClass('d-none')">
                    ...
                    <div class="m-portlet w-100">
                        ...
                        <div class="">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" data-toggle="tab" href="#" data-target="#m_tabs_1_1">Danh sách phúc tra</a>
                                </li>
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                    <div class="m-form__actions m--align-right">
                        ...
                        @if(in_array('people.people.print-preview',session('routeList')))
                            <a target="_blank" href="{{route('people.people.print-preview')}}?people_id={{$item['people_id']}}">
                            <button type="button""
