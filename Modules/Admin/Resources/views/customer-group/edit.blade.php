<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title ss--title m--font-bold">
            ...
            </i>{{__('CHỈNH SỬA NHÓM KHÁCH HÀNG')}}</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
    <div class="modal-body">
        <input type="hidden" name="customer_group_id_edit">
        <div class="form-group">
            <label>
                {{__('Tên khóm khách hàng')}}:<b class="text-danger">*</b>
            </label>
            <div class="{{ $errors->has('group_name') ? ' has-danger' : '' }}">
                <input type="text" name="group_name_edit" class="form-control m-input"
        ...
        {{--<div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">--}}
            {{--<div class="m-form__actions m--align-right">--}}
                {{--<button data-dismiss="modal"--}}
						...
						{{--</span>--}}
                {{--</button>--}}
                {{--<button type="button" onclick="customerGroup.submitEdit()"--}}
