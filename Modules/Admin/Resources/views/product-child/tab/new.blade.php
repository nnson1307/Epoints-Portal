    ...
    <form class="frmFilter m--margin-bottom-20">
        <div class="row m--margin-bottom-20">
            ...
            <div class="col-lg-6">
                <a href="javascript:void(0)"
                   onclick="productChild.popAdd('new')"
        ...
        <div class="ss--background">
                ...
                <div class="col-lg-3">
                    <div class="form-group m-form__group">
                        <div class="input-group">
                            <input type="hidden" name="type_tab" value="new">
            ...
            <div class="row m--padding-left-15 m--padding-right-15">
                ...
                <div class="col-lg-2">
                    <button href="javascript:void(0)" onclick="productChild.tab('new')"
