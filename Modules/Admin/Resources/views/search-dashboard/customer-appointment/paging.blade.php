        ...
        <ul class="m-datatable__pager-nav" style="float: right">
            @if(count($dataCustomerAppointment)>10)
                @if($pageCustomerAppointment>1)
                    ...
                    <li><a onclick="Paginate.pageClickCustomerAppointment({{$pageCustomerAppointment-1}})" title="Previous"
                ...
                @for ($i=1;$i<$totalPage;$i++)
                    ...
                    @endif
                @endfor
                @if($pageCustomerAppointment<$totalPage-1)
                    <li><a title="Next" class="m-datatable__pager-link" onclick="Paginate.pageClickCustomerAppointment({{$pageCustomerAppointment+1}})"
        ...
        <div class="m-datatable__pager-info" style="float: left">
            <span class="m-datatable__pager-detail">
                @if(count($dataCustomerAppointment)>0)
                    {{__('Hiển thị')}} {{($pageCustomerAppointment-1)*10+1}}
                    - {{($pageCustomerAppointment-1)*10 + count($listCustomerAppointment)}}
