        ...
        <ul class="m-datatable__pager-nav" style="float: right">
            @if(count($dataCustomer)>10)
                @if($pageCustomer>1)
                    ...
                    <li><a onclick="Paginate.pageClickCustomer({{$pageCustomer-1}})" title="Previous"
                ...
                @for ($i=1;$i<$totalPage;$i++)
                    ...
                    @endif
                @endfor
                @if($pageCustomer<$totalPage-1)
                    <li><a title="Next" class="m-datatable__pager-link" onclick="Paginate.pageClickCustomer({{$pageCustomer+1}})"
        ...
        <div class="m-datatable__pager-info" style="float: left">
            <span class="m-datatable__pager-detail">
                @if(count($dataCustomer)>0)
                    {{__('Hiển thị')}} {{($pageCustomer-1)*10+1}}
                    - {{($pageCustomer-1)*10 + count($listCustomer)}}
