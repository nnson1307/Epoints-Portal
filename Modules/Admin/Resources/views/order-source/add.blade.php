    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <div class="{{ $errors->has('order_source_name') ? ' has-danger' : '' }}">
                <input type="text" id="order-source-name" name="order_source_name" class="form-control m-input"
    ...
    <div class="modal-footer">
        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit  ss--width--100">
            <div class="m-form__actions m--align-right">
                ...
                <button type="button" onclick="OrderSource.addClose()"
                ...
                <button class="ss--btn-mobiles btn ss--button-cms-piospa m-btn m-btn--icon m-btn--wide m-btn--md ss--btn m--margin-left-10 m--margin-bottom-5" onclick="OrderSource.add()">
                    <span class="ss--text-btn-mobi">
