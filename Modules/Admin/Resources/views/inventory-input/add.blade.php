            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <select onchange="checkInput()" id="warehouse" class="form-control m_selectpicker">
                        ...
                        <div class="table-responsive">
                            <table id="table-product"
                                ...
                                <tr>
                                    ...
                                    <th class="ss--font-size-th ss--nowrap ss--text-center">{{__('SỐ LƯỢNG')}}</th>
                                    <th class="ss--font-size-th ss--nowrap ss--text-center">{{__('TỔNG TIỀN')}}</th>
                                    <th></th>
                                </tr>
                                </thead>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group m-form__group row">
                                    <label for="example-text-input" class="col-lg-12 col-form-label">
                                        {{__('Tổng số sản phẩm')}}: <b class="total-product ss--text-color">{{__('0 sản phẩm')}}</b>
                                    </label>
                                    <div class="col-lg-4 ss--display-none">
                                        <div class="input-group m-input-group m-input-group--solid">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6 ss--display-none">
                                        <div class="input-group m-input-group m-input-group--solid">
...
@section('after_script')
    ...
    <script type="text/template" id="product-childs">
        <tr class="ss--select2-mini">
            ...
            <td class="name-version ss--font-size-13 m--margin-top-5">{name}
                <input name="hiddencode[]" type="hidden" value="{code}"></td>
            <td valign="top" class="ss--font-size-13 ss--text-center ss--nowrap" style="text-align: center;">
                {price}
                <input style="text-align: right" readonly class="form-control" type="hidden"
                       value="{price}"></td>
            </td>
            ...
            <td class="ss--font-size-13 ss--text-center" style="width: 150px">
                <input id="id-child-{code}" onkeypress="maskNumberPriceProductChild()" onchange="changeCost(this)" name="cost-product-child"
                       data-thousands="," class="price form-control2 m-input change-class ss--text-center ss--width-150"
                       value="{cost}">
            </td>
            <td class="ss--font-size-13 ss--text-center ss--nowrap" style="width: 150px">
                <div class="input-group bootstrap-touchspin ss--touchspin">
                    ...
                    <input onchange="clickNumberProduct(this)"
                           type="text"
                           class="form-control ss--btn-ct number-product change-class ss--text-center ss--width-100-"
    ...
    <script src="{{asset('static/backend/js/admin/inventory-input/add-script.js')}}"
