    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form id="form-list-serial">
                <input type="hidden" name="inventory_input_detail_id" value="{{$inventory_input_detail_id}}">
                ...
                <div class="modal-body">
                    <div class="ss--background">
                        <div class="row ss--bao-filter2">
                            ...
                            <div class="col-6">
                                <button type="button" onclick="InventoryInput.removeSearchSerial()" class="btn btn-primary color_button btn-search">
                                    {{ __('XÓA BỘ LỌC') }}
                                    <i class="fa fa-eraser" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-primary color_button btn-search" onclick="InventoryInput.changePageSerial(1)">
