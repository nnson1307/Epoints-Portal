    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group m-form__group">
                    <label>
                        <strong>{{__('Nhà cung cấp')}}:</strong>
                    </label>
                    <div class="input-group">
                        <select id="supplier" class="form-control m_selectpicker">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 pr-0">
                                ...
                                <input accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                                       id="file_excel" onchange="InventoryInput.fileName()" type="file" style="display: none">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button type="button" onclick="InventoryInput.addInventory()"
