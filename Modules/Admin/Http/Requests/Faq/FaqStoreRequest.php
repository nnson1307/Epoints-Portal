...
class FaqStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'faq_title_vi' => 'required|max:250|unique:faq,faq_title_vi,NULL,faq_id,faq_group,'.$faqGroup.',is_deleted,0',
            'faq_title_en' => 'required|max:250|unique:faq,faq_title_en,NULL,faq_id,faq_group,'.$faqGroup.',is_deleted,0',
