...
class FaqGroupUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'faq_group_title_vi' => 'required|max:250|unique:faq_group,faq_group_title_vi,'.$faqGroupId.',faq_group_id,is_deleted,0',
            'faq_group_title_en' => 'required|max:250|unique:faq_group,faq_group_title_en,'.$faqGroupId.',faq_group_id,is_deleted,0',
