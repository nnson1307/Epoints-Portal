...
class StaffTitleTable extends Model
{
    ...
    /**
     * lấy tất cả chức vụ theo điệu kiện 
     * @param array $listIdTitle
     * @return mixed
     */

    public function getListCondition($listIdTitle)
    {
        return $this->whereIn("staff_title_id", $listIdTitle)->get();
    }
}
