...
class ServiceTable extends Model
{
    ...
    protected $fillable = [
        ...
        'is_remind',
        'remind_value',
        'is_upload_image_ticket',
        'is_upload_image_sample'
    ];
    ...
    protected function _getList($filter = [])
    {
        $ds = $this
            ...
            (
                ...
                'services.created_at',
                'services.updated_at',
                's.full_name as create_full_name',
                'su.full_name as update_full_name',
            ...
            ->leftJoin('staffs as s', 's.staff_id', '=', 'services.created_by')
            ->leftJoin('staffs as su', 'su.staff_id', '=', 'services.updated_by')
...
//                'service_materials.material_detail as material_detail',
                ...
                "{$this->table}.is_upload_image_ticket",
                "{$this->table}.is_upload_image_sample"
...
//                ->orWhere("services.service_code","LIKE","%".$filter["keyword"]."%");
    ...
    public function getItemSearch($name, $id)
    {
        ...
        if ($id != 0) {
            $ds->where('services.service_id', '!=', $id);
        }
        return $ds->get();
    }
}