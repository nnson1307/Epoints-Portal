...
namespace Modules\Admin\Libs\SmsFpt;
require_once realpath(__DIR__) . '/Autoload.php';

TechAPIAutoloader::register();

use Modules\Admin\Libs\SmsFpt\TechAPI\src\TechAPI\Constant;
use Modules\Admin\Libs\SmsFpt\TechAPI\src\TechAPI\Client;
use Modules\Admin\Libs\SmsFpt\TechAPI\src\TechAPI\Auth\ClientCredentials;
