    ...
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h2 class="m-portlet__head-text title_index">
                        <span><i class="la la-server"></i> {{__('DANH SÁCH XÁC NHẬN THÔNG TIN')}}</span>
                    </h2>
        ...
        <div class="m-portlet__body" id="autotable">
            ...
            <div class="table-content m--padding-top-15">
                @include('customer::customer-info-temp.list')
...
@section('after_script')
    <script src="{{asset('static/backend/js/customer/customer-info-temp/list.js?v='.time())}}" type="text/javascript"></script>
@stop
