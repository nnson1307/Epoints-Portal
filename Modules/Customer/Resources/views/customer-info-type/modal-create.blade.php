        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="fa fa-plus-circle"></i> @lang('THÊM LOẠI THÔNG TIN KÈM THEO')
                </h5>
            </div>
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control m-input" id="customer_info_type_name_vi"
                                   name="customer_info_type_name_vi">
                        </div>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
                            @lang('Loại thông tin kèm theo (tiếng Anh)'):<b class="text-danger">*</b>
                        </label>
                        <div class="input-group">
                            <input type="text" class="form-control m-input" id="customer_info_type_name_en"
                                   name="customer_info_type_name_en">
                        </div>
                    </div>
                </form>
            </div>
