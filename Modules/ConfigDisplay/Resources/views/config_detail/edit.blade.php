            ...
            <form id="form-data" action="" style="margin-bottom:100px" method="POST">
                <div class="m-portlet__body mt-5">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xl-10">
                            <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar">
                                ...
                                <input type="hidden" value="{{ $itemConfigDisplayDetail->image }}" id="config_banner"
                                    name="config_banner">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xl-10">
                            <input class="form-control" id="main_title" value="{{ $itemConfigDisplayDetail->main_title }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xl-10">
                            <input class="form-control" id="sub_title" value="{{ $itemConfigDisplayDetail->sub_title }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xl-10">
                            <input class="form-control" value="{{ $itemConfigDisplayDetail->action_name }}"
            ...
            <div class="row form-group">
                <div class="col-xl-12 col-lg-12 d-flex justify-content-end pr-5">
                    ...
                    <button type="button" class="btn btn-primary color_button btn-search kt-padding-l-40 kt-padding-r-40"
                        onclick="configDisplayDetail.update()">
...
@section('after_script')
    <script>
        ...
        const ID_CONFIG_DISPLAY_DETAIL = '{{ $idConfigDisplayDetail }}'
    </script>
