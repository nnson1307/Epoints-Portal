...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'staff_salary_template_name' => 'required|max:190|unique:staff_salary_templates,staff_salary_template_name,'. $params['staff_salary_template_id'] .',staff_salary_template_id,is_deleted,0',
