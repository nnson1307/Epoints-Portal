            ...
            <div class="m-portlet__head-caption">
                ...
                <span class="m-portlet__head-icon">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang("Danh sách ngày lễ")
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">

                @if(in_array('holiday.add',session('routeList')))
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                ...
                <div class="table-content m--padding-top-30">
                    @include('staff-salary::holiday.list')
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    <script src="{{asset('static/backend/js/staff-salary/holiday/list.js?v='.time())}}"></script>
@stop
