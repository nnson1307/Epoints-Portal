 ...
 */
?>
<div class="modal fade" id="modalHolidayAdd" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title"
                    ...
                    <i class="fa fa-plus-circle"></i> @lang('THÊM NGÀY LỄ')
                </h5>
            </div>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" id="staff_holiday_title" value="" class="form-control m-input" placeholder="{{ __('Tên ngày lễ') }}">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control m-input" readonly="" placeholder="{{ __('Ngày bắt đầu') }}" id="staff_holiday_start_date">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control m-input daterange-picker" readonly="" placeholder="{{ __('Ngày kết thúc') }}"  id="staff_holiday_end_date">
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i class="la la-calendar-check-o"></i>
                                </span>
