    ...
    <div class="col-12">
        ...
        <div class="m-portlet  m-portlet--full-height ">
            ...
            <div class="m-portlet__body">
                <div class="row">
                    <table class="table m-table m-table--head-bg-default" id="tblSalary" page-break-inside: auto;>
                        <thead class="bg">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $totalHoliday = $salary_holiday *  ($staffTimekeepingStaff['total_day_holiday'] + $staffTimekeepingStaff['total_holiday_paid_leave']); ?>
