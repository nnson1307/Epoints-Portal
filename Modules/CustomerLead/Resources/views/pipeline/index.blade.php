            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        @lang("DANH SÁCH PIPELINE")
                    </h2>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                @if(in_array('customer-lead.pipeline.create',session('routeList')))
                    <a href="{{route('customer-lead.pipeline.create')}}"
                       class="btn btn-primary m-btn btn-sm color_button m-btn--icon m-btn--pill btn_add_pc">
                    <span>
                        <i class="fa fa-plus-circle"></i>
                        <span> @lang('THÊM PIPELINE')</span>
                    </span>
                    </a>
                    <a href="{{route('customer-lead.pipeline.create')}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill
        ...
        <div class="m-portlet__body">
            <div id="autotable">
                ...
                <div class="table-content m--padding-top-30">
                    @include('customer-lead::pipeline.list')
                </div>
            </div>
        </div>
    </div>
