<div class="modal fade show"
     id="{{isset($detailWork) && $detailWork != null ? 'modal-customer-care-edit' : 'modal-customer-care'}}"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="{{isset($detailWork) && $detailWork != null ? 'form-care-edit' : 'form-care'}}"
                      autocomplete="off">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" name="manage_work_title" class="form-control m-input"
                                       value="{{isset($detailWork) && $detailWork != null ? $detailWork['manage_work_title'] : ''}}"
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="kt-radio-inline">
                                    @if (isset($listTypeWork) && count($listTypeWork) > 0)
                                        @foreach ($listTypeWork as $item)
                                            <label class="kt-radio mr-2">
                                                <input type="radio" name="manage_type_work_id"
                                                       @if((isset($detailWork) && $detailWork != null && $item['manage_type_work_id'] == $detailWork['manage_type_work_id']))
                                                       {{ ' checked' }}
                                                       @elseif(!isset($detailWork) && $item['manage_type_work_id'] == 1))
                                                            {{ ' checked' }}
                                                       @endif
                                                       class="mr-2"
                                                       value="{{$item['manage_type_work_id']}}"> {{ $item['manage_type_work_name'] }}
                                                <span></span>
                                            </label>
                                        @endforeach
                                    @endif
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control summernote" id="content" name="content"
                                              rows="5">{{isset($detailWork) && $detailWork != null ? $detailWork['description'] : ''}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="form-group m-form__group" style="display:flex;align-items: initial">
                                ...
                                <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                    <label style="margin: 0 0 0 10px; padding-top: 4px">
                                        <input type="checkbox" id="is_booking"
                                               {{isset($detailWork) && $detailWork != null ? 'disabled' : ''}}
                                               onclick="Work.changeBooking()"
                                               value="1"
                                               {{(isset($detailWork) &&  $detailWork != null && $detailWork['is_booking'] == 1) ? 'checked' : ''}}
                                               class="manager-btn" name="">
                                        <span></span>
                                    </label>
                                </span>
                                <label class="col-form-label pl-2 font-weight-bold"
                                       style="padding-top: 5px; font-size:1.25rem">Đặt lịch hẹn trước</label>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text"
                                                           class="form-control m-input time-input checkBookingAdd"
                                                           {{isset($detailWork) && $detailWork != null && $detailWork['is_edit'] == 0 ? 'disabled' : '' }} value="{{isset($detailWork) && $detailWork != null && isset($detailWork['date_start']) && $detailWork['date_start'] != '' && $detailWork['date_start'] != '0000-00-00 00:00:00' ? \Carbon\Carbon::parse($detailWork['date_start'])->format('H:i') : ''}}"
                                                           placeholder="@lang('Giờ')" name="time_start">
                                                </div>
                                                <div class="col-8">
                                                    <div class="input-group date date-multiple">
                                                        <input type="text"
                                                               class="form-control m-input daterange-input checkBookingAdd"
                                                               {{isset($detailWork) && $detailWork != null && $detailWork['is_edit'] == 0 ? 'disabled' : '' }} value="{{isset($detailWork) && $detailWork != null && isset($detailWork['date_start']) && $detailWork['date_start'] != '' && $detailWork['date_start'] != '0000-00-00 00:00:00' ? \Carbon\Carbon::parse($detailWork['date_start'])->format('d/m/Y') : ''}}"
                                        ...
                                        <div class="form-group m-form__group">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text"
                                                           class="form-control m-input time-input checkBookingAdd"
                                                           {{isset($detailWork) && $detailWork != null && $detailWork['is_edit'] == 0 ? 'disabled' : '' }} value="{{isset($detailWork) && $detailWork != null && isset($detailWork['date_end']) && $detailWork['date_end'] != '' && $detailWork['date_end'] != '0000-00-00 00:00:00' ? \Carbon\Carbon::parse($detailWork['date_end'])->format('H:i') : ''}}"
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group date date-multiple">
                                                        <input type="text"
                                                               class="form-control m-input daterange-input checkBookingAdd"
                                                               {{isset($detailWork) && $detailWork != null && $detailWork['is_edit'] == 0 ? 'disabled' : '' }} value="{{isset($detailWork) && $detailWork != null && isset($detailWork['date_end']) && $detailWork['date_end'] != '' && $detailWork['date_end'] != '0000-00-00 00:00:00' ? \Carbon\Carbon::parse($detailWork['date_end'])->format('d/m/Y') : ''}}"
                                        ...
                                        <div class="form-group m-form__group">
                                            ...
                                            <div class="input-group">
                                                <select name="processor_id"
                                                        class="form-control select2 select2-active checkBookingAdd" {{isset($detailWork) && $detailWork != null && $detailWork['is_edit'] == 0 ? 'disabled' : '' }}>
                                                    <option value="">@lang('Chọn nhân viên thực hiện')</option>
                                                    @if (isset($listStaff) && count($listStaff) > 0)
                                                        @foreach ($listStaff as $item)
                                                            <option value="{{ $item['staff_id'] }}" {{(isset($detailWork) && $detailWork != null && $detailWork['processor_id'] == $item['staff_id']) || (isset($detailWork) && $detailWork == null && $item['staff_id'] == \Illuminate\Support\Facades\Auth::id()) ? 'selected' : '' }}>{{ $item['full_name'] }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group m-form__group">
                                            ...
                                            <div class="input-group">
                                                <select name="manage_status_id"
                                                        class="form-control select2 select2-active w-100 checkBookingAdd">
                                                    {{--                                                    <option value="">@lang('Chọn trạng thái')</option>--}}
                                                    @if (isset($listStatus) && count($listStatus) > 0)
                                                        @foreach ($listStatus as $item)
                                                            <option value="{{ $item['manage_status_id'] }}" {{isset($detailWork) && $detailWork != null && $detailWork['manage_status_id'] == $item['manage_status_id'] ? 'selected' : ''}}>{{ $item['manage_status_name'] }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <div class="input-group">
                                                <input type="hidden" name="customer_lead_id"
                                    ...
                                    <div class="col-12">
                                        @if (isset($detailWork) && $detailWork == null)
                                            <div class="block-hide-work mt-3">
                                                <div class="form-group m-form__group">
                                                    ...
                                                    <div class="form-group m-form__group"
                                                        ...
                                                        <label class="col-form-label pl-2 font-weight-bold"
                                                               style="padding-top: 5px; font-size:1.25rem">Nhắc nhở
                                                            trước</label>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                            <div class="form-group m-form__group">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input type="text"
                                                                           class="form-control m-input date-timepicker checkRemindAdd"
                                                                           disabled
                                                                ...
                                                                <div>
                                                                    <div class="input-group mb-3">
                                                                        <input type="text" disabled
                                                                               class="form-control input-mask-remind checkRemindAdd"
                                                                               id="time_remind" name="time_remind"
                                                                               value=""
                                                                               placeholder="Nhắc trước">
                                                                        <div class="input-group-append">
                                                                            <select class="input-group-text checkRemindAdd"
                                                                                    disabled name="time_type_remind">
                                                                                <option value="m"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group m-form__group">
                                                                ...
                                                                <textarea name="description_remind" disabled
                                                                          class="form-control m-input checkRemindAdd"
                                                                          rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <input type="hidden" id="history_id" name="history_id"
                           value="{{isset($historyId) ? $historyId: ''}}">
                    <input type="hidden" id="manage_work_id" name="manage_work_id"
                           value="{{isset($detailWork) && $detailWork != null ? $detailWork['manage_work_id']: ''}}">
                </form>
                @if (!isset($detailWork) || $detailWork == null )
                    <div class="row">
            ...
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    @if (isset($detailWork) && $detailWork != null)
                        <button onclick="listLead.closeModalCareEdit()" data-dismiss="modal"
                    ...
                    @else
                        <button onclick="listLead.closeModalCare()" data-dismiss="modal"
                                class="btn btn-metal bold-huy m-btn m-btn--icon m-btn--wide m-btn--md">
                            <span>
                            <i class="la la-arrow-left"></i>
                            <span>{{__('HỦY')}}</span>
