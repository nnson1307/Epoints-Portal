                ...
                <div class="modal-body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-2">
                            <a href="javascript:void(0)"
                               onclick="listLead.call('{{$item['customer_lead_id']}}', '{{$item['phone']}}')"
                    ...
                    @if (count($arrPhone) > 0)
                        @foreach($arrPhone as $v)
                            <div class="form-group m-form__group row">
                                <div class="col-lg-3">
                                    <span class="font-weight-bold font-13">{{$v['phone']}}</span>
                                </div>
                                <div class="col-lg-2">
                                    <a href="javascript:void(0)"
                                       onclick="listLead.call('{{$item['customer_lead_id']}}', '{{$v['phone']}}')"
                                       class="btn btn-outline-brand m-btn m-btn--icon btn-lg m-btn--icon-only m-btn--pill m-btn--air"
                                       title="@lang('Gọi')">
                                        <i class="la la-phone"></i>
                                    </a>
