                ...
                <div class="col-lg-2">
                    <div class="input-group">
                        <input type="input" class="form-control" id="search" name="search"
                               onchange="kanBanView.changePipeline()" placeholder="@lang('Nhập thông tin tìm kiếm')">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        <select class="form-control" id="select_manage_type_work_id" name="select_manage_type_work_id"
                            ...
                            @foreach ($listWorkType as $itemType)
                                <option value="{{$itemType['manage_type_work_key']}}">{{$itemType['manage_type_work_name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
