        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title color_title" id="exampleModalLabel">
                    <i class="la la-edit"></i> @lang('CHỈNH SỬA KHÁCH HÀNG TIỀM NĂNG')
                </h5>
            </div>
            <div class="modal-body">
                <form id="form-edit">
                    ...
                    <input type="hidden" name="chatHubPopup" id="chatHubPopup" value="{{ $chatHubPopup }}">
                </form>
            </div>
            <div class="modal-footer">
                <div class="m-form__actions m--align-right w-100">
                    <button data-dismiss="modal"
                            class="btn btn-metal btn-close-popup-edit bold-huy m-btn m-btn--icon m-btn--wide m-btn--md">
						<span>
						<i class="la la-arrow-left"></i>
						<span>{{__('HỦY')}}</span>
						</span>
                    </button>
                    <button type="button" onclick="edit.save({{$item['customer_lead_id']}}, {{$load}})"
...
<script>
    ...
    $(document).on('click', '.btn-close-popup-edit', function(){
