                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                {{__('BÁO CÁO CHẤT LƯỢNG LEAD THEO NHÂN VIÊN')}}
                            </h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">

                        <form action="{{route('customer-lead.report.export-excel-view-lead-report-staff')}}" method="POST">
                            {{ csrf_field() }}
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-form m-form--label-align-right">
                        <div class="row">
                            ...
                            <div class="col-lg-3 ss--col-xl-4 ss--col-lg-12 form-group">
                                <button type="button" class="btn btn-info" onclick="lead.renderTableReportStaff()">
