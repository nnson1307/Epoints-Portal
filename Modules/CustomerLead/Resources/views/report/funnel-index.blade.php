                    ...
                    <div class="row form-group">
                        <div class="col-12">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link  active show" href="{{route('customer-lead.report.reportFunnel')}}">{{ __('Khách hàng tiềm năng') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('customer-lead.report.reportFunnelDeal')}}">{{ __('Cơ hội tiềm năng') }}</a>
                                </li>
                            </ul>
                            {{-- <a href="{{route('customer-lead.report.reportFunnel')}}">
                                <button type="button" class="btn bt-report active">Khách hàng tiềm năng</button>
                            </a>
                            <a href="{{route('customer-lead.report.reportFunnelDeal')}}">
                                <button type="button" class="btn bt-report ">Cơ hội tiềm năng</button>
                            </a> --}}
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <div class="row" id="report_result">
                                        ...
                                        <div class="col-6">
                                            <div class="height-info">
                                                <p class="text-uppercase">Tỷ lệ chuyển đổi khách hàng tiềm năng thành cơ hội bán hàng</p>
                                                <p class="convertDeal"><span>20</span>%</p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="height-info">
                                                <p class="text-uppercase">Tỷ lệ chuyển đổi khách hàng tiềm năng thành khách hàng thực thụ</p>
                                                <p class="convertCustomer"><span>10</span>%</p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="height-info">
                                                <p class="text-uppercase">Tỷ lệ chuyển đổi khách hàng thành tiềm năng thất bại</p>
                                ...
                                <div class="col-12 form-group">
                                    <h4>Báo cáo chất lượng leads theo nguồn khách hàng</h4>
                                    <div id="table-source">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/customer-lead/report/funnel.js?v='.time())}}"
