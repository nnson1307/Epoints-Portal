    ...
    <div style=" min-height: 50px !important; max-height: 400px !important; overflow-y: scroll; margin-bottom: 20px;">
        <table class="table table-message table-message-main">
            ...
            @foreach($listComment as $item)
                <tr class="tr_{{$item['deal_comment_id']}}">
                    <td>
                    ...
                    <td>
                        ...
                        <p class="mb-0"><a href="javascript:void(0)" class="reply_message" onclick="DealComment.showFormChat({{$item['deal_comment_id']}})">{{ __('managerwork::managerwork.answer') }} </a> {{\Carbon\Carbon::parse($item['created_at'])->diffForHumans(\Carbon\Carbon::now()) }}</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border-top: none;">
                        <table class="table-message">
                            <tbody class="tr_child_{{$item['deal_comment_id']}}">
...
<div class="col-12 mb-5 text-right">
    <button type="button" onclick="DealComment.addComment()" class=" mt-3 ss--btn-mobiles btn ss--button-cms-piospa ss--btn m-btn m-btn--icon m-btn--wide m-btn--md m--margin-left-10  m--margin-bottom-5">
