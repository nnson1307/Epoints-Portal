    ...
    <div class="m-portlet m-portlet--head-sm">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                @if(in_array('customer-lead.tag.create',session('routeList')))
                    <a href="{{route('customer-lead.tag.create')}}"
                    ...
                    <a href="{{route('customer-lead.tag.create')}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill
...
{{--                                </div>--}}
                ...
                <div class="table-content m--padding-top-30">
                    @include('customer-lead::tag.list')
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    <script src="{{asset('static/backend/js/customer-lead/tag/script.js')}}" type="text/javascript"></script>
    <script>
        list._init();
    </script>
@endsection
