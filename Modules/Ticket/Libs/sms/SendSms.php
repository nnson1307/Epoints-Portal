...
namespace Modules\Ticket\Libs\sms;

use Modules\Ticket\Models\ConfigTable;
use Modules\Ticket\Models\SmsProviderTable;
...
//
            ...
            if ($branName == null || strlen($branName) == 0 || $branName == '' || $configTmp['value'] == 'VN') {
                $sendSMS['messages'] = [
                    [
                        'source' => $source,
                        'body' => $message,
