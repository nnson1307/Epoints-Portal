...
class TicketRoleStatusMapTable extends Model
{
    ...
    protected $fillable = ['ticket_role_status_map_id', 'ticket_role_id','ticket_status_id','allow','created_by',
        'updated_by', 'created_at', 'updated_at'];

    protected function _getList($filters = [])
    {
        $query = $this->select('ticket_role_status_map_id', 'ticket_role_id','ticket_status_id','allow','created_by',
            'updated_by', 'created_at', 'updated_at')
    ...
    public function add(array $data)
    {
        ...
        return $oCustomerGroup->ticket_role_status_map_id;
    }
    ...
    */
    public function checkExiststatus_name($status_name = '', $id = '')
    {
        ...
        ->where('ticket_role_status_map_id','<>', $id)
        ->first();
        return $select;
    }
