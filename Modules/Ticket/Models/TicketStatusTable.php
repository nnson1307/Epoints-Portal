...
class TicketStatusTable extends Model
{
    ...
    protected $fillable = ['ticket_status_id', 'ticket_status_value','status_name','created_by',
        'updated_by', 'created_at', 'updated_at'];

    protected function _getList($filters = [])
    {
        $query = $this->select('ticket_status_id', 'ticket_status_value','status_name','created_by',
            'updated_by', 'created_at', 'updated_at')
    ...
    public function getName(){
        $oSelect= self::select("ticket_status_id","status_name")->get();
        return ($oSelect->pluck("status_name","ticket_status_id")->toArray());
    }

    public function add(array $data)
    {
        $oCustomerGroup = $this->create($data);
        return $oCustomerGroup->ticket_status_id;
    }
