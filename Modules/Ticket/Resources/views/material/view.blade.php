    ...
    <div class="modal-header">
        ...
        <div class="modal-title ss--title m--font-bold">
            <div class="button-action d-none">
                <button type="button"
                    class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn-sm pl-3 pr-3">
                    {{ __('Xác nhận') }}
                </button>
                <button type="button"
                    class="btn bg-danger text-light m-btn m-btn--icon m-btn--pill btn-sm pl-3 pr-3">
                    {{ __('Hủy') }}
                </button>
            </div>
        </div>
                ...
                <div class="form-group m-form__group">
                    ...
                    <div class="input-group">
                        <select name="ticket_code" class="form-control select2 select2-active" disabled>
                            ...
                            @foreach ($listTicketAll as $key => $value)
