        ...
        <form class="modal-content" id="form-add-material">
            <div class="modal-header">
                ...
                <div class="modal-title ss--title m--font-bold">
                    <span>{{ __('Tải file import') }} <a
                            href="{{ url('uploads/admin/ticket/phieu_yeu_cau_vat_tu.xlsx') }}" target="_blank"
                            class="text-danger">{{ __('tại đây') }}</a> </span>
                    <label class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn_add_pc btn-sm"
                        for="file-import">
                        <span>
                    ...
                    <input type="file" class="d-none" name="import_file" id="file-import"
                        accept=".xlsx, .xls, .csv" onchange="Material.upload()">
                </div>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group m-form__group">
                    ...
                    <div class="input-group">
                        <select name="ticket_code" class="form-control">
