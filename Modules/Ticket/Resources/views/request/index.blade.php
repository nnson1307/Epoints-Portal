...
@section('content')
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        {{ __('DANH SÁCH YÊU CẦU') }}
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                {{-- @if (in_array('ticket.request.add', session('routeList'))) --}}
                <a href="javascript:void(0)" data-toggle="modal" data-target="#modalAdd" onclick="Shift.clear()"
                    class="btn ss--button-cms-piospa m-btn m-btn--icon m-btn--pill btn_add_pc btn-sm">
                    <span>
                        <i class="fa fa-plus-circle"></i>
                        <span> {{ __('THÊM YÊU CẦU') }}</span>
                    </span>
                </a>
                <a href="javascript:void(0)" data-toggle="modal" data-target="#modalAdd" onclick="Shift.clear()"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 form-group">
                                    <select name="ticket_issue_group_id" class="form-control select2 select2-active">
                                ...
                                <div class="col-lg-3 form-group">
                                    ...
                                    <select name="is_active" class="form-control select2 select2-active">
                                ...
                                <div class="col-lg-3 form-group">
                                    <select name="created_by" class="form-control select2 select2-active" id="">
                                ...
                                <div class="col-lg-3 form-group">
                                    <select name="search_keyword" class="form-control select2 select2-active" id="">
                                        <option value="">@lang('Chọn thời gian xử lý')</option>
                                        @foreach (processTimeTicketFilter() as $key => $value)
                                        <option value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <div class="modal fade" id="modalAdd" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::request.add')
        </div>
    </div>
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::request.edit')
        </div>
    </div>
    <div class="modal fade" id="modalView" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::request.view')
        </div>
    </div>
@stop
@section('after_script')
    @include('ticket::language.lang')
    <script src="{{ asset('static/backend/js/ticket/request/list.js?v=' . time()) }}" type="text/javascript"></script>
    <script src="{{ asset('static/backend/js/ticket/helper_js/class_event.js') }}" type="text/javascript"></script>
    <script src="{{ asset('static/backend/js/ticket/helper_js/function.js') }}" type="text/javascript"></script>
@stop
