    ...
    <div class="modal-body">
        <div class="row">
            <div class="form-group m-form__group col-lg-6">
                ...
                <select name="role_group_id" class="form-control select2 select2-active" id="role_group_id">
                    <option value="">@lang('Chọn tên role')</option>
                    @foreach ($roleGroup as $key => $value )
                        <option value="{{ $key }}">{{ $value }}</option>
                    @endforeach
                </select>
                <span class="err error-role_group_id"></span>
            </div>
            <div class="form-group m-form__group col-lg-6">
                <label class="black_title">
                    {{ __('Mô tả') }}:
                </label>
                <textarea class="form-control m-input" id="description" name="description" rows="1"
            ...
            <div class="col-lg-12">
                ...
                <div class="input-group m-input-group">
                    <div class="table-responsive">
                        <table class="table table-striped m-table ss--header-table" id="ticket_status_role_table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" name="ticket_status_role[]" value="{{$status['ticket_status_value']}}">
                                    </td>
                                    @endforeach
                                </tr>
                            </tbody>
