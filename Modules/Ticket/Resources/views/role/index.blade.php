...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 form-group">
                                    <select name="created_by" class="form-control select2 select2-active" id="created_by">
                                        <option value="">{{__('Chọn người tạo')}}</option>
    ...
    <div class="modal fade" id="modalAdd" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::role.add')
        </div>
    </div>
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::role.edit')
        </div>
    </div>
    <div class="modal fade" id="modalView" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('ticket::role.view')
        </div>
    </div>
@stop
@section('after_script')
    @include('ticket::language.lang')
    <script src="{{ asset('static/backend/js/ticket/role/list.js?v=' . time()) }}" type="text/javascript"></script>
@stop
