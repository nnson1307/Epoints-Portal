<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title ss--title m--font-bold">
            ...
            {{__('XEM CHI TIẾT NHÂN VIÊN THEO QUEUE')}}
        </h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" name="name" class="form-control m-input" placeholder=""
                            disabled>
                        <span class="err error-name_staff"></span>
                    </div>
                    <div class="form-group m-form__group">
                        <label class="black_title">
                            {{ __('Email') }}:
                ...
                <div class="col-lg-6">
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <select name="ticket_queue_id" class="form-control" multiple disabled>
                ...
                <div class="col-lg-6">
                    <div class="form-group m-form__group">
                        ...
                        <div class="input-group">
                            <select name="role_queue_id" class="form-control select2 select2-active" disabled>
