        ...
        <div class="modal-content">
            <div class="config_search">
                <div class="modal-header">
                    <h4 class="modal-title ss--title m--font-bold">
                        ...
                        {{ __('ticket::acceptance.config_search') }}
                    </h4>
                </div>
                                        ...
                                        <div class="col-lg-3 p-3">
                                            <div class="ss--font-size-13 text-center">
                                                <label class="m-checkbox m-checkbox--air">
                                                    <input class="check-page" {{ $value['active'] == 1 ? 'checked' : '' }}
            ...
            <div class="config_column">
                <div class="modal-header">
                    <h4 class="modal-title ss--title m--font-bold">
                        <i class="fa fa-cog ss--icon-title m--margin-right-5"></i>
                        {{ __('ticket::acceptance.config_list') }}
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="row m-0">
            ...
            <div class="modal-footer">
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit ss--width--100">
                    <div class="m-form__actions m--align-right">
                        ...
                        <button type="button" onclick="Acceptance.saveConfig()"
