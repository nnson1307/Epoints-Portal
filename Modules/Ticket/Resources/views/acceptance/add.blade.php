            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        ...
                        @lang('ticket::acceptance.add_acceptance')
                    </h2>
                </div>
            </div>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <select name="ticket_id" class="form-control select2 select2-active" id="ticket_id" onchange="Acceptance.changeTicket()">
                                    <option value="">{{__('ticket::acceptance.select_ticket')}}</option>
                                    @foreach ($listTicket as $key => $value)
                                        <option value="{{ $value['ticket_id'] }}" {{$idTicket != null && $idTicket == $value['ticket_id'] ? 'selected' : ''}}>{{ $value['ticket_code'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
{{--                        </button>--}}
            ...
            <div class="m-portlet__body">
                <div class="m-form__actions m--align-right">
                    ...
                    <button onclick="Acceptance.saveAcceptance()" type="button" class="ss--btn-mobiles m--margin-bottom-5 btn ss--button-cms-piospa ss--btn m-btn m-btn--icon m-btn--wide m-btn--md m--margin-left-10">
                        <span class="ss--text-btn-mobi">
