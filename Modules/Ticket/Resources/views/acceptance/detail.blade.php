            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        ...
                        @lang('ticket::acceptance.detail_acceptance')
                    </h2>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <select name="ticket_id" class="form-control select2 select2-active" id="ticket_id" onchange="Acceptance.changeTicket()">
                    ...
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <input type="text" name="title" id="title" class="form-control" placeholder="@lang('ticket::acceptance.acceptance_name')">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="customer_full_name" disabled class="form-control" placeholder="@lang('ticket::acceptance.customer_name')" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            <label class="black_title">
                                @lang('ticket::acceptance.sign_by'):<b class="text-danger">*</b>
                            </label>
                            <div class="input-group">
                                <input type="text" disabled class="form-control" placeholder="@lang('ticket::acceptance.sign_by')" value="{{$detailAcceptance['sign_by']}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            <label class="black_title">
                                @lang('ticket::acceptance.sign_date'):<b class="text-danger">*</b>
                            </label>
                            <div class="input-group">
                                <input type="text" disabled class="form-control" placeholder="@lang('ticket::acceptance.sign_date')" value="{{$detailAcceptance['sign_date'] != '' && $detailAcceptance['sign_date'] != null ? \Carbon\Carbon::parse($detailAcceptance['sign_date'])->format('d/m/Y H:i') : ''}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group m-form__group">
                            <label class="black_title">
                                @lang('ticket::acceptance.status'):<b class="text-danger">*</b>
                            </label>
                            <div class="input-group">
                                <input type="text" disabled class="form-control" placeholder="@lang('ticket::acceptance.status')" value="{{$detailAcceptance['status'] == 'new' ? 'Mới' : ($detailAcceptance['status'] == 'approve' ? 'Đã ký' : 'Huỷ') }}">
                            </div>
                        </div>
                    </div>
...
@section('after_script')
        ...
        <tr class="incurred_block_product" id="incurred_block_product_{number}">
            ...
            <td class="text-center">
                <div id="incurred_block_material_product_{number}">
                    ...
                    <input type="text" id="incurred_material_product_{number}" class="form-control d-inline text-center p-1 product_quantity" style="width : 45%" value="1.0" onfocusout="Acceptance.changeNumberIncurred({number},'')">
    ...
    <script type="text/template" id="addFile">
        <div class="col-12 block-file-{countFile}">
    ...
    <script>
        $(document).ready(function () {
            Acceptance.changeTicket(`{{$detailAcceptance['title']}}`,`detail`);
