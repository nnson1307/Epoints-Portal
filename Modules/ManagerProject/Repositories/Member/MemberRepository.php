...
class MemberRepository implements MemberRepositoryInterface
{
    ...
    public function getList($params)
    {
        ...
        $view = view('manager-project::member.list', ['list' => $list,'listStaffManage'=> $listStaffManage,'listStaffProject' => $listStaffProject])->render();
        return [
            'error' => false,
            'view' => $view
        ];
    ...
    public function show($idMemberProject)
    {
        ...
        $view = view('manager-project::member.show', ['memberProject' => $memberProject, 'listRole' => $listRole])->render();
        return [
            'error' => false,
            'view' => $view
        ];
    ...
    public function edit($idMemberProject)
    {
        ...
        $listRole = $manageProjectRole->getAll();
        $memberProject = $this->projectStaff->detail($idMemberProject);
        $view = view('manager-project::member.edit', ['memberProject' => $memberProject, 'listRole' => $listRole])->render();
        return [
            'error' => false,
            'view' => $view
        ];
...
//            $projectStaff = $this->projectStaff->find($idMemberProject);
    ...
    public function showPopupAddStaff($data)
    {
        ...
        $view = view('manager-project::member.append.form-add-staff', [
            'listRole' => $listRole,
