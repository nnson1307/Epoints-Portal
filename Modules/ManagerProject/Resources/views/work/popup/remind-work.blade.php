                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control m-input date-timepicker" readonly
                                           placeholder="@lang('Thời gian nhắc')" name="date_remind" value="{{$detail!= null ? \Carbon\Carbon::parse($detail['date_remind'])->format('d/m/Y H:i') : \Carbon\Carbon::now()->addMinutes(10)->format('d/m/Y H:i')}}">
...
{{--                                        </div>--}}
                        ...
                        <div class="col-lg-12">
                            <div class="form-group m-form__group">
                                ...
                                <textarea name="description_remind" class="form-control m-input" rows="3">{!! $detail != null ? $detail['description'] : '' !!}</textarea>
                            </div>
                        </div>
                    </div>
