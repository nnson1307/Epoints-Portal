        ...
        <div class="m-portlet m-portlet--head-sm">
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-tools">
                    ...
                    @if(isset($data['work_detail']))
                        <button type="button" onclick="WorkProject.cancelWork()"
                    ...
                    @if(isset($data['work_detail']))
                        <button type="button" onclick="WorkProject.saveWork()"
                    ...
                    @if($detail == null)
                        @if(isset($data['work_detail']))
                            <button type="button" onclick="WorkProject.saveWork(1)"
                                    class="ss--btn-mobiles btn ss--button-cms-piospa ss--btn m-btn m-btn--icon m-btn--wide m-btn--md m--margin-left-10 m--margin-bottom-5">
                            <span class="ss--text-btn-mobi">
                                <i class="la la-check"></i>
                                <span>{{ __('LƯU THÔNG TIN') }}</span>
            ...
            <form id="form-edit">
                <div class="m-portlet__body pt-0">
                    <div class="row">
                        <div class="col-lg-12 mt-3 form-group text-right">
...
{{--                            @endif--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="kt-radio-inline">
                                                    @foreach ($listTypeWork as $item)
                                                        <label class="kt-radio mr-4">
                                                            <input type="radio" name="manage_type_work_id"
                                                                   {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} class="mr-2"
                                                                   value="{{$item['manage_type_work_id']}}"
                                                                    {{$detail != null && $item['manage_type_work_id'] == $detail['manage_type_work_id'] ? 'checked' : ''}}
                                            ...
                                            @else
                                                <select name="manage_type_work_id"
                                                    ...
                                                    @foreach ($listTypeWork as $item)
                                                        <option value="{{ $item['manage_type_work_id'] }}"
                                                                {{$detail != null && $item['manage_type_work_id'] == $detail['manage_type_work_id'] ? 'selected' : ''}}
                                ...
                                <div class="col-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            @if($detail == null)
                                                <select name="manage_project_id"
                                                        class="form-control select2 select2-active" {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }}>
                                                    <option value="">@lang('Chọn dự án')</option>
                                                    @foreach ($listProject as $item)
                                                        <option value="{{ $item['manage_project_id'] }}" {{($detail != null && $detail['manage_project_id'] == $item['manage_project_id']) || (isset($manage_project_id) && $manage_project_id == $item['manage_project_id']) ? 'selected' : ''}}>{{ $item['manage_project_name'] }}</option>
                                                    @endforeach
                                                </select>
                                            @else
                                                <?php
                                ...
                                <div class="col-12">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn btn-sm m-btn--icon bg-light color"
                                                    onclick="WorkProject.showPopStaff()">
                                                <span>
                                            ...
                                            @if(isset($data['work_detail']))
                                                <label class="form-check-label m-checkbox m-checkbox--air">
                                                    <input type="checkbox" name="is_approve_id" value="1" id="is_approve_id"
                                                           onclick="WorkProject.approveStaff()" {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{$detail != null && $detail['is_approve_id'] == 1 ? 'checked' : ''}}>
                                                    <span></span>
                        ...
                        <div class="col-6">
                            <div class="row collapse multi-collapse border-0 show" id="moreInfo">
                                <div class="col-lg-12">
                                    <div class="form-group m-form__group">
                                        <label class="black_title">
                                            @lang('Công việc cha')
                                        ...
                                        <div>
                                            <select onchange="WorkProject.changeParentTask()" id="parent_id" name="parent_id"
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="type_card_work" value="bonus" id="type_card_work_bonus"
                                                        {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{($detail != null && $detail['type_card_work'] == 'bonus') || $detail == null ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="type_card_work_bonus">{{ __('Không') }}</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline ml-5">
                                                <input type="radio" class="custom-control-input" name="type_card_work" value="kpi" id="type_card_work_kpi"
                                                        {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{$detail != null && $detail['type_card_work'] == 'kpi' ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="type_card_work_kpi">{{ __('Có') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group m-form__group">
                                        <label class="black_title">
                                            @lang('Đánh dấu ưu tiên')
                                        </label>
                                        <div class="input-group">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="priority" value="2" id="priority_2"
                                                        {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{($detail != null && in_array($detail['priority'],[2,3])) || $detail == null ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="priority_2">{{ __('Không') }}</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline ml-5">
                                                <input type="radio" class="custom-control-input" name="priority" value="1" id="priority_1"
                                                        {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{$detail != null && $detail['priority'] == 1 ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="priority_1">{{ __('Có') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <select name="manage_work_customer_type" onchange="Work.changeCustomer()"
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <select name="customer_id" id="customer_id"
                                                    onchange="Work.changeObjectCustomer(this)"
                                                    class="form-control select2 select2-active" {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }}>
                                                                                ...
                                                                                <label class="kt-radio">
                                                                                    @if(isset($data['work_detail']))
                                                                                        <input type="radio"
                                                                                               ...
                                                                                               value="none"
                                                                                               {{$detail == null ? 'checked' : ($detail != null && (!isset($detail['repeat_type'])) ? 'checked' : '' )}} onchange="WorkProject.changeRepeat()"> {{__('Không có')}}
                                                                                        <span></span>
                                                                                    @else
                                                                                        <input type="radio"
                                                                                               class="repeat_type select-parent"
                                                                                ...
                                                                                <label class="kt-radio">
                                                                                    @if(isset($data['work_detail']))
                                                                                        <input type="radio"
                                                                                               ...
                                                                                               {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} name="repeat_type"
                                                                                               value="daily"
                                                                                               {{$detail != null && in_array($detail['repeat_type'],['daily']) ? 'checked' : '' }} onchange="WorkProject.changeRepeat()"> {{__('Hàng ngày')}}
                                                                                        <span></span>
                                                                                    @else
                                                                                        <input type="radio"
                                                                                               class="repeat_type disabled-parent"
                                                                                ...
                                                                                <label class="kt-radio">
                                                                                    @if(isset($data['work_detail']))
                                                                                        <input type="radio"
                                                                                               ...
                                                                                               {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} name="repeat_type"
                                                                                               value="weekly"
                                                                                               {{$detail != null && in_array($detail['repeat_type'],['weekly']) ? 'checked' : '' }} onchange="WorkProject.changeRepeat()"> {{__('Hàng tuần một lần mỗi')}}
                                                                                        <span></span>
                                                                                    @else
                                                                                        <input type="radio"
                                                                                               class="repeat_type disabled-parent"
                                                                                    ...
                                                                                    <div class="pl-3 block_weekly"
                                                                                        ...
                                                                                        @for($i = 0; $i <= 6 ; $i++)
                                                                                            <label class="weekly-select weekly-select-{{$i}} {{$detail != null && $detail['repeat_type'] == 'weekly' && in_array($i,$listTime) == true ? 'weekly-select-active' : '' }}"
                                                                                                   data-week="{{$i}}"
                                                                                                   onclick="WorkProject.selectWeekly({{$i}})">{{$i+2 == 8 ? 'CN' : 'T'.($i+2)}}</label>
                                                                                            <input type="hidden"
                                                                                ...
                                                                                <label class="kt-radio">
                                                                                    @if(isset($data['work_detail']))
                                                                                        <input type="radio"
                                                                                               ...
                                                                                               {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} name="repeat_type"
                                                                                               value="monthly"
                                                                                               {{$detail != null && in_array($detail['repeat_type'],['monthly']) == true ? 'checked' : '' }}  onchange="WorkProject.changeRepeat()"> {{__('Hàng tháng')}}
                                                                                        <span></span>
                                                                                    @else
                                                                                        <input type="radio"
                                                                                               class="repeat_type disabled-parent"
                                                                                    ...
                                                                                    @if(isset($data['work_detail']))
                                                                                        @for($i = 1; $i <= 31 ; $i++)
                                                                                            <label class="monthly-select monthly-select-{{$i}} {{$detail != null && $detail['repeat_type'] == 'monthly' && in_array($i,$listTime) == true ? 'weekly-select-active' : '' }}"
                                                                                                   data-month="{{$i}}"
                                                                                                   onclick="WorkProject.selectMonthly({{$i}})">{{$i}}</label>
                                                                                            <input type="hidden"
                                                                                ...
                                                                                <label class="kt-radio">
                                                                                    @if(isset($data['work_detail']))
                                                                                        <input type="radio"
                                                                                               ...
                                                                                               value="none"
                                                                                               {{$detail == null ? 'checked' : ($detail != null && ($detail['repeat_end'] == 'none' || !isset($detail['repeat_end'])) ? 'checked' : '' )}} onchange="WorkProject.changeRepeatEnd()"> {{__('Không bao giờ')}}
                                                                                        <span></span>
                                                                                    @else
                                                                                        <input type="radio"
                                                                                               name="repeat_end"
                                                                                        ...
                                                                                        <label class="kt-radio">
                                                                                            @if(isset($data['work_detail']))
                                                                                                <input type="radio"
                                                                                                       ...
                                                                                                       value="after"
                                                                                                       {{$detail != null && in_array($detail['repeat_end'],['after']) ? 'checked' : '' }} onchange="WorkProject.changeRepeatEnd()"> {{__('Sau')}}
                                                                                                <span></span>
                                                                                            @else
                                                                                                <input type="radio"
                                                                                                       name="repeat_end"
                                                                                        ...
                                                                                        <label class="kt-radio">
                                                                                            @if(isset($data['work_detail']))
                                                                                                <input type="radio"
                                                                                                       ...
                                                                                                       {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} class="repeat_end disabled-parent"
                                                                                                       value="date"
                                                                                                       {{$detail == null ? '' : ($detail != null && $detail['repeat_end'] == 'date' ? 'checked' : '')}} onchange="WorkProject.changeRepeatEnd()"> {{__('Vào ngày')}}
                                                                                                <span></span>
                                                                                            @else
                                                                                                <input type="radio"
                                                                                                       name="repeat_end"
    ...
    <input type="hidden" id="group_manage_project_id" value="{{$manage_project_id}}">
    <div id="my-modal-staff">
...
@section('after_script')
    ...
    <script src="{{ asset('static/backend/js/manager-project/managerWork/work_script.js?v=' . time()) }}"
