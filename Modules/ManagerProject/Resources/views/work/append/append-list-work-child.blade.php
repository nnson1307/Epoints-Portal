@if(count($listWorkChild) != 0)
    <div class="col-12 mt-5">
                ...
                <tr>
                    ...
                    <td>
                        @if(\Illuminate\Support\Facades\Session::has('is_staff_work_project') == false || \Illuminate\Support\Facades\Session::get('is_staff_work_project') == 1)
                            ...
                            @if($item['is_deleted'] == 1 || (isset($listStaffManage) && in_array(\Illuminate\Support\Facades\Auth::id(),$listStaffManage)))
                    ...
                    <td><a href="{{route('manager-project.work.detail',['id' => $item['manage_work_id']])}}">{{$item['manage_work_title']}}</a> </td>
        ...
        {{ $listWorkChild->links('manager-project::work.helpers.paging-work') }}
    </div>
@else
    <div class="col-12 mt-5">
        <table class="table table-striped m-table ss--header-table">
