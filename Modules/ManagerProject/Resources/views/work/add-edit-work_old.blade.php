        ...
        <div class="modal-content clear-form">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="input-group date date-multiple">
                                        <input type="text" class="form-control m-input date-input"
                                               ...
                                               readonly
                                               value="{{isset($dataShift['start_date']) && $dataShift['start_date'] != null ? \Carbon\Carbon::parse($dataShift['start_date'])->format('d/m/Y') : ''}}"
                                               @else
                                               {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }} value="{{$detail != null && isset($detail['date_start']) && $detail['date_start'] != '' && $detail['date_start'] != '0000-00-00 00:00:00' ? \Carbon\Carbon::parse($detail['date_start'])->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y')}}"
                                               @endif
                        ...
                        <div class="m-form__group">
                            <div class="form-check pl-0">
                                @if(isset($data['work_detail']))
                                    <label class="form-check-label m-checkbox m-checkbox--air">
                                        <input type="checkbox" name="is_approve_id" value="1" id="is_approve_id"
                                               onclick="WorkDetail.approveStaff()" {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{$detail != null && $detail['is_approve_id'] == 1 ? 'checked' : ''}}>
                                        <span></span>
                                ...
                                @else
                                    <label class="form-check-label m-checkbox m-checkbox--air">
                                        <input type="checkbox" name="is_approve_id" value="1" id="is_approve_id"
                                               onclick="WorkChild.approveStaff()" {{$detail != null && $detail['is_edit'] == 0 ? "disabled" : '' }} {{$detail != null && $detail['is_approve_id'] == 1 ? 'checked' : ''}}>
                                        <span></span>
                                        <div class="pt-1">{{ __('Công việc cần phê duyệt') }}</div>
                                    </label>
                                @endif
                    ...
                    {{--<div class="form-group m-form__group">--}}
                    {{--<label class="black_title">--}}
                    {{--@lang('Chọn chi nhánh nhân viên hỗ trợ')--}}
                    {{--</label>--}}
                    {{--<div class="input-group">--}}
                    {{--<select name="branch_id" id="branch_id_search" onchange="changeBranch()"--}}
                    {{--class="form-control "--}}
                    {{--data-placeholder="{{__('Chọn chi nhánh')}}">--}}
                    {{--<option value="">{{__('Chọn chi nhánh')}}</option>--}}
                    {{--@foreach ($listBranch as $item)--}}
                    {{--<option value="{{ $item['branch_id'] }}" {{$detail != null && $detail['branch_id'] == $item['branch_id'] ? 'selected' : ''}}>{{ $item['branch_name'] }}</option>--}}
                    {{--@endforeach--}}
                    {{--</select>--}}
                    {{--</div>--}}
                    {{--</div>--}}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group m-form__group">
                            ...
                            <div class="input-group">
                                <select name="support[]" id="support" class="form-control selectpicker" multiple
                                        {{$detail != null && $detail['is_edit'] == 0 ? 'disabled' : '' }}
                                        title="@lang('Chọn nhân viên hỗ trợ')">
                                                    ...
                                                    <optgroup label="{{$v1['department_name']}}" class="m--font-bold">
                                                        @if (count($v1['list_staff']) > 0)
                                                            @foreach($v1['list_staff'] as $v2)
                                                                @if($detail != null && count($detail['list_support']) != 0)
                                                                    <option value="{{$v2['staff_id'] }}" {{in_array($v2['staff_id'], collect($detail['list_support'])->pluck('staff_id')->toArray()) ? 'selected' : ''}}>{{ $v2['staff_name'] }}</option>
                                                                @else
                                                                                    ...
                                                                                    <div class="pl-3 block_weekly"
                                                                                        ...
                                                                                        @for($i = 0; $i <= 6 ; $i++)
                                                                                            <label class="weekly-select weekly-select-{{$i}} {{$detail != null && $detail['repeat_type'] == 'weekly' && in_array($i,$listTime) == true ? 'weekly-select-active' : '' }}"
                                                                                                   data-week="{{$i}}"
                                                                                                   onclick="WorkDetail.selectWeekly({{$i}})">{{$i+2 == 8 ? 'CN' : 'T'.($i+2)}}</label>
                                                                                            <input type="hidden"
                                                                                ...
                                                                                @else
                                                                                    <div class="pl-3 block_weekly"
                                                                                        ...
                                                                                        @for($i = 0; $i <= 6 ; $i++)
                                                                                            <label class="weekly-select weekly-select-{{$i}} {{$detail != null && $detail['repeat_type'] == 'weekly' && in_array($i,$listTime) == true ? 'weekly-select-active' : '' }}"
                                                                                                   data-week="{{$i}}"
                                                                                                   onclick="WorkChild.selectWeekly({{$i}})">{{$i+2 == 8 ? 'CN' : 'T'.($i+2)}}</label>
                                                                                            <input type="hidden"
                                                                                                   class="weekly-select-{{$i}}"
                                                                                                   name="manage_repeat_time_weekly[]"
                                                                                                   value="{{$detail != null && $detail['repeat_type'] == 'weekly' && in_array($i,$listTime) == true  ? $i : '' }}">
...
<script>
    ...
    function changeBranch() {
        ...
        console.log(laroute.route('manager-project.work.detail.submit-change-folder'));
        $.ajax({
            url: laroute.route('manager-project.work.detail.change-branch-staff'),
            method: 'POST',
            data: {
                branch_id: branch_id
            },
