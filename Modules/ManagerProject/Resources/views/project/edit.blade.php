...
@section('content')
    <div class="m-portlet m-portlet--head-sm">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{ route('manager-project.project.project-info-overview',['id' => $project['manage_project_id']]) }}" class="btn btn-secondary btn-search ml-2"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" onchange="ProjectAdd.namePrefixProject(this)"
                                                   ...
                                                   id="project_name" name="project_name" value="{{ $project['manage_project_name'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($listStaffs as $item)
                                                        <option value="{{ $item->staff_id }}"
                                                                {{ (isset($project) && $project['manager_id'] == $item->staff_id) ? 'selected' : '' }}>{{ $item->full_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            @else
                                                <select  disabled
                                                    ...
                                                    @foreach ($listStaffs as $item)
                                                        <option value="{{ $item->staff_id }}"
                                                                {{ (isset($project) && $project['manager_id'] == $item->staff_id) || Auth::user()->staff_id == $item->staff_id ? 'selected' : '' }}>{{ $item->full_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="project_manager" id="project_manager" value="{{$project['manager_id']}}">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-group">
                                            <select name="project_department" id="project_department"
                                                ...
                                                @foreach ($listDepartment as $item)
                                                    <option value="{{ $item->department_id }}" {{ (isset($project) && $project['department_id'] == $item->department_id) || \Illuminate\Support\Facades\Auth::user()['department_id'] == $item->department_id ? 'selected' : ''}}>
                                        ...
                                        <div class="input-group">
                                            <select name="project_status" id="project_status"
                                                ...
                                                @foreach ($listStatus as $item)
                                                    <option value="{{ $item->manage_project_status_id }}" {{(isset($project) && $project['manage_project_status_id'] == $item->manage_project_status_id) || $item->manage_project_status_id == 1 ? 'selected' : ''}}>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control m-input date-input" disabled
                                                   placeholder="{{ __('Nhập tiền tố công việc') }}"
                                                   value="{{$project['prefix_code']}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control progress-input"
                                                   placeholder="{{ __('Nhập tiến độ dự án') }}" value="{{isset($project['progress']) ? $project['progress'] : 0}}" id="progress"
                                                   name="progress">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    <label class="m-radio cus">
                                                        <input type="radio" name="permission" {{$project['permission'] == 'private' ? 'checked' : ''}}
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    <label class="m-radio cus">
                                                        <input type="radio" name="permission" {{$project['permission'] == 'public' ? 'checked' : ''}}
                                                               class="period_in_date_type period_in_date_type_unlimited"
                                                               value="public">
                                                        {{ __('Công khai') }}
                                                        <span></span>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-control custom-radio custom-control-inline mr-5">
                                                <input type="radio" class="custom-control-input" name="is_important" {{$project['is_important'] == 0 ? 'checked' : ''}} value="0" id="is_important_0">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline ml-5">
                                                <input type="radio" class="custom-control-input" name="is_important" {{$project['is_important'] == 1 ? 'checked' : ''}} value="1" id="is_important_1">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control budget" id="budget" name="budget" value="{{number_format($project['budget'])}}" placeholder="{{__('Ngân sách dự án')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group mb-2 mr-sm-2 position-relative">
                                            <input type="text" class="form-control resource" id="resource" value="{{number_format($project['resource'])}}" placeholder="{{__('Nguồn lực dự án')}}">
                                        ...
                                        <div class="input-group">
                                            <select name="contract_id" id="contract_id"
                                                ...
                                                @foreach($listContract as $item)
                                                    <option value="{{$item['contract_id']}}" {{$project['contract_id'] == $item['contract_id'] ? 'selected' : ''}} data-code="{{$item['contract_code']}}">{{$item['contract_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row block-user-contact">
                                                    <div class="col-lg-5">
                                                        <div class="form-group m-form__group ">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control user_contact_name" name="user_contact[{{$key}}]name" value="{{$item['name']}}" placeholder="{{__('Người liên hệ')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-5">
                                                        <div class="form-group m-form__group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control user_contact_phone" name="user_contact[{{$key}}]phone" value="{{$item['phone']}}" placeholder="{{__('SDT người liên hệ')}}">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <form id="form-file" autocomplete="off">
        ...
        {{--        <input type="hidden" id="manage_work_id" name="manage_work_id" value="{{$detail['manage_work_id']}}">--}}
                <input type="hidden" id="manage_project_id" name="manage_project_id" value="{{$project['manage_project_id']}}">
    </form>
@endsection
@php
...
@section('after_script')
    ...
    <script>
        var n = 0;
        var nCustomer = {{count($listContact)}};
        var nDocument = 0;
    </script>
