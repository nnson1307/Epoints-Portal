                        ...
                        <tbody>
                            @foreach($project->dataShow as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($key == 0)
                                            <a href="{{ route('manager-project.member', ['manage_project_id' => $idProject,'department_id' => $item['department_id'],'none_time' => true]) }}">
                                                {{$item['total_staff']}}</td>
                                            </a>
                                        @else
                                            <a href="{{ route('manager-project.member', ['manage_project_id' => $idProject,'department_id' => $item['department_id'],'manage_project_id' => $idProject,'none_time' => true]) }}">
                                                {{$item['total_staff']}}</td>
                                            </a>
                                        @endif
