...
@section('content')
    <div class="m-portlet" id="autotable">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{ route('manager-project.project.add') }}"
                ...
                <a href="javascript:void(0)" data-toggle="modal" data-target="#modalAdd" onclick="Project.clear()"
        ...
        <div class="m-portlet__body">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 form-group">
                                    <div class="d-flex">
                                        <button onclick="Project.refresh()" class="btn btn-refresh ss--button-cms-piospa m-btn--icon mr-3">
                                            {{ __('XÓA BỘ LỌC') }}
            ...
            <div class="table-content">
                @include('manager-project::project.list')
    ...
    <div class="modal fade" id="modalAdd" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-project::project.add')
        </div>
    </div>
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-project::project.edit')
        </div>
    </div>
    <div class="modal fade" id="modalView" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <!-- Modal content-->
            @include('manager-project::project.view')
        </div>
    </div>
@stop
@section('after_script')
    <script src="{{ asset('static/backend/js/manager-project/project/list.js?v=' . time()) }}" type="text/javascript"></script>
@stop
