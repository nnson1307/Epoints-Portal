<div id="add-payment" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title title_index">
                    <i class="fa fa-plus-circle"></i> {{__('THÊM PHIẾU CHI')}}
                </h4>
            </div>
            <form id="add-payment-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="object_accounting_type_code" id="object_accounting_type_code" class="form-control m-input select"
                                            ...
                                            @foreach( $data['OBJECT_ACCOUNTING_TYPE'] as $v)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="payment_type" id="payment_type" class="form-control m-input" style="width: 100%">
                                            <option></option>
                                            @foreach($data['PAYMENT_TYPE'] as $v)
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input aria-describedby="basic-addon1" name="total_amount" class="format-money form-control m-input btn-sm numeric_child" id="total_amount"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="payment_method" id="payment_method" class="form-control m-input select"
                                            ...
                                            @foreach($data['PAYMENT_METHOD'] as $v)
                    ...
                    <div class="modal-footer">
                        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                            <div class="m-form__actions m--align-right">
                                ...
                                <button type="button" onclick="projectInfo.addPayment()"
                ...
                <input type="hidden" name="manage_project_id" value="{{$data['manage_project_id']}}"></input>
            </form>
        </div>
    </div>
</div>
