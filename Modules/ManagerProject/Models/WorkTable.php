    ...
    public function getAllWork($filter = []){
        $mSelect = $this
            ->select(
                ...
                "{$this->table}.manage_project_issue_id",
        ...
        if(isset($filter['arrPhaseId']) && $filter['arrPhaseId'] != '' && $filter['arrPhaseId']!= null ){
            $mSelect = $mSelect->whereIn("{$this->table}.manage_project_phase_id",$filter['arrPhaseId']);
        }
        if(isset($filter['arrIdIssue']) && $filter['arrIdIssue'] != '' && $filter['arrIdIssue']!= null ){
            $mSelect = $mSelect->whereIn("{$this->table}.manage_project_issue_id",$filter['arrIdIssue']);
        }
