    ...
    public  function projectInfo($input){
        $mSelect = $this
            -> select (
                ...
                "manage_project_contact.manage_project_contact_id",
                "manage_project_contact.name as contact_name",
                "manage_project_contact.phone as contact_phone",
            ...
            ->leftJoin("manage_project_status_config","manage_project_status.manage_project_status_id","manage_project_status_config.manage_project_status_id")
            ->leftJoin("staffs","{$this->table}.created_by","staffs.staff_id")
            ->leftJoin("manage_project_contact","{$this->table}.manage_project_id","manage_project_contact.manage_project_id")
