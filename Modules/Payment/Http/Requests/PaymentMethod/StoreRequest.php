...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'payment_method_code' => 'required|max:50|unique:payment_method,payment_method_code,'.',payment_method_id,is_delete,0',
            'payment_method_name_vi' => 'required|max:255|unique:payment_method,payment_method_name_vi,'.',payment_method_id,is_delete,0',
            'payment_method_name_en' => 'required|max:255|unique:payment_method,payment_method_name_en,'.',payment_method_id,is_delete,0',
    ...
    {
        return [
            'payment_method_code.required' => __('Hãy nhập mã hình thức thanh toán'),
            'payment_method_code.unique' => __('Mã hình thức thanh toán là duy nhất'),
            'payment_method_code.max' => __('Mã hình thức thanh toán không quá 50 kí tự'),
