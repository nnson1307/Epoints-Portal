...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'discount_causes_name_vi' => 'required|max:191|unique:discount_causes,discount_causes_name_vi,'.',discount_causes_id,is_delete,0',
            'discount_causes_name_en' => 'required|max:191|unique:discount_causes,discount_causes_name_en,'.',discount_causes_id,is_delete,0',
        ];
    }
