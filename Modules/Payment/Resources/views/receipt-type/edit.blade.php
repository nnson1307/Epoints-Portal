            ...
            <form id="form-create">
                <div class="form-group m-form__group">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input format-money"
                               value="{{$item['receipt_type_name_vi'] != null ? $item['receipt_type_name_vi'] : ''}}"
                ...
                <div class="form-group m-form__group">
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input format-money"
                               value="{{$item['receipt_type_name_en'] != null ? $item['receipt_type_name_en'] : ''}}"
        ...
        <div class="modal-footer">
            <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m--align-right">
                    ...
                    <button type="button" onclick="edit.save('{{$item['receipt_type_id'] != null ? $item['receipt_type_id'] : ''}}')"
