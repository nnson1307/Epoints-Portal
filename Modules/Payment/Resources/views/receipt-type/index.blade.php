        ...
        <div class="m-portlet__body">
            <div id="autotable">
                ...
                <div class="table-content m--padding-top-30">
                    @include('payment::receipt-type.list')
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/payment/receipt-type/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        listReceiptType._init();
    </script>
@stop
