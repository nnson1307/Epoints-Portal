...
<div class="book">
    <div class="page">
        <div class="subpage">
            ...
            <div class="form-group text-center">
                <span style="font-size: 23px; font-weight: bold;">@lang('HOÁ ĐƠN PHIẾU THU')</span>
            </div>
            <div class="form-group row_custom clearfix">
                <div class="col-print-7">
                    <span class="font-size-14">
                        <strong>@lang('Khách hàng'): </strong>
                    ...
                    <span class="font-size-14">
                        <strong>@lang('Điện thoại'):</strong>
                    </span> <br>
                    <span class="font-size-14">
                        <strong>@lang('Địa chỉ'):</strong>
                    </span>
                </div>
                <div class="col-print-5">
                    <span class="font-size-14">
                        <strong>@lang('Nhân viên'):</strong> {{$receipt['staff_name']}}
                    </span> <br>
                    <span class="font-size-14">
                        <strong>@lang('Ngày giờ thu'):</strong> @if ($receipt['status'] == 'paid')
                            {{\Carbon\Carbon::parse($receipt['updated_at'])->format('d/m/Y H:i:s')}}
                        @endif
                    </span> <br>
                    <span class="font-size-14">
                        <strong>@lang('Số hoá đơn'):</strong> {{$receipt['receipt_code']}}
                    </span>
                </div>
            </div>
            ...
            <div class="form-group">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                           {{number_format($receipt['amount_paid'], isset(config()->get('config.decimal_number')->value) ? config()->get('config.decimal_number')->value : 0)}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="7">
                            ...
                            <span style="font-style: italic;">{{$text_total_amount_paid}}</span>
