        ...
        <div class="m-portlet__body">
            <div id="autotable">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="search"
                                       placeholder="@lang("Nhập tên loại hoặc mã loại")">
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                ...
                <div class="table-content m--padding-top-30">
                    @include('payment::payment-type.list')
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/payment/payment-type/script.js?v='.time())}}"
            type="text/javascript"></script>
    <script>
        listPaymentType._init();
    </script>
@stop
