            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h2 class="m-portlet__head-text title_index">
                        <span><i class="la la-server"></i> {{__('DANH SÁCH LÝ DO GIẢM GIÁ')}}</span>
                    </h2>
                            ...
                            <div class="form-group m-form__group">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search"
                                           placeholder="{{__('Nhập tên loại lý do giảm giá')}}">
                                </div>
                            </div>
                        </div>
...
{{--                 @include('helpers.filter')--}}
            ...
            <div class="table-content m--padding-top-15">
                @include('payment::discount-causes.list')
