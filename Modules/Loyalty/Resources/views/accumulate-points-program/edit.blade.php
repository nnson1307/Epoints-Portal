            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h2 class="m-portlet__head-text">
                        {{ __('CẬP NHẬT CHƯƠNG TRÌNH TÍCH ĐIỂM') }}
                    </h2>
                </div>
            </div>
            <div class="">
            ...
            <form id="form-data" action="" style="margin-bottom:100px" method="POST">
                <div class="m-portlet__body">
                    <div class="row form-group">
                        <input type="text" hidden value="{{ $itemProgram->accumulation_program_id }}"
                            id="accumulation_program_id">
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col-xl-12 col-lg-12">
                                    ...
                                    <div class="kt-radio-list">
                                        <div class="mb-3">
                                            <label class="m-radio cus">
                                                <input type="radio" name="validity_period_type"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group date">
                                                    ...
                                                    @else disabled readonly @endif
                                                    placeholder="@lang('survey::survey.create.time_start')" name="date_start">
                                    ...
                                    <span class="m-switch m-switch--icon m-switch--success m-switch--sm">
                                        <label style="margin: 0 0 0 10px; padding-top: 4px">
                                            <input type="checkbox" {{ $itemProgram->is_active == 1 ? 'checked' : '' }}
                                                class="manager-btn" id="is_active" name="is_active">
                                            <span></span>
                                        </label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-xl-8">
                                    <textarea name="loylaty_description" class="form-control" id="loylaty_description" cols="30" rows="5">{{ $itemProgram->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 mt-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="number"
                                                @if ($itemProgram->apply_type == 'all' && $itemProgram->accumulation_point != '') value="{{ $itemProgram->accumulation_point }}"
                                                 @else
                                            disabled @endif
                                                class="form-control" id="accumulate_point_all"
