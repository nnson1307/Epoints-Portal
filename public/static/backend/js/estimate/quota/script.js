$(document).ready(function () {
    $('#description').summernote({
        height: 150,
        placeholder: translate.lang['Nhập nội dung...'],
        toolbar: [
    ...
    $('#provinceid').select2({
        placeholder: translate.lang["Chọn tỉnh/thành"],
    });
    ...
    $('#districtid').select2({
        placeholder: translate.lang["Chọn quận/huyện"],
        ajax: {
            url: laroute.route('admin.customer.load-district'),
...
var branch = {
    remove: function (obj, id) {
        ...
        swal({
            title: translate.lang['Thông báo'],
            text: translate.lang["Bạn có muốn xóa không?"],
            type: 'warning',
            showCancelButton: true,
            confirmButtonText: translate.lang['Xóa'],
            cancelButtonText: translate.lang['Hủy'],
            onClose: function () {
    ...
    add: function () {
        ...
        form.validate({
            ...
            messages: {
                branch_name: {
                    required: translate.lang['Hãy nhập tên chi nhánh']
                },
                address: {
                    required: translate.lang['Hãy nhập địa chỉ']
                },
                phone: {
                    required: translate.lang['Hãy nhập số điện thoại'],
                    minlength: translate.lang['Tối thiểu 10 số'],
                    number: translate.lang['Số điện thoại không hợp lệ'],
                    maxlength: translate.lang['Số điện thoại không hợp lệ']
                },
                provinceid: {
                    required: translate.lang['Hãy chọn tỉnh/thành phố']
                },
                districtid: {
                    required: translate.lang['Hãy chọn quận/huyện']
                },
                // hot_line: {
                //     number: translate.lang['Số hot line không hợp lệ']
                // },
                representative_code: {
                    required: translate.lang['Hãy nhập mã đại diện']
                }
            },
        });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success == 1) {
                            swal(translate.lang["Thêm chi nhánh thành công"], "", "success");
    ...
    edit: function () {
        ...
        if (email != '') {
            if (!isValidEmailAddress(email)) {
                $('.error_email').text(translate.lang['Email không hợp lệ']);
                return false;
            } else {
                $.ajax({
                    type: 'POST',
                    ...
                    success: function (response) {
                        if (response.success == 1) {
                            $('.error-name').text('');
                            swal(translate.lang["Cập nhật chi nhánh thành công"], "", "success");
                            window.location = laroute.route('admin.branch');
                        }
