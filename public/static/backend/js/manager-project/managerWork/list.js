...
var detailCommon = {
    ...
    showPopup : function(id){
        $.ajax({
            url: laroute.route('manager-project.work.detail.show-popup-remind-popup'),
            method: "POST",
            data: {
    ...
    addCloseRemind : function (check) {
        $.ajax({
            url: laroute.route('manager-project.work.staff-overview.add-remind-work'),
...
var ManagerWork = {
    ...
    submitCopy : function (id){
        ...
        swal({
            ...
            if (result.value) {
                $.post(laroute.route('manager-project.work.copy', { id: id }), function(res) {
                    if (res.error == false){
                        swal(
    ...
    approve : function (id){
        ...
        swal({
            ...
            if (result.value) {
                $.post(laroute.route('manager-project.work.approve', { id: id }), function() {
                    swal(
    ...
    reject : function (id){
        ...
        swal({
            ...
            if (result.value) {
                $.post(laroute.route('manager-project.work.reject', { id: id }), function() {
                    swal(
    ...
    remove: function(obj, id, total_child = 0, list = false) {
        ...
        swal({
            ...
            if (result.value) {
                $.post(laroute.route('manager-project.work.remove', { id: id }), function(res) {
                    if(!res.error){
                        swal(
    ...
    changeStatus: function(obj, id, action) {
        $.post(laroute.route('manager-project.work.change-status'), { id: id, action: action }, function(data) {
            $('#autotable').PioTable('refresh');
        }, 'JSON');
    },
    showAdd : function(){

        $.post(laroute.route('manager-project.work.show-add'), {}, function (res) {
    ...
    add: function() {
        ...
        $.ajax({
            url: laroute.route('manager-project.work.add'),
            method: 'POST',
            dataType: 'JSON',
            data: form.serialize(),
            success: function(res) {
    ...
    edit: function(id) {
        ...
        clear();
        $.ajax({
            url: laroute.route('manager-project.work.edit'),
            data: {
                manage_work_id: id
            },
            method: "POST",
    ...
    submitEdit: function() {
        ...
        $.ajax({
            url: laroute.route('manager-project.work.submit-edit'),
            method: 'POST',
            dataType: 'JSON',
            data: form.serialize(),
            success: function(res) {
    ...
    exportList : function (){
        window.location.href = laroute.route('manager-project.work.export') + '?' + $('#frm-search').serialize();
    },
    ...
    saveConfig: function() {
        ...
        $.ajax({
            url: laroute.route('manager-project.work.save-config'),
            data: {
                search: search,
                column: column,
            },
...
// $('#autotable').PioTable({
//     baseUrl: laroute.route('manager-project.work.list')
// });

$('#autotable').PioTable({
    baseUrl: laroute.route('manager-project.project.project-info-work-list',{manage_project_id : $('#main_manage_project_id').val()})
});
...
function uploadImage(input) {
    if (input.files && input.files[0]) {
        ...
        if (Math.round(fsize / 1024) <= 10240) {
            $('.error_img').text('');
            $.ajax({
                url: laroute.route("manager-project.work.upload-image"),
                method: "POST",
                data: form_data,
                contentType: false,
                cache: false,
...
var WorkChild = {
    showPopup : function(manage_work_id = null, create_object_type = null, create_object_id = null){
        $.ajax({
            url: laroute.route('manager-project.work.detail.show-popup-work-child'),
            method: "POST",
            data: {
                manage_project_id : $('#frm-search input[name="manage_project_id"]').val(),
    ...
    issueShowPopup : function(project_issue_id, manage_project_id = null){
        var popup_manage_project_id = $('#frm-search input[name="manage_project_id"]').val();
        if (manage_project_id != null) {
            popup_manage_project_id = manage_project_id;
        }
        var manage_work_id = null;
        $.ajax({
            url: laroute.route('manager-project.work.detail.show-popup-work-child'),
            method: "POST",
            data: {
                manage_project_id : popup_manage_project_id,
...
var WorkAll = {
    changeCustomer : function(manage_work_id = null){
        ...
        $.ajax({
            url: laroute.route('manager-project.work.detail.change-customer'),
            data: {
...
uploadImgCkList = function (file,parent_comment = null) {
    ...
    $.ajax({
        method: 'POST',
        url: laroute.route('manager-project.work.detail.upload-file'),
        contentType: false,
        cache: false,
        processData: false,
        data: out,
...
var ManagerWorkDetail = {
    remove: function(obj, id, total_child = 0, list = false) {
        ...
        $.post(laroute.route('manager-project.work.check-work-child', { id: id }), function(res) {
            if(res.error == false){
                var title = ManagerWork.jsonLang["Bạn có muốn xóa không?"];
...
var ProjectWork = {
    phareChange : function (){
        $('#main_manage_project_phase_id').val($('#manage_project_phase_id').val());
        $('.btn-search').trigger('click');
    }
}
