...
var detailCommon = {
    showPopup : function(id){
        $.ajax({
            url: laroute.route('project.work.manager-project.work.detail.show-popup-remind-popup'),
            method: "POST",
            data: {
...
var ManagerWork = {
    ...
    submitCopy : function (id){
        $.getJSON(laroute.route('translate'), function (json) {
            swal({
                ...
                if (result.value) {
                    $.post(laroute.route('manager-project.work.copy', {id: id}), function () {
                        swal(
    ...
    searchPageListStaff : function (page = 1){
        ...
        $.ajax({
            url: laroute.route('manager-project.work.kanban-view.search-page-popup-staff'),
            data: {
...
var WorkChild = {
    ...
    showPopup : function(manage_work_id = null){
        console.log($('#frm-search input[name="manage_project_id"]').val());
        $.ajax({
