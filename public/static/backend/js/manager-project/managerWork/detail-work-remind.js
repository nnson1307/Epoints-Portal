...
var Remind = {
    ...
    search: function (manage_work_id) {
        $.ajax({
            url: laroute.route('manager-project.work.detail.search-remind'),
            method: "POST",
    ...
    removeRemind:function (id) {
        $.getJSON(laroute.route('translate'), function (json) {
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url: laroute.route('manager-project.work.detail.remove-remind'),
                        method: "POST",
                        data: {
                            manage_remind_id: id
                        },
    ...
    changeActive : function (id) {
        ...
        $.ajax({
            url: laroute.route('manager-project.work.detail.change-status-remind'),
            method: "POST",
            data: {
                manage_remind_id: id,
                is_active:is_active
