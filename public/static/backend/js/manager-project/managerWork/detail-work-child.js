...
var WorkChild = {
    ...
    removeRemind : function (manage_work_id) {
        $.getJSON(laroute.route('translate'), function (json) {
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url: laroute.route('manager-project.work.detail.remove-work'),
                        method: "POST",
                        data: {
                            manage_work_id: manage_work_id
                        },
    ...
    search: function (manage_work_id,page = 1) {
        $.ajax({
            url: laroute.route('manager-project.work.detail.search-work'),
            data: $('#form-search').serialize()+'&manage_work_id='+manage_work_id+'&page='+page,
            method: "POST",
            dataType: "JSON",
            success: function(res) {
                if (res.error == false) {
