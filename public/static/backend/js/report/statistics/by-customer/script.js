    ...
    loadChart: function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                console.log(res.chartCustomer);
                chartCustomer(res.chartCustomer);
                chartGender(res.chartGender);
                chartCustomerSource(res.chartCustomerSource);
...
function chartCustomer(dataValue) {
    ...
    function drawChart() {
        ...
        $.getJSON(laroute.route('translate'), function (json) {
            ...
            var chart = new google.charts.Bar(document.getElementById('chart-growth-customer'));
