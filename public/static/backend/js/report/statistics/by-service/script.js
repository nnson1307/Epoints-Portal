    ...
    _init: function () {
        $.getJSON(laroute.route('translate'), function (json) {
            ...
            $("#time").daterangepicker({
                ...
                statisticService.loadChart();
            });
            $('#service').select2().on('select2:select', function (event) {
                statisticService.loadChart();
            });
            statisticService.loadChart();
        });
    ...
    loadChart: function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                chartGrowthService(data.dataChartColumn);
                ...
                $('#autotable').PioTable({
                    baseUrl: laroute.route('admin.report-growth.service.list-detail')
                });
