var dropAdd = Dropzone.options.dropzoneone = {
    url: laroute.route('admin.customer.uploads'),
    maxFiles: 10,
    paramName: "customer_avatar",
        ...
        this.on('success', function (file, response) {
            if (response.success == 1) {
                if ($('#file_image').length) {
                    ...
                    $("#form").prepend("<input id='file_image' type='hidden' name='customer_avatar' value='" + response.file + "'>");
                }
            }
