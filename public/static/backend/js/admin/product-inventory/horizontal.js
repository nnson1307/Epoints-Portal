        ...
        init: function () {
            $(".m_datatable").mDatatable({
                    data: {
                        type: "remote", source: {
                            read: {
                                url: laroute.route('admin.get-list-product-inventory'),
                                method: 'POST',
                                // custom headers
                    ...
                    , layout: {
                        theme: "default", class: "", scroll: !0, footer: !1
                    }
                    , sortable: !0, filterable: !1, pagination: !0, search: {
                        input: $("#generalSearch")
                    }
                    , toolbar: {
                        items: {
                    ...
                    , columns: [{
                        ...
                        , {
                            field: "name", title: "TÊN SẢN PHẨM", width: 150
                        }
                        , {
                            field: "wareHouse", title: "KHO", responsive: {
                                hidden: "md"
                            }
                        }
                        , {
                            field: "quantity", title: "S", width: 200, responsive: {
                                visible: "lg"
                            }
                        }
                        , {
                            field: "CompanyEmail", title: "Email", width: 150, responsive: {
                                visible: "lg"
                            }
                        }
                        , {
                            field: "CompanyAgent", title: "Agent", responsive: {
                                visible: "lg"
                            }
                        }
                        , {
                            field: "Notes", title: "Notes", width: 500
                        }
                        , {
                        ...
                        , {
                            field: "Notes", title: "Notes", width: 250
                        }
                        , {
                            field: "ShipDate", title: "Ship Date"
                        }
                        , {
                            field: "TimeZone", title: "Time Zone", width: 150
                        }
                        , {
                            field: "Status", title: "Status", width: 150, template: function (t) {
                                var e = {
                                        1: {
                        ...
                        , {
                            field: "Type", title: "Type", width: 150, template: function (t) {
                                var e = {
                                        1: {
