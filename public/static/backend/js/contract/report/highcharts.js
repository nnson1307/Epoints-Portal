...
*/
(function (O, J) {
    "object" === typeof module && module.exports ? module.exports = O.document ? J(O) : J : "function" === typeof define && define.amd ? define(function () {
        return J(O)
    }) : O.Highcharts = J(O)
})("undefined" !== typeof window ? window : this, function (O) {
    var J = function () {
        var a = "undefined" === typeof O ? window : O, y = a.document, G = a.navigator && a.navigator.userAgent || "",
            E = y && y.createElementNS && !!y.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            h = /(edge|msie|trident)/i.test(G) && !a.opera, c = -1 !== G.indexOf("Firefox"),
            r = -1 !== G.indexOf("Chrome"), u = c && 4 > parseInt(G.split("Firefox/")[1], 10);
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], c = this.paths[1], r = [], u = this.now, v = a.length, w;
                if (1 === u) r = this.toD;
                else if (v === c.length && 1 > u) for (; v--;) w = parseFloat(a[v]), r[v] = isNaN(w) ? c[v] : u * parseFloat(c[v] - w) + w; else r = c;
                this.elem.attr("d", r, null, !0)
            }, update: function () {
                var a = this.elem, c = this.prop, r = this.now, u = this.options.step;
                if (this[c + "Setter"]) this[c + "Setter"](); else a.attr ? a.element && a.attr(c, r, null, !0) : a.style[c] = r + this.unit;
                u && u.call(a, r, this)
            }, run: function (h, c, r) {
                var u = this, v = u.options, w = function (a) {
                    return w.stopped ? !1 : u.step(a)
                }, n = E.requestAnimationFrame || function (a) {
                    setTimeout(a, 13)
                }, g = function () {
                    for (var d =
                        0; d < a.timers.length; d++) a.timers[d]() || a.timers.splice(d--, 1);
                    a.timers.length && n(g)
                };
                ...
                var c = +new Date, r, u = this.options, v = this.elem, w = u.complete, n = u.duration, g = u.curAnim;
                v.attr &&
                !v.element ? h = !1 : h || c >= n + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), r = g[this.prop] = !0, a.objectEach(g, function (a) {
                    !0 !== a && (r = !1)
                ...
                function u(a) {
                    var b, k;
                    for (f = a.length; f--;) b = "M" === a[f] || "L" === a[f], k = /[a-zA-Z]/.test(a[f + 3]), b && k && a.splice(f + 1, 0, a[f + 1], a[f + 2], a[f + 1], a[f + 2])
                }
                ...
                function w(a, f) {
                    for (var k = (b - a.length) / p; 0 < k && k--;) l = a.slice().splice(a.length / t - p, p * t), l[0] = f[b - p - k * p], m && (l[p - 6] = l[p - 2], l[p - 5] = l[p - 1]), [].splice.apply(a, [a.length / t, 0].concat(l)), x && k--
                }

                c = c || "";
                var n, g = h.startX, d = h.endX, m = -1 < c.indexOf("C"), p = m ? 7 : 3, b, l, f;
                c = c.split(" ");
                r = r.slice();
                var x = h.isArea, t = x ? 2 : 1, H;
                m && (u(c), u(r));
                if (g && d) {
                    for (f = 0; f < g.length; f++) if (g[f] ===
                        d[0]) {
                        n = f;
                        break
        ...
        a.merge = function () {
            var h, c = arguments, r, u = {}, v = function (c, n) {
                "object" !== typeof c && (c = {});
        ...
        a.isObject = function (h, c) {
            return !!h && "object" === typeof h && (!c || !a.isArray(h))
        };
        ...
        a.attr = function (h, c, r) {
            var u;
            a.isString(c) ? a.defined(r) ? h.setAttribute(c, r) : h && h.getAttribute && ((u = h.getAttribute(c)) || "class" !==
                c || (u = h.getAttribute(c + "Name"))) : a.defined(c) && a.isObject(c) && a.objectEach(c, function (a, c) {
                h.setAttribute(c, a)
            });
            return u
        };
        ...
        a.pick = function () {
            var a = arguments, c, r, u = a.length;
            for (c = 0; c < u; c++) if (r = a[c], void 0 !== r && null !== r) return r
        };
        a.css = function (h, c) {
            a.isMS &&
            !a.svg && c && void 0 !== c.opacity && (c.filter = "alpha(opacity\x3d" + 100 * c.opacity + ")");
            a.extend(h.style, c)
        };
        a.createElement = function (h, c, r, u, v) {
            ...
            var w = a.css;
            c && a.extend(h, c);
            v && w(h, {padding: 0, border: "none", margin: 0});
            r && w(h, r);
            u && u.appendChild(h);
            return h
        };
        ...
        a.stableSort = function (a, c) {
            ...
            for (v = 0; v < h; v++) delete a[v].safeI
        };
        ...
        a.numberFormat = function (h, c, r, u) {
            h = +h || 0;
            c = +c;
            var v = a.defaultOptions.lang, w = (h.toString().split(".")[1] || "").split("e")[0].length, n, g,
        ...
        a.getStyle = function (h, c, r) {
            ...
            if (h = E.getComputedStyle(h,
                void 0)) h = h.getPropertyValue(c), a.pick(r, "opacity" !== c) && (h = a.pInt(h));
            return h
        };
        ...
        a.find = Array.prototype.find ? function (a, c) {
            ...
            var h, u = a.length;
            for (h = 0; h < u; h++) if (c(a[h], h)) return a[h]
        };
        a.keys = Object.keys;
        a.offset = function (a) {
        ...
        a.stop = function (h, c) {
            for (var r = a.timers.length; r--;) a.timers[r].elem !== h || c && c !== a.timers[r].prop || (a.timers[r].stopped = !0)
        };
        a.objectEach = function (a, c, r) {
            for (var h in a) a.hasOwnProperty(h) && c.call(r || a[h], a[h], h, a)
        };
        ...
        a.addEvent = function (h, c, r, u) {
            var v, w = h.addEventListener || a.addEventListenerPolyfill;
            v = "function" ===
            typeof h && h.prototype ? h.prototype.protoEvents = h.prototype.protoEvents || {} : h.hcEvents = h.hcEvents || {};
        ...
        a.removeEvent = function (h, c, r) {
            ...
            function v(g) {
                ...
                h.nodeName && (c ? (d = {}, d[c] = !0) : d = g, a.objectEach(d, function (a, b) {
                    if (g[b]) for (m = g[b].length; m--;) u(b, g[b][m])
                }))
            }
        ...
        a.fireEvent = function (h, c, r, u) {
            var v, w, n, g, d;
            r = r || {};
            G.createEvent && (h.dispatchEvent || h.fireEvent) ? (v = G.createEvent("Events"), v.initEvent(c, !0, !0), a.extend(v, r), h.dispatchEvent ? h.dispatchEvent(v) : h.fireEvent(c, v)) : ["protoEvents",
                "hcEvents"].forEach(function (m) {
                if (h[m]) for (w = h[m][c] || [], n = w.length, r.target || a.extend(r, {
                    preventDefault: function () {
                        r.defaultPrevented = !0
                    }, target: h, type: c
                }), g = 0; g < n; g++) (d = w[g]) && !1 === d.call(h, r) && r.preventDefault()
            });
            u && !r.defaultPrevented && u.call(h, r)
        };
        a.animate = function (h, c, r) {
            var u, v = "", w, n, g;
            a.isObject(r) || (g = arguments, r = {duration: g[2], easing: g[3], complete: g[4]});
        ...
        a.seriesType = function (h, c, r, u, v) {
            var w = a.getOptions(), n = a.seriesTypes;
            w.plotOptions[h] = a.merge(w.plotOptions[c], r);
            n[h] = a.extendClass(n[c] || function () {
            }, u);
            n[h].prototype.type = h;
            v && (n[h].prototype.pointClass = a.extendClass(a.Point,
                v));
            return n[h]
        };
    ...
    (function (a) {
        var y = a.isNumber, G = a.merge, E = a.pInt;
        a.Color = function (h) {
            if (!(this instanceof
                a.Color)) return new a.Color(h);
            this.init(h)
        };
        a.Color.prototype = {
            parsers: [{
                ...
                var c, r, u, v;
                if ((this.input = h = this.names[h && h.toLowerCase ? h.toLowerCase() :
                    ""] || h) && h.stops) this.stops = h.stops.map(function (c) {
                    return new a.Color(c[1])
                }); else if (h && h.charAt && "#" === h.charAt() && (c = h.length, h = parseInt(h.substr(1), 16), 7 === c ? r = [(h & 16711680) >> 16, (h & 65280) >> 8, h & 255, 1] : 4 === c && (r = [(h & 3840) >> 4 | (h & 3840) >> 8, (h & 240) >> 4 | h & 240, (h & 15) << 4 | h & 15, 1])), !r) for (u = this.parsers.length; u-- && !r;) v = this.parsers[u], (c = v.regex.exec(h)) && (r = v.parse(c));
                this.rgba = r || []
            }, get: function (a) {
                var c = this.input, h = this.rgba, u;
                this.stops ? (u = G(c), u.stops = [].concat(u.stops), this.stops.forEach(function (c,
                                                                                                   h) {
                ...
                if (this.stops) this.stops.forEach(function (c) {
                    c.brighten(a)
                }); else if (y(a) && 0 !== a) for (c = 0; 3 > c; c++) h[c] += E(255 * a), 0 > h[c] && (h[c] = 0), 255 < h[c] && (h[c] = 255);
                return this
            }, setOpacity: function (a) {
                this.rgba[3] = a;
                return this
            }, tweenTo: function (a, c) {
                var h = this.rgba, u = a.rgba;
                u.length && h && h.length ? (a = 1 !== u[3] || 1 !==
                    h[3], c = (a ? "rgba(" : "rgb(") + Math.round(u[0] + (h[0] - u[0]) * (1 - c)) + "," + Math.round(u[1] + (h[1] - u[1]) * (1 - c)) + "," + Math.round(u[2] + (h[2] - u[2]) * (1 - c)) + (a ? "," + (u[3] + (h[3] - u[3]) * (1 - c)) : "") + ")") : c = a.input || "none";
                return c
            }
        };
        a.color = function (h) {
    ...
    (function (a) {
        var y, G, E = a.addEvent, h = a.animate, c = a.attr, r = a.charts, u = a.color, v = a.css, w = a.createElement,
            n = a.defined, g = a.deg2rad, d = a.destroyObjectProperties, m = a.doc, p = a.extend, b = a.erase,
            l = a.hasTouch, f = a.isArray, x = a.isFirefox, t = a.isMS, H = a.isObject,
            F = a.isString, z = a.isWebKit, k = a.merge, A = a.noop, D = a.objectEach, B = a.pick, e = a.pInt,
            q = a.removeEvent, L = a.splat, I = a.stop, R = a.svg, K = a.SVG_NS, M = a.symbolSizes, S = a.win;
        ...
        p(y.prototype, {
            ...
            complexColor: function (e, q, b) {
                var C = this.renderer, l, d, p, g, A, K, m, N, x, c, t, I = [], L;
                a.fireEvent(this.renderer, "complexColor", {args: arguments}, function () {
                    ...
                    "radialGradient" === d && c && !n(p.gradientUnits) && (g = p, p = k(p, C.getRadialAttr(c, g), {gradientUnits: "userSpaceOnUse"})), D(p, function (a, e) {
                        "id" !== e && I.push(e, a)
                    }), D(m, function (a) {
                        I.push(a)
                        ...
                        e = C.createElement("stop").attr({offset: e[0], "stop-color": N, "stop-opacity": x}).add(K);
                        K.stops.push(e)
            ...
            applyTextOutline: function (e) {
                ...
                if ((k = e[0]) && "none" !== k && a.svg) {
                    ...
                    for (d = e.length; d--;) q =
                        e[d], "highcharts-text-outline" === q.getAttribute("class") && b(e, C.removeChild(q));
                    l = C.firstChild;
            ...
            attr: function (e, q, b,
                            f) {
                var C, k = this.element, l, d = this, p, g, A = this.symbolCustomAttribs;
                ...
                "string" === typeof e ? d = (this[e + "Getter"] || this._defaultGetter).call(this, e, k) : (D(e, function (C, q) {
                    ...
                    p || (g = this[q + "Setter"] || this._defaultSetter, g.call(this, C, q, k), !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(q) &&
            ...
            updateShadows: function (a, e, q) {
                for (var C = this.shadows, b = C.length; b--;) q.call(C[b], "height" === a ? Math.max(e - (C[b].cutHeight || 0), 0) : "d" === a ? this.d : e, a, C[b])
            },
            ...
            css: function (a) {
                var C = this.styles, q = {}, b = this.element, k, f = "", l, d = !C,
                    g = ["textOutline", "textOverflow", "width"];
                a && a.color && (a.fill = a.color);
                C && D(a, function (a, e) {
                    a !== C[e] && (q[e] = a, d = !0)
                });
                d && (C && (a = p(C, q)), a && (null === a.width || "auto" === a.width ? delete this.textWidth : "text" === b.nodeName.toLowerCase() &&
                    a.width && (k = this.textWidth = e(a.width))), this.styles = a, k && !R && this.renderer.forExport && delete a.width, b.namespaceURI === this.SVG_NS ? (l = function (a, e) {
            ...
            on: function (a, e) {
                var q = this, C = q.element;
                l && "click" === a ? (C.ontouchstart = function (a) {
                    q.touchEventFired = Date.now();
                    a.preventDefault();
                    e.call(C, a)
                }, C.onclick = function (a) {
                    (-1 === S.navigator.userAgent.indexOf("Android") ||
                        1100 < Date.now() - (q.touchEventFired || 0)) && e.call(C, a)
                }) : C["on" + a] = e;
                return this
            },
            ...
            updateTransform: function () {
                var a = this.translateX || 0, e = this.translateY || 0, q = this.scaleX,
                    b = this.scaleY, f = this.inverted, k = this.rotation, l = this.matrix, d = this.element;
            ...
            getBBox: function (a, e) {
                var q, C = this.renderer, b, f = this.element, k = this.styles, l, d = this.textStr, A, K = C.cache,
                    m = C.cacheKeys, x = f.namespaceURI === this.SVG_NS, c;
                e = B(e, this.rotation);
                b = e * g;
                l = C.styledMode ? f && y.prototype.getStyle.call(f, "font-size") : k && k.fontSize;
                n(d) && (c = d.toString(), -1 === c.indexOf("\x3c") && (c = c.replace(/[0-9]/g, "0")), c += ["", e || 0, l, this.textWidth,
                    k && k.textOverflow].join());
                c && !a && (q = K[c]);
                if (!q) {
                    if (x || C.forExport) {
                        try {
                    ...
                    C.isSVG && (a = q.width, C = q.height, x && (q.height = C = {
                        "11px,17": 14,
                        "13px,20": 16
                    }[k && k.fontSize + "," + Math.round(C)] || C), e && (q.width = Math.abs(C * Math.sin(b)) +
                        Math.abs(a * Math.cos(b)), q.height = Math.abs(C * Math.cos(b)) + Math.abs(a * Math.sin(b))));
                    if (c && 0 < q.height) {
                        for (; 250 < m.length;) delete K[m.shift()];
                        K[c] || m.push(c);
                        K[c] = q
                    }
                }
            ...
            add: function (a) {
                var e = this.renderer, q = this.element, C;
            ...
            destroy: function () {
                var a = this, e = a.element || {}, q = a.renderer,
                    f = q.isSVG && "SPAN" === e.nodeName && a.parentGroup, k = e.ownerSVGElement, l = a.clipPath;
                e.onclick = e.onmouseout = e.onmouseover = e.onmousemove = e.point = null;
                I(a);
                l && k && ([].forEach.call(k.querySelectorAll("[clip-path],[CLIP-PATH]"),
                    function (a) {
                        var e = a.getAttribute("clip-path"), q = l.element.id;
                        (-1 < e.indexOf("(#" + q + ")") || -1 < e.indexOf('("#' + q + '")')) && a.removeAttribute("clip-path")
                    }), a.clipPath = l.destroy());
                if (a.stops) {
                    for (k = 0; k < a.stops.length; k++) a.stops[k] = a.stops[k].destroy();
                    a.stops = null
                }
                a.safeRemoveChild(e);
                for (q.styledMode || a.destroyShadows(); f && f.div && 0 === f.div.childNodes.length;) e = f.parentGroup, a.safeRemoveChild(f.div), delete f.div, f = e;
            ...
            shadow: function (a,
                              e, q) {
                var b = [], f, C, k = this.element, l, d, p, g;
                if (!a) this.destroyShadows(); else if (!this.shadows) {
                    d = B(a.width, 3);
                    p = (a.opacity || .15) / d;
                    g = this.parentInverted ? "(-1,-1)" : "(" + B(a.offsetX, 1) + ", " + B(a.offsetY, 1) + ")";
                    for (f = 1; f <= d; f++) C = k.cloneNode(0), l = 2 * d + 1 - 2 * f, c(C, {
                        stroke: a.color || "#000000",
                        "stroke-opacity": p * f,
                        "stroke-width": l,
                        transform: "translate" + g,
                        fill: "none"
                    }), C.setAttribute("class", (C.getAttribute("class") || "") + " highcharts-shadow"), q && (c(C, "height", Math.max(c(C, "height") - l, 0)), C.cutHeight = l), e ? e.element.appendChild(C) :
            ...
            dashstyleSetter: function (a) {
                var q, f = this["stroke-width"];
                "inherit" === f && (f = 1);
                if (a = a && a.toLowerCase()) {
                    a = a.replace("shortdashdotdot", "3,1,1,1,1,1,").replace("shortdashdot", "3,1,1,1").replace("shortdot", "1,1,").replace("shortdash", "3,1,").replace("longdash", "8,3,").replace(/dot/g, "1,3,").replace("dash", "4,3,").replace(/,$/, "").split(",");
                    for (q = a.length; q--;) a[q] = e(a[q]) * f;
            ...
            titleSetter: function (a) {
                ...
                e.appendChild(m.createTextNode(String(B(a), "").replace(/<[^>]*>/g,
                    "").replace(/&lt;/g, "\x3c").replace(/&gt;/g, "\x3e")))
            },
            textSetter: function (a) {
                a !== this.textStr && (delete this.bBox, this.textStr = a, this.added && this.renderer.buildText(this))
            },
            fillSetter: function (a, e, q) {
                "string" === typeof a ? q.setAttribute(e, a) : a && this.complexColor(a, e, q)
            },
            visibilitySetter: function (a, e, q) {
                "inherit" === a ? q.removeAttribute(e) : this[e] !== a && q.setAttribute(e, a);
                this[e] = a
            },
            zIndexSetter: function (a, q) {
                var f = this.renderer, b = this.parentGroup, k = (b || f).element || f.box, l, d = this.element, C, p,
                    f = k === f.box;
                l = this.added;
                var g;
                ...
                if (l) {
                    ...
                    q = k.childNodes;
                    for (g = q.length - 1; 0 <= g && !C; g--) if (b = q[g], l = b.getAttribute("data-z-index"), p = !n(l), b !== d) if (0 > a && p && !f && !g) k.insertBefore(d, q[g]), C = !0; else if (e(l) <= a || p && (!n(a) || 0 <= a)) k.insertBefore(d, q[g + 1] || null), C = !0;
                    C || (k.insertBefore(d, q[f ? 3 : 0] || null), C = !0)
                }
                return C
            },
            _defaultSetter: function (a, e, q) {
                q.setAttribute(e, a)
            }
        });
        ...
        y.prototype["stroke-widthSetter"] = y.prototype.strokeSetter = function (a, e, q) {
            this[e] = a;
            this.stroke && this["stroke-width"] ? (y.prototype.fillSetter.call(this, this.stroke,
                "stroke", q), q.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === e && 0 === a && this.hasStroke && (q.removeAttribute("stroke"), this.hasStroke = !1)
        };
        ...
        p(G.prototype, {
            ...
            init: function (a, e, q, f, b, k, l) {
                var d;
                d = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"});
                ...
                this.setSize(e,
                    q, !1);
                var C;
                x && a.getBoundingClientRect && (e = function () {
                    v(a, {left: 0, top: 0});
                    C = a.getBoundingClientRect();
                    v(a, {left: Math.ceil(C.left) - C.left + "px", top: Math.ceil(C.top) - C.top + "px"})
            ...
            definition: function (a) {
                function e(a, f) {
                    ...
                    L(a).forEach(function (a) {
                        var k = q.createElement(a.tagName), l = {};
                        D(a, function (a, e) {
            ...
            truncate: function (a, e, q, f, b, k, l) {
                var d = this, p = a.rotation, C, g = f ? 1 : 0, A = (q || f).length, K = A, c = [], x = function (a) {
                    e.firstChild && e.removeChild(e.firstChild);
                ...
                if (I = b + t > k) {
                    for (; g <= A;) K = Math.ceil((g + A) / 2), f && (C = l(f, K)), t = n(K, C && C.length - 1), g === A ? g = A + 1 : t > k ? A = K - 1 : g = K;
            ...
            buildText: function (a) {
                var q = a.element, f = this, k = f.forExport, b = B(a.textStr,
                    "").toString(), l = -1 !== b.indexOf("\x3c"), d = q.childNodes, p, g = c(q, "x"), C = a.styles,
                    A = a.textWidth, x = C && C.lineHeight, n = C && C.textOutline,
                    t = C && "ellipsis" === C.textOverflow, I = C && "nowrap" === C.whiteSpace, L = C && C.fontSize, z,
                    H, h = d.length, C = A && !a.added && this.box, F = function (a) {
                        var b;
                        ...
                        D(f.escapes, function (q, f) {
                            e && -1 !== e.indexOf(q) || (a = a.toString().replace(new RegExp(q,
                                "g"), f))
                        });
                        return a
                    }, w = function (a, e) {
                ...
                if (z !== a.textCache) {
                    for (a.textCache = z; h--;) q.removeChild(d[h]);
                    l || n || t || A || -1 !== b.indexOf(" ") ? (C && C.appendChild(q), l ? (b = f.styledMode ? b.replace(/<(b|strong)>/g, '\x3cspan class\x3d"highcharts-strong"\x3e').replace(/<(i|em)>/g, '\x3cspan class\x3d"highcharts-emphasized"\x3e') :
                        b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e'), b = b.replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g)) : b = [b], b = b.filter(function (a) {
                        return "" !== a
                        ...
                        l.forEach(function (e) {
                            if ("" !== e || 1 === l.length) {
                                var x = {}, n = m.createElementNS(f.SVG_NS,
                                    "tspan"), D, B;
                                (D = w(e, "class")) && c(n, "class", D);
                                if (D = w(e, "style")) D = D.replace(/(;| |^)color([ :])/, "$1fill$2"), c(n, "style", D);
                                (B = w(e, "href")) && !k && (c(n, "onclick", 'location.href\x3d"' + B + '"'), c(n, "class", "highcharts-anchor"), f.styledMode || v(n, {cursor: "pointer"}));
                                ...
                                if (" " !== e) {
                                    ...
                                    c(n, x);
                                    q.appendChild(n);
                                    !d && H && (!R && k && v(n, {display: "block"}), c(n, "dy", F(n)));
                                    if (A) {
                                        ...
                                        }); else if (x) for (; z.length;) z.length && !I && 0 < B && (n = m.createElementNS(K, "tspan"), c(n, {
                                            dy: h,
                                            x: g
            ...
            button: function (a, e, q, f, b, l, d, g, A) {
                var C = this.label(a, e, q, A, null, null, null, null, "button"), K = 0, n = this.styledMode;
                C.attr(k({padding: 8, r: 2}, b));
                if (!n) {
                    var m, x, c, I;
                    b = k({
                    ...
                    x = l.style;
                    delete l.style;
                    d = k(b, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, d);
                    c = d.style;
                    delete d.style;
                    g = k(b, {style: {color: "#cccccc"}}, g);
                    I = g.style;
                    delete g.style
                }
                ...
                C.setState = function (a) {
                    1 !== a && (C.state = K = a);
                    C.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" +
                        ["normal", "hover", "pressed", "disabled"][a || 0]);
                    n || C.attr([b, l, d, g][a || 0]).css([m, x, c, I][a || 0])
                };
                n || C.attr(b).css(p({cursor: "default"}, m));
            ...
            arc: function (a, e, q, b, f, k) {
                H(a) ? (b = a, e = b.y, q = b.r, a = b.x) : b = {innerR: b, start: f, end: k};
            ...
            rect: function (a, e, q, b, f, k) {
                ...
                a = H(a) ? a : void 0 === a ? {} : {x: a, y: e, width: Math.max(q, 0), height: Math.max(b, 0)};
            ...
            setSize: function (a, e, q) {
                var b = this.alignedObjects, f = b.length;
                this.width = a;
                this.height = e;
                for (this.boxWrapper.animate({width: a, height: e}, {
                    step: function () {
            ...
            image: function (a, e, q, b, f, k) {
                var l = {preserveAspectRatio: "none"}, d, g = function (a, e) {
                ...
                1 < arguments.length && p(l, {x: e, y: q, width: b, height: f});
            ...
            symbol: function (a, e, q, b, f, k) {
                var l = this, d, g = /^url\((.*?)\)$/, A = g.test(a), K = !A && (this.symbols[a] ? a : "circle"),
                    C = K && this.symbols[K], x = n(e) && C && C.call(this.symbols,
                    Math.round(e), Math.round(q), b, f, k), c, t;
                C ? (d = this.path(x), l.styledMode || d.attr("fill", "none"), p(d, {
                    ...
                    width: b,
                    height: f
                }), k && p(d, k)) : A && (c = a.match(g)[1], d = this.image(c), d.imgwidth = B(M[c] && M[c].width, k && k.width), d.imgheight = B(M[c] && M[c].height, k && k.height), t = function () {
                    d.attr({width: d.width, height: d.height})
                }, ["width", "height"].forEach(function (a) {
                    d[a + "Setter"] = function (a, e) {
                        var q = {}, b = this["img" + e], f = "width" === e ? "translateX" : "translateY";
                        this[e] = a;
                        n(b) && (this.element && this.element.setAttribute(e,
                            b), this.alignByTranslate || (q[f] = ((this[e] || 0) - b) / 2, this.attr(q)))
                    }
                }), n(e) && d.attr({
                    x: e,
                    y: q
                }), d.isImg = !0, n(d.imgwidth) && n(d.imgheight) ? t() : (d.attr({width: 0, height: 0}), w("img", {
                    onload: function () {
                        var a = r[l.chartIndex];
                        0 === this.width && (v(this, {position: "absolute", top: "-999em"}), m.body.appendChild(this));
            ...
            symbols: {
                circle: function (a, e, q, b) {
                    ...
                    var k = Math.min(f && f.r || 0, q, b), d = k + 6, l = f && f.anchorX;
                    f = f && f.anchorY;
                    var p;
                    p = ["M", a + k, e, "L", a + q - k, e, "C", a + q, e, a + q, e, a + q, e + k, "L", a + q, e + b - k, "C", a + q, e + b, a + q, e + b, a + q - k, e + b, "L", a + k, e + b, "C", a, e +
                    b, a, e + b, a, e + b - k, "L", a, e + k, "C", a, e, a, e, a + k, e];
            ...
            clipRect: function (e, q, b, f) {
                var k = a.uniqueKey(), l = this.createElement("clipPath").attr({id: k}).add(this.defs);
            ...
            text: function (a, e, q, b) {
                ...
                b || (a.xSetter = function (a, e, q) {
                    var b = q.getElementsByTagName("tspan"), f, k = q.getAttribute(e), l;
                    for (l = 0; l < b.length; l++) f = b[l], f.getAttribute(e) === k && f.setAttribute(e, a);
                    q.setAttribute(e, a)
                });
                return a
            },
            fontMetrics: function (a, q) {
                a = this.styledMode ?
                    q && y.prototype.getStyle.call(q, "font-size") : a || q && q.style && q.style.fontSize || this.style && this.style.fontSize;
            ...
            rotCorr: function (a, e, q) {
                var b = a;
                e && q && (b = Math.max(b * Math.cos(e * g), 4));
                return {x: -a / 3 * Math.sin(e * g), y: b}
            },
            label: function (e, b, f, l, d, g, A, K, c) {
                var m = this, x = m.styledMode, t = m.g("button" !== c && "label"),
                    I = t.text = m.text("", 0, 0, A).attr({zIndex: 1}),
                    D, L, C = 0, B = 3, z = 0, H, h, F, M, R, w = {}, r, u, S = /^url\((.*?)\)$/.test(l), v = x || S,
                    N = function () {
                        return x ? D.strokeWidth() % 2 / 2 : (r ? parseInt(r, 10) : 0) % 2 / 2
                    }, P, T, E;
                c && t.addClass("highcharts-" + c);
                P = function () {
                    var a = I.element.style, e = {};
                    ...
                    v && (D || (t.box = D = m.symbols[l] || S ? m.symbol(l) : m.rect(), D.addClass(("button" === c ? "" : "highcharts-label-box") +
                        (c ? " highcharts-" + c + "-box" : "")), D.add(t), a = N(), e.x = a, e.y = (K ? -u : 0) + a), e.width = Math.round(t.width), e.height = Math.round(t.height), D.attr(p(e, w)), w = {})
                };
                T = function () {
                    var a = z + B, e;
                    e = K ? 0 : u;
                    n(H) && L && ("center" === R || "right" === R) && (a += {center: .5, right: 1}[R] * (H - L.width));
                ...
                A = {
                    css: function (a) {
                        ...
                        return {width: L.width + 2 * B, height: L.height + 2 * B, x: L.x - B, y: L.y - B}
                    }, destroy: function () {
    ...
    (function (a) {
        var y = a.attr, G = a.createElement, E = a.css, h = a.defined, c =
                a.extend, r = a.isFirefox, u = a.isMS, v = a.isWebKit, w = a.pick, n = a.pInt, g = a.SVGRenderer, d = a.win,
            m = a.wrap;
        c(a.SVGElement.prototype, {
            htmlCss: function (a) {
                var b = "SPAN" === this.element.tagName && a && "width" in a, l = w(b && a.width, void 0), f;
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, l = this.translateX || 0, f = this.translateY || 0,
                        d = this.x || 0, g = this.y || 0, m = this.textAlign || "left",
                        c = {left: 0, center: .5, right: 1}[m], z = this.styles, k = z && z.whiteSpace;
                    E(b, {marginLeft: l, marginTop: f});
                    !a.styledMode && this.shadows && this.shadows.forEach(function (a) {
                        E(a, {marginLeft: l + 1, marginTop: f + 1})
                    });
                    ...
                    if ("SPAN" === b.tagName) {
                        var z =
                                this.rotation, A = this.textWidth && n(this.textWidth),
                            D = [z, m, b.innerHTML, this.textWidth, this.textAlign].join(), B;
                        ...
                        D !== this.cTT && (k = a.fontMetrics(b.style.fontSize,
                            b).b, !h(z) || z === (this.oldRotation || 0) && m === this.oldAlign || this.setSpanRotation(z, c, k), this.getSpanCorrection(!h(z) && this.textPxLength || b.offsetWidth, k, c, z, m));
                        E(b, {left: d + (this.xCorr || 0) + "px", top: g + (this.yCorr || 0) + "px"});
                        this.cTT = D;
                        this.oldRotation = z;
                        this.oldAlign = m
                    }
        ...
        c(g.prototype, {
            getTransformKey: function () {
                ...
                var f = this.createElement("span"), g = f.element, p = f.renderer, n = p.isSVG, h = function (a, b) {
                    ...
                    a.addedSetters = !0
                }, z = a.charts[p.chartIndex], z = z && z.styledMode;
                ...
                f.attr({text: d, x: Math.round(b), y: Math.round(l)}).css({position: "absolute"});
                z || f.css({fontFamily: this.style.fontFamily, fontSize: this.style.fontSize});
                g.style.whiteSpace = "nowrap";
                f.css =
                    f.htmlCss;
                n && (f.add = function (a) {
                    var b, l = p.box.parentNode, k = [];
                            ...
                            k.reverse().forEach(function (a) {
                                ...
                                c(a, {
                                    classSetter: function (a) {
                                        ...
                                        k[0].div && f.on.apply({element: k[0].div}, arguments);
                                        return a
    ...
    (function (a) {
        var y = a.defined, G = a.extend, E = a.merge, h = a.pick, c = a.timeUnits, r = a.win;
        a.Time = function (a) {
            this.update(a, !1)
        };
        a.Time.prototype = {
            ...
            update: function (a) {
                ...
                (this.variableTimezone = !(c && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function (a, g) {
                    var d = g.getTime(), m = d - w.getTimezoneOffset(g);
                    g.setTime(m);
                    a = g["getUTC" + a]();
                    g.setTime(d);
                    return a
                    ...
                    var m;
                    if ("Milliseconds" === a || "Seconds" === a || "Minutes" ===
                        a && 0 === g.getTimezoneOffset() % 60) g["set" + a](d); else m = w.getTimezoneOffset(g), m = g.getTime() - m, g.setTime(m), g["setUTC" + a](d), a = w.getTimezoneOffset(g), m = g.getTime() + a, g.setTime(m)
                ...
                var m, p, b;
                this.useUTC ? (m = this.Date.UTC.apply(0, arguments), p = this.getTimezoneOffset(m), m += p, b = this.getTimezoneOffset(m),
                    p !== b ? m += b - p : p - 36E5 !== this.getTimezoneOffset(m - 36E5) || a.isSafari || (m -= 36E5)) : m = (new this.Date(c, r, h(w, 1), h(n, 0), h(g, 0), h(d, 0))).getTime();
                return m
            }, timezoneOffsetFunction: function () {
                var c = this, h = this.options, w = r.moment;
                ...
                var n = this, g = new this.Date(h), d = this.get("Hours", g), m = this.get("Day", g),
                    p = this.get("Date", g), b = this.get("Month", g), l = this.get("FullYear", g),
                    f = a.defaultOptions.lang, x = f.weekdays, t = f.shortWeekdays, H = a.pad, g = a.extend({
                ...
                a.objectEach(g, function (a, b) {
                    for (; -1 !== c.indexOf("%" + b);) c = c.replace("%" + b, "function" === typeof a ? a.call(n, h) : a)
                });
                ...
                if (y(r)) {
                    ...
                    l >= c.month && (g.set("Month", m, l >= c.year ? 0 : f * Math.floor(g.get("Month",
                        m) / f)), b = g.get("FullYear", m));
                    l >= c.year && g.set("FullYear", m, b - b % f);
                    l === c.week && (b = g.get("Day", m), g.set("Date", m, g.get("Date", m) - b + n + (b < n ? -7 : 0)));
                    b = g.get("FullYear", m);
                    n = g.get("Month", m);
                    var t = g.get("Date", m), H = g.get("Hours", m);
                    r = m.getTime();
                    g.variableTimezone && (x = w - r > 4 * c.month || g.getTimezoneOffset(r) !== g.getTimezoneOffset(w));
                    r = m.getTime();
                    for (m = 1; r < w;) d.push(r), r = l === c.year ? g.makeTime(b + m * f, 0) : l === c.month ? g.makeTime(b, n + m * f) : !x || l !== c.day && l !== c.week ? x && l === c.hour && 1 < f ? g.makeTime(b, n, t, H + m * f) : r +
                ...
                d.info = G(a, {higherRanks: p, totalRange: l * f});
                return d
            }
        }
    })(J);
    (function (a) {
        var y = a.color, G = a.merge;
        a.defaultOptions = {
        ...
        a.setOptions = function (y) {
            ...
            a.time.update(G(a.defaultOptions.global, a.defaultOptions.time),
                !1);
    ...
    (function (a) {
        var y = a.correctFloat, G = a.defined, E = a.destroyObjectProperties, h = a.fireEvent, c = a.isNumber,
            r = a.merge, u = a.pick, v = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var c = this, n = c.axis, g = n.options, d = n.chart, m = n.categories, p = n.names, b = c.pos,
                    l = u(c.options && c.options.labels, g.labels), f = n.tickPositions, x = b === f[0],
                    t = b === f[f.length - 1], m = this.parameters.category || (m ? u(m[b], p[b], b) : b), h = c.label,
                    f = f.info, F, z, k, A;
                n.isDatetimeAxis && f && (z = d.time.resolveDTLFormat(g.dateTimeLabelFormats[!g.grid && f.higherRanks[b] || f.unitName]),
                    F = z.main);
                c.isFirst = x;
                c.isLast = t;
                c.formatCtx = {
                ...
                if (A = z && z.list) c.shortenLabel = function () {
                    for (k = 0; k < A.length; k++) if (h.attr({text: n.labelFormatter.call(a.extend(c.formatCtx, {dateTimeLabelFormat: A[k]}))}), h.getBBox().width < n.getSlotWidth(c) - 2 * u(l.padding, 5)) return;
                    h.attr({text: ""})
                };
                if (G(h)) h && h.textStr !== g && (!h.textWidth || l.style && l.style.width ||
                h.styles.width || h.css({width: null}), h.attr({text: g})); else {
                ...
                var c = this.axis, g = c.options.labels, d = a.x, m = c.chart.chartWidth, p = c.chart.spacing,
                    b = u(c.labelLeft, Math.min(c.pos, p[3])), p = u(c.labelRight, Math.max(c.isRadial ?
                    0 : c.pos + c.len, m - p[1])), l = this.label, f = this.rotation,
                    x = {left: 0, center: .5, right: 1}[c.labelAlign || l.attr("align")], t = l.getBBox().width,
                    h = c.getSlotWidth(this), F = h, z = 1, k, A = {};
                ...
                var m = this.axis, p = m.chart, b = d && p.oldChartHeight || p.chartHeight;
                c = {
                ...
                h(this, "afterGetPosition", {pos: c});
                return c
            }, getLabelPosition: function (a, c, g, d, m, p, b, l) {
                var f = this.axis, x = f.transA, t = f.reversed, n = f.staggerLines, F = f.tickRotCorr || {x: 0, y: 0},
                    z = m.y, k = d || f.reserveSpaceDefault ? 0 : -f.labelOffset * ("center" === f.labelAlign ? .5 : 1),
                    A = {};
                ...
                A.y = Math.round(c);
                h(this,
                    "afterGetLabelPosition", {pos: A});
                return A
            }, getMarkPath: function (a, c, g, d, m, p) {
                return p.crispLine(["M", a, c, "L", a + (m ? 0 : -g), c + (m ? g : 0)], d)
            }, renderGridLine: function (a, c, g) {
                var d = this.axis, m = d.options, p = this.gridLine, b = {}, l = this.pos, f = this.type,
                    x = u(this.tickmarkOffset, d.tickmarkOffset), t = d.chart.renderer, n = f ? f + "Grid" : "grid",
                    h = m[n + "LineWidth"], z = m[n + "LineColor"], m = m[n + "LineDashStyle"];
                p || (d.chart.styledMode || (b.stroke = z, b["stroke-width"] = h, m && (b.dashstyle = m)), f || (b.zIndex = 1), a && (c = 0), this.gridLine = p = t.path().attr(b).addClass("highcharts-" +
                    (f ? f + "-" : "") + "grid-line").add(d.gridGroup));
                if (p && (g = d.getPlotLinePath(l + x, p.strokeWidth() * g, a, "pass"))) p[a || this.isNew ? "attr" : "animate"]({
                    d: g,
                    opacity: c
                })
            }, renderMark: function (a, c, g) {
                var d = this.axis, m = d.options, p = d.chart.renderer, b = this.type, l = b ? b + "Tick" : "tick",
                    f = d.tickSize(l), x = this.mark, t = !x, n = a.x;
                a = a.y;
                var h = u(m[l + "Width"], !b && d.isXAxis ? 1 : 0), m = m[l + "Color"];
                ...
                var m = this.axis, p = m.horiz, b = m.options, l = this.label, f = b.labels, x = f.step,
                    m = u(this.tickmarkOffset, m.tickmarkOffset), t = !0, h = a.x;
                a = a.y;
                l && c(h) && (l.xy = a = this.getLabelPosition(h, a, l, p, f, m, d, x), this.isFirst && !this.isLast && !u(b.showFirstLabel, 1) || this.isLast && !this.isFirst && !u(b.showLastLabel, 1) ? t = !1 : !p || f.step || f.rotation || n || 0 === g || this.handleOverflow(a), x && d % x &&
                (t = !1), t && c(a.y) ? (a.opacity = g, l[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (l.attr("y", -9999), this.isNewLabel = !0))
            }, render: function (c, n, g) {
                var d = this.axis, m = d.horiz, p = this.pos, b = u(this.tickmarkOffset, d.tickmarkOffset),
                    p = this.getPosition(m, p, b, n), b = p.x, l = p.y,
    ...
    var V = function (a) {
        var y = a.addEvent, G = a.animObject, E = a.arrayMax, h = a.arrayMin, c = a.color, r = a.correctFloat,
            u = a.defaultOptions, v = a.defined, w = a.deg2rad, n = a.destroyObjectProperties, g = a.extend,
            d = a.fireEvent, m = a.format, p = a.getMagnitude, b = a.isArray, l = a.isNumber, f = a.isString,
            x = a.merge, t = a.normalizeTickInterval, H = a.objectEach, F = a.pick, z = a.removeEvent, k = a.splat,
            A = a.syncTimeout, D = a.Tick, B = function () {
                this.init.apply(this, arguments)
            };
        a.extend(B.prototype, {
            ...
            init: function (a, q) {
                ...
                d(this, "init", {userOptions: q});
                b.opposite =
                    q.opposite;
                b.side = q.side || (b.horiz ? b.opposite ? 0 : 2 : b.opposite ? 1 : 3);
                b.setOptions(q);
                var f = this.options, l = f.type;
            ...
            defaultLabelFormatter: function () {
                var e = this.axis, q = this.value, b = e.chart.time, f = e.categories, l = this.dateTimeLabelFormat,
                    k = u.lang, d = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, g = d && d.length, c,
                    p = e.options.labels.format, e = e.isLog ? Math.abs(q) : e.tickInterval;
                if (p) c = m(p, this, b); else if (f) c = q; else if (l) c = b.dateFormat(l, q); else if (g && 1E3 <= e) for (; g-- && void 0 === c;) b = Math.pow(k, g + 1), e >= b && 0 === 10 * q % b && null !== d[g] && 0 !== q && (c = a.numberFormat(q / b, -1) + d[g]);
                void 0 === c && (c = 1E4 <= Math.abs(q) ? a.numberFormat(q, -1) :
                ...
                d(this, "getSeriesExtremes", null, function () {
                    ...
                    a.series.forEach(function (e) {
                        if (e.visible || !q.options.chart.ignoreHiddenSeries) {
                            var b = e.options, f = b.threshold, k;
                            a.hasVisibleSeries = !0;
                            a.positiveValuesOnly && 0 >= f && (f = null);
                            if (a.isXAxis) b = e.xData, b.length && (e = h(b), k = E(b), l(e) || e instanceof Date || (b = b.filter(l),
                                e = h(b), k = E(b)), b.length && (a.dataMin = Math.min(F(a.dataMin, b[0], e), e), a.dataMax = Math.max(F(a.dataMax, b[0], k), k))); else if (e.getExtremes(), k = e.dataMax, e = e.dataMin, v(e) && v(k) && (a.dataMin = Math.min(F(a.dataMin, e), e), a.dataMax = Math.max(F(a.dataMax, k), k)), v(f) && (a.threshold = f), !b.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
                        }
                    })
                });
            ...
            translate: function (a, q, b, f, k, d) {
                var e = this.linkedParent || this, c = 1, g = 0, p = f ? e.oldTransA : e.transA;
                f = f ? e.oldMin : e.min;
            ...
            getPlotLinePath: function (a, q, b, f, k) {
                var e = this.chart, d = this.left, c = this.top, g, p, A = b &&
                    e.oldChartHeight || e.chartHeight, t = b && e.oldChartWidth || e.chartWidth, m;
                g = this.transB;
                var x = function (a, e, q) {
            ...
            getMinorTickPositions: function () {
                var a = this, q = a.options, b = a.tickPositions, f = a.minorTickInterval, k = [],
                    d = a.pointRangePadding || 0, l = a.min - d, d = a.max + d, g = d - l;
                if (g && g / f < a.len / 3) if (a.isLog) this.paddedTicks.forEach(function (e,
                                                                                            q, b) {
                    q && k.push.apply(k, a.getLogTickPositions(f, b[q - 1], b[q], !0))
                }); else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) k = k.concat(a.getTimeTicks(a.normalizeTimeTickInterval(f), l, d, q.startOfWeek)); else for (q = l + (b[0] - l) % f; q <= d && q !== k[0]; q += f) k.push(q);
                0 !== k.length && a.trimTicks(k);
                return k
            },
            adjustForMinRange: function () {
                var a = this.options, q = this.min, b = this.max, f, k, d, l, g, c, p, A;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (v(a.min) || v(a.max) ? this.minRange = null : (this.series.forEach(function (a) {
                    c =
                        a.xData;
                    for (l = p = a.xIncrement ? 1 : c.length - 1; 0 < l; l--) if (g = c[l] - c[l - 1], void 0 === d || g < d) d = g
            ...
            getClosest: function () {
                ...
                this.categories ? a = 1 : this.series.forEach(function (e) {
                    var q = e.closestPointRange, b = e.visible || !e.chart.options.chart.ignoreHiddenSeries;
                    !e.noSharedTooltip && v(q) && b && (a = v(a) ? Math.min(a, q) : q)
                });
                return a
            },
            nameToX: function (a) {
                var e = b(this.categories), f = e ? this.categories : this.names, k = a.options.x, d;
                a.series.requireSorting = !1;
                v(k) || (k = !1 === this.options.uniqueNames ? a.series.autoIncrement() : e ? f.indexOf(a.name) : F(f.keys[a.name], -1));
                -1 === k ? e || (d = f.length) : d = k;
                void 0 !== d && (this.names[d] = a.name, this.names.keys[a.name] =
                    d);
                return d
            },
            ...
            setAxisTranslation: function (a) {
                var e =
                        this, b = e.max - e.min, k = e.axisPointRange || 0, l, g = 0, c = 0, p = e.linkedParent,
                    A = !!e.categories, t = e.transA, m = e.isXAxis;
                ...
                }), p = e.ordinalSlope && l ? e.ordinalSlope / l : 1, e.minPointOffset = g *= p, e.pointRangePadding = c *= p, e.pointRange = Math.min(k, b), m && (e.closestPointRange =
                    l);
                a && (e.oldTransA = t);
            ...
            setTickInterval: function (e) {
                var b = this, f = b.chart, k = b.options, g = b.isLog, c = b.isDatetimeAxis, A = b.isXAxis,
                    m = b.isLinked, x = k.maxPadding, n = k.minPadding, D, h = k.tickInterval, B = k.tickPixelInterval,
                    z = b.categories, H = l(b.threshold) ? b.threshold : null, w = b.softThreshold, u, y, E;
                ...
                b.range && v(b.max) && (b.userMin = b.min =
                    y = Math.max(b.dataMin, b.minFromRange()), b.userMax = E = b.max, b.range = null);
                d(b, "foundExtremes");
                ...
                l(k.ceiling) && (b.max = Math.max(Math.min(b.max,
                    k.ceiling), F(b.userMax, -Number.MAX_VALUE)));
            ...
            setTickPositions: function () {
                var e = this.options, b, f = e.tickPositions;
                b = this.getMinorTickInterval();
                var k = e.tickPositioner, l = e.startOnTick, g = e.endOnTick;
                ...
                !b && (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200) ? (b = [this.min, this.max], a.error(19, !1, this.chart)) : b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, e.units), this.min, this.max, e.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b[0],
                    b.pop()], b[0] === b[1] && (b.length = 1)), this.tickPositions = b, k && (k = k.apply(this, [this.min, this.max]))) && (this.tickPositions = b = k);
            ...
            trimTicks: function (a, b, f) {
                var e = a[0], k = a[a.length - 1], q = this.minPointOffset || 0;
                if (!this.isLinked) {
                    if (b && -Infinity !== e) this.min = e; else for (; this.min - q > a[0];) a.shift();
                    if (f) this.max = k; else for (; this.max +
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === f.alignTicks || !1 === f.startOnTick || !1 === f.endOnTick || this.isLog || this.chart[this.coll].forEach(function (e) {
                    var f = e.options, f = [e.horiz ? f.left : f.top, f.width, f.height, f.pane].join();
            ...
            getTickAmount: function () {
                ...
                !v(a.tickInterval) &&
                this.len < f && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2);
                !b && this.alignToOthers() && (b = Math.ceil(this.len / f) + 1);
                4 > b && (this.finalTickAmt = b, b = 5);
                this.tickAmount = b
            },
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, f = this.tickAmount, k = this.finalTickAmt,
                    d = b && b.length, l = F(this.threshold, this.softThreshold ? 0 : null);
                if (this.hasData()) {
                    if (d < f) {
                        for (; b.length < f;) b.length % 2 || this.min === l ? b.push(r(b[b.length - 1] + a)) : b.unshift(r(b[0] - a));
                        this.transA *= (d - 1) / (f - 1);
                        this.min =
                            b[0];
            ...
            setScale: function () {
                ...
                this.oldUserMax || this.alignToOthers() ? (this.resetStacks && this.resetStacks(), this.forceRedraw = !1, this.getSeriesExtremes(), this.setTickInterval(), this.oldUserMin = this.userMin, this.oldUserMax = this.userMax, this.isDirty || (this.isDirty = b || this.min !== this.oldMin || this.max !== this.oldMax)) : this.cleanStacks && this.cleanStacks();
                d(this, "afterSetScale")
            },
            setExtremes: function (a, b, f, k, l) {
                var e = this, q = e.chart;
                f = F(f, !0);
            ...
            zoom: function (a, b) {
                var e = this.dataMin, f = this.dataMax, k = this.options, d = Math.min(e, F(k.min, e)),
                    k = Math.max(f, F(k.max, f));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (v(e) && (a < d && (a = d), a > k && (a = k)), v(f) && (b < d && (b = d), b > k && (b = k))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var e = this.chart, b = this.options, f = b.offsets || [0, 0, 0, 0], k = this.horiz,
                    d = this.width = Math.round(a.relativeLength(F(b.width,
                        e.plotWidth - f[3] + f[1]), e.plotWidth)),
            ...
            getThreshold: function (a) {
                var e = this.isLog, b = e ? this.lin2log(this.min) : this.min,
            ...
            tickSize: function (a) {
                var e = this.options, b = e[a + "Length"],
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz, f = this.tickInterval, k = f,
                    d = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / f), l, g = a.rotation,
                    c = this.labelMetrics(), p, A = Number.MAX_VALUE,
                    t, m = function (a) {
                        a /= d || 1;
                        a = 1 < a ? Math.ceil(a) : 1;
                        return r(a * f)
            ...
            getSlotWidth: function (a) {
                var b = this.chart, e = this.horiz, f = this.options.labels,
                    k = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), d = b.margin[3];
            ...
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, k = this.tickPositions, d = this.ticks, l = this.options.labels,
                    g = l && l.style || {}, c = this.horiz, p = this.getSlotWidth(),
                    A = Math.max(1, Math.round(p - 2 * (l.padding || 5))), t = {}, m = this.labelMetrics(),
                    x = l.style && l.style.textOverflow, n, D, h = 0, B;
                ...
                if (this.autoRotation) h > A && h > m.h ? t.rotation = this.labelRotation : this.labelRotation = 0; else if (p && (n = A, !x)) for (D = "clip", A = k.length; !c && A--;) if (B = k[A], B = d[B].label) B.styles && "ellipsis" === B.styles.textOverflow ? B.css({textOverflow: "clip"}) : B.textPxLength > p && B.css({width: p + "px"}), B.getBBox().height > this.len / k.length - (m.h - m.f) && (B.specificTextOverflow = "ellipsis");
                t.rotation && (n = h > .5 * a.chartHeight ? .33 * a.chartHeight : h, x ||
                (D = "ellipsis"));
                if (this.labelAlign = l.align || this.autoLabelAlign(this.labelRotation)) t.align = this.labelAlign;
                k.forEach(function (a) {
                    var b = (a = d[a]) && a.label, e = g.width, f = {};
                    b && (b.attr(t), a.shortenLabel ? a.shortenLabel() : n && !e && "nowrap" !== g.whiteSpace && (n < b.textPxLength || "SPAN" === b.element.tagName) ? (f.width = n, x || (f.textOverflow = b.specificTextOverflow || D), b.css(f)) : b.styles && b.styles.width && !f.width && !e && b.css({width: null}), delete b.specificTextOverflow, a.rotation = t.rotation)
                }, this);
                this.tickRotCorr = b.rotCorr(m.b,
            ...
            addTitle: function (a) {
                var b = this.chart.renderer, e = this.horiz, f = this.opposite, k = this.options.title, d,
            ...
            getOffset: function () {
                var a = this, b = a.chart, f = b.renderer, k = a.options, l = a.tickPositions, g = a.ticks, c = a.horiz,
                    p = a.side, A = b.inverted && !a.isZAxis ? [1, 0, 3, 2][p] : p, t, m, x = 0, n, D = 0, h = k.title,
                    B = k.labels, z = 0, r = b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][p], u = k.className,
                    y = a.axisParent;
                t = a.hasData();
                a.showAxis = m = t || F(k.showEmpty, !0);
                a.staggerLines = a.horiz && B.staggerLines;
                a.axisGroup || (a.gridGroup = f.g("grid").attr({zIndex: k.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (u || "")).add(y), a.axisGroup = f.g("axis").attr({zIndex: k.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (u || "")).add(y), a.labelGroup = f.g("axis-labels").attr({zIndex: B.zIndex || 7}).addClass("highcharts-" +
                    a.coll.toLowerCase() + "-labels " + (u || "")).add(y));
                ...
                h && h.text && !1 !== h.enabled && (a.addTitle(m), m && !1 !== h.reserveSpace &&
                (a.titleOffset = x = a.axisTitle.getBBox()[c ? "height" : "width"], n = h.offset, D = v(n) ? 0 : F(h.margin, c ? 5 : 10)));
                a.renderLine();
                ...
                r[p] = Math.max(r[p], a.axisTitleMargin + x + w * a.offset, D, t && l.length && c ? c[0] + w * a.offset :
                    0);
            ...
            getLinePath: function (a) {
                var b = this.chart, e = this.opposite, f = this.offset, k = this.horiz,
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, f = this.top, k = this.len, d = this.options.title, l = a ? b : f,
                    g = this.opposite, c = this.offset, p = d.x || 0, A = d.y || 0, t = this.axisTitle,
                    m = this.chart.renderer.fontMetrics(d.style && d.style.fontSize, t),
                    t = Math.max(t.getBBox(null, 0).height - m.h - 1, 0),
                    k = {low: l + (a ? 0 : k), middle: l + k / 2, high: l + (a ? k : 0)}[d.align],
                    b = (a ? f + this.height : b) + (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin +
                        [-t, t, m.f, -t][this.side];
                return {
            ...
            renderMinorTick: function (a) {
                var b = this.chart.hasRendered && l(this.oldMin), e = this.minorTicks;
                e[a] || (e[a] = new D(this, a, "minor"));
                b && e[a].isNew && e[a].render(null, !0);
                e[a].render(null, !1, 1)
            },
            renderTick: function (a, b) {
                var e = this.isLinked, f = this.ticks, k = this.chart.hasRendered && l(this.oldMin);
                if (!e || a >= this.min && a <= this.max) f[a] || (f[a] = new D(this, a)), k && f[a].isNew && f[a].render(b, !0, -1), f[a].render(b)
            },
            render: function () {
                var b =
                        this, f = b.chart, k = b.options, g = b.isLog, c = b.isLinked, p = b.tickPositions, t = b.axisTitle,
                    m = b.ticks, x = b.minorTicks, n = b.alternateBands, h = k.stackLabels, B = k.alternateGridColor,
                    z = b.tickmarkOffset, F = b.axisLine, r = b.showAxis, w = G(f.renderer.globalAnimation), u, v;
                ...
                F && (F[F.isPlaced ? "animate" : "attr"]({d: this.getLinePath(F.strokeWidth())}), F.isPlaced = !0, F[r ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var b = this, e = b.stacks, f = b.plotLinesAndBands, k;
            ...
            drawCrosshair: function (a, b) {
                var e, f = this.crosshair, k = F(f.snap, !0), l, g = this.cross;
                ...
                if (this.crosshair && !1 !== (v(b) || !k)) {
                    ...
                    g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (k ? "category " : "thin ") + f.className).attr({zIndex: F(f.zIndex, 2)}).add(), this.chart.styledMode || (g.attr({
                    ...
                    g.show().attr({d: e});
                    k && !f.width && g.attr({"stroke-width": this.transA});
                    this.cross.e = a
    ...
    (function (a) {
        var y = a.Axis, G = a.getMagnitude, E = a.normalizeTickInterval, h = a.timeUnits;
        y.prototype.getTimeTicks = function () {
            return this.chart.time.getTimeTicks.apply(this.chart.time, arguments)
        };
        y.prototype.normalizeTimeTickInterval = function (a,
                                                          r) {
            ...
            return {unitRange: v, count: a, unitName: r[0]}
        }
    })(J);
    (function (a) {
        var y = a.Axis, G = a.getMagnitude,
            E = a.normalizeTickInterval, h = a.pick;
        y.prototype.getLogTickPositions = function (a, r, u, v) {
            var c = this.options, n = this.len, g = [];
            v || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), g = this.getLinearTickPositions(a, r, u); else if (.08 <= a) for (var n = Math.floor(r), d, m, p, b, l, c = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; n < u + 1 && !l; n++) for (m = c.length, d = 0; d < m && !l; d++) p = this.log2lin(this.lin2log(n) * c[d]), p > r && (!v || b <= u) && void 0 !== b && g.push(b), b > u && (l = !0), b = p; else r = this.lin2log(r), u = this.lin2log(u), a = v ? this.getMinorTickInterval() :
                c.tickInterval, a = h("auto" === a ? null : a, this._minorAutoInterval, c.tickPixelInterval / (v ? 5 : 1) * (u - r) / ((v ? n / this.tickPositions.length : n) || 1)), a = E(a, null, G(a)), g = this.getLinearTickPositions(a, r, u).map(this.log2lin), v || (this._minorAutoInterval = a / 5);
    ...
    (function (a, y) {
        var G = a.arrayMax, E = a.arrayMin, h = a.defined, c = a.destroyObjectProperties, r = a.erase, u = a.merge,
            v = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                var c = this, n = c.axis, g = n.horiz, d = c.options, m = d.label, p = c.label, b = d.to, l = d.from,
                    f = d.value, x = h(l) && h(b), t = h(f), H = c.svgElem, F = !H, z = [], k = d.color,
                    A = v(d.zIndex, 0), D = d.events,
                    z = {"class": "highcharts-plot-" + (x ? "band " : "line ") + (d.className || "")}, B = {},
                    e = n.chart.renderer, q = x ? "bands" : "lines";
                n.isLog && (l = n.log2lin(l), b = n.log2lin(b), f = n.log2lin(f));
                n.chart.styledMode ||
                (t ? (z.stroke = k, z["stroke-width"] = d.width, d.dashStyle && (z.dashstyle = d.dashStyle)) : x && (k && (z.fill = k), d.borderWidth && (z.stroke = d.borderColor, z["stroke-width"] = d.borderWidth)));
                B.zIndex = A;
                q += "-" + A;
                ...
                F && z && z.length ? (H.attr({d: z}), D && a.objectEach(D, function (a, b) {
                    H.on(b, function (a) {
                        D[b].apply(c,
                            [a])
                    })
                })) : H && (z ? (H.show(), H.animate({d: z})) : (H.hide(), p && (c.label = p = p.destroy())));
                ...
                var m = this.label, p = this.axis.chart.renderer;
                m || (m = {
                ...
                g = E(d);
                p = E(c);
                m.align(a, !1, {x: g, y: p, width: G(d) - g, height: G(c) - p});
                m.show()
            }, destroy: function () {
        ...
        a.extend(y.prototype, {
            getPlotBandPath: function (a, c) {
                var g = this.getPlotLinePath(c, null, null, !0), d = this.getPlotLinePath(a, null, null, !0), m = [],
                    p = this.horiz, b =
                        1, l;
                a = a < this.min && c < this.min || a > this.max && c > this.max;
                if (d && g) for (a && (l = d.toString() === g.toString(), b = 0), a = 0; a < d.length; a += 6) p && g[a + 1] === d[a + 1] ? (g[a + 1] += b, g[a + 4] += b) : p || g[a + 2] !== d[a + 2] || (g[a + 2] += b, g[a + 5] += b), m.push("M", d[a + 1], d[a + 2], "L", d[a + 4], d[a + 5], g[a + 4], g[a + 5], g[a + 1], g[a + 2], "z"), m.isFlat = l;
                return m
                ...
                var g = (new a.PlotLineOrBand(this,
                    c)).render(), d = this.userOptions;
                g && (n && (d[n] = d[n] || [], d[n].push(c)), this.plotLinesAndBands.push(g));
                return g
            }, removePlotBandOrLine: function (a) {
                for (var c = this.plotLinesAndBands, g = this.options, d = this.userOptions, m = c.length; m--;) c[m].id === a && c[m].destroy();
                [g.plotLines || [], d.plotLines || [], g.plotBands || [], d.plotBands || []].forEach(function (d) {
                    for (m = d.length; m--;) d[m].id === a && r(d, d[m])
                })
        ...
        V);
    (function (a) {
        var y = a.doc, G = a.extend, E = a.format, h = a.isNumber, c = a.merge, r = a.pick, u = a.splat,
        ...
        a.Tooltip.prototype = {
            init: function (a, c) {
                ...
                a.renderer.definition({
                    tagName: "style", textContent: ".highcharts-tooltip-" + a.index +
                    "{filter:url(#drop-shadow-" + a.index + ")}"
                })
            }, getLabel: function () {
                var c = this.chart.renderer, g = this.chart.styledMode, d = this.options, m;
                ...
                }), a.doc.body.appendChild(m), this.renderer = c = new a.Renderer(m, 0, 0)), this.split ? this.label = c.g("tooltip") : (this.label = c.label("", 0, 0, d.shape || "callout", null, null, d.useHTML, null,
                    "tooltip").attr({
                    padding: d.padding,
                    r: d.borderRadius
                }), g || this.label.attr({
                ...
                var p = this, b = p.now,
                    l = !1 !== p.options.animation && !p.isHidden && (1 < Math.abs(c - b.x) || 1 < Math.abs(g -
                        b.y)), f = p.followPointer || 1 < p.len;
                G(b, {
                    x: l ? (2 * b.x + c) / 3 : c,
                    y: l ? (b.y + g) / 2 : g,
                ...
                var d =
                    this.chart, g = d.pointer, p = d.inverted, b = d.plotTop, l = d.plotLeft, f = 0, x = 0, t, h;
                a = u(a);
                ...
                return a.map(Math.round)
                                      ...
                                      c, d) {
                var g = this.chart, p = this.distance, b = {}, l = g.inverted && d.h || 0, f, x = this.outside,
                    ...
                    A = !this.followPointer &&
                        r(d.ttBelow, !g.inverted === !!d.negative), D = function (a, e, f, k, d, c) {
                        var g = f < k - p, q = k + p + f < e, t = k - p - f;
                        k += p;
                ...
                var d, m = this.options, p, b = c, l, f = {}, x = [];
                d = m.formatter || this.defaultFormatter;
                var f = this.shared, t, h = this.chart.styledMode;
                ...
                var d = this, m = [], p = this.chart, b = p.renderer, l = !0, f = this.options, x = 0, t,
                    h = this.getLabel(), n = p.plotTop;
                a.isString(c) && (c = [!1, c]);
                c.slice(0, g.length + 1).forEach(function (a, k) {
                    if (!1 !== a && "" !== a) {
                        k = g[k - 1] || {isHeader: !0, plotX: g[0].plotX, plotY: p.plotHeight};
                        var c = k.series || d, D = c.tt, B = k.series || {},
                        ...
                        k.isHeader ? (x = a.height, p.xAxis[0].opposite && (t = !0, n -= x), B =
                            Math.max(0, Math.min(k.plotX + p.plotLeft - B / 2, p.chartWidth + (p.scrollablePixels ? p.scrollablePixels - p.marginRight : 0) - B))) : B = k.plotX + p.plotLeft - r(f.distance, 16) - B;
                        0 > B && (l = !1);
                ...
                var c = this.chart, d = this.getLabel(),
                    m = (this.options.positioner || this.getPosition).call(this, d.width, d.height,
                        a), p = a.plotX + c.plotLeft;
                a = a.plotY + c.plotTop;
                var b;
                ...
                var g = this.chart.time, b = g.dateFormat("%m-%d %H:%M:%S.%L", c), l, f,
                    x = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, t = "millisecond";
                for (f in w) {
                    if (a === w.week && +g.dateFormat("%w", c) === d && "00:00:00.000" ===
                        b.substr(6)) {
                        f = "week";
                        break
                    }
                ...
                c = c ? "footer" : "header";
                var d = a.series, g = d.tooltipOptions, p = g.xDateFormat, b = d.xAxis,
                ...
                return E(f, {point: a, series: d}, this.chart.time)
    ...
    (function (a) {
        var y = a.addEvent, G = a.attr, E = a.charts, h = a.color, c = a.css, r = a.defined, u = a.extend, v = a.find,
            w = a.fireEvent, n = a.isNumber, g = a.isObject, d = a.offset, m = a.pick, p = a.splat, b = a.Tooltip;
        ...
        a.Pointer.prototype = {
            init: function (a, f) {
                ...
                var b = this.chart, d = b.options.chart, l = d.zoomType || "", b = b.inverted;
                ...
                var f;
                f = a.touches ? a.touches.length ? a.touches.item(0) :
                    a.changedTouches[0] : a;
                b || (this.chartPosition = b = d(this.chart.container));
                return u(a, {chartX: Math.round(f.pageX - b.left), chartY: Math.round(f.pageY - b.top)})
                ...
                a.forEach(function (a) {
                    ...
                    a = a.searchPoint(d,
                        l);
                    if ((l = g(a, !0)) && !(l = !g(f, !0))) var l = f.distX - a.distX, c = f.dist - a.dist,
                ...
                var f = a.series, d = f.xAxis, f = f.yAxis, l = m(a.clientX, a.plotX), c = a.shapeArgs;
                if (d && f) return b ? {
                    chartX: d.len + d.pos - l, chartY: f.len +
                    f.pos - a.plotY
                } : {chartX: l + d.pos, chartY: a.plotY + f.pos};
                if (c && c.x && c.y) return {chartX: c.x, chartY: c.y}
            }, getHoverData: function (a, b, d, c, p, h, n) {
                var f, l = [], t = n && n.isBoosting;
                c = !(!c || !a);
                ...
                return {hoverPoint: f, hoverSeries: b, hoverPoints: l}
            }, runPointActions: function (b, f) {
                var d = this.chart, c = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    l = c ? c.shared : !1, g = f || d.hoverPoint, p = g && g.series || d.hoverSeries,
                    p = this.getHoverData(g, p, d.series, "touchmove" !== b.type && (!!f || p && p.directTouch && this.isDirectTouch), l, b, {isBoosting: d.isBoosting}),
                    k, g = p.hoverPoint;
                k = p.hoverPoints;
                ...
                d.axes.forEach(function (f) {
                    var d = m(f.crosshair.snap, !0), c = d ? a.find(k, function (a) {
                        return a.series[f.coll] === f
                    }) : void 0;
                    c || !d ? f.drawCrosshair(b, c) : f.hideCrosshair()
                })
            }, reset: function (a, b) {
                var f = this.chart, d = f.hoverSeries, c = f.hoverPoint, l = f.hoverPoints, g = f.tooltip,
                    k = g && g.shared ? l : c;
                ...
                b.cancelClick = !1;
                b.mouseDownX =
                    this.mouseDownX = a.chartX;
                b.mouseDownY = this.mouseDownY = a.chartY
            }, drag: function (a) {
                var b = this.chart, d = b.options.chart, c = a.chartX, l = a.chartY, g = this.zoomHor,
                    p = this.zoomVert, k = b.plotLeft, m = b.plotTop, D = b.plotWidth, B = b.plotHeight, e,
                    q = this.selectionMarker, n = this.mouseDownX, r = this.mouseDownY,
                    u = d.panKey && a[d.panKey + "Key"];
                q && q.touch || (c < k ? c = k : c > k + D && (c = k + D), l < m ? l = m : l > m + B && (l = m + B), this.hasDragged = Math.sqrt(Math.pow(n - c, 2) + Math.pow(r - l, 2)), 10 < this.hasDragged && (e = b.isInsidePlot(n - k, r - m), b.hasCartesianSeries &&
                (this.zoomX || this.zoomY) && e && !u && !q && (this.selectionMarker = q = b.renderer.rect(k, m, g ? 1 : D, p ? 1 : B, 0).attr({
                    "class": "highcharts-selection-marker",
                    zIndex: 7
                }).add(), b.styledMode || q.attr({fill: d.selectionMarkerFill || h("#335cad").setOpacity(.25).get()})), q && g && (c -= n, q.attr({
                    width: Math.abs(c),
                    x: (0 < c ? 0 : c) + n
                })), q && p && (c = l - r, q.attr({
                    height: Math.abs(c),
                ...
                var b = this, d = this.chart, l = this.hasPinched;
                if (this.selectionMarker) {
                    var g = {
                            originalEvent: a,
                            xAxis: [], yAxis: []
                        }, p = this.selectionMarker, m = p.attr ? p.attr("x") : p.x, k = p.attr ? p.attr("y") : p.y,
                        A = p.attr ? p.attr("width") : p.width, D = p.attr ? p.attr("height") : p.height, h;
                    if (this.hasDragged || l) d.axes.forEach(function (e) {
                        if (e.zoomEnabled && r(e.min) && (l || b[{xAxis: "zoomX", yAxis: "zoomY"}[e.coll]])) {
                            var f = e.horiz, d = "touchend" === a.type ? e.minPixelPadding : 0,
                                c = e.toValue((f ? m : k) + d), f = e.toValue((f ? m + A : k + D) - d);
                            g[e.coll].push({axis: e, min: Math.min(c, f), max: Math.max(c, f)});
                            h = !0
                        }
                ...
                d && n(d.index) && (c(d.container, {cursor: d._cursor}), d.cancelClick = 10 < this.hasDragged, d.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [])
                ...
                var b = this.chart, d = b.hoverPoint, c = b.plotLeft, l = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (d && this.inClass(a.target, "highcharts-tracker") ? (w(d.series, "click", u(a, {point: d})), b.hoverPoint && d.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - l) && w(b, "click", a)))
            }, setDOMEvents: function () {
                var b = this, f = b.chart.container, d = f.ownerDocument;
    ...
    (function (a) {
        var y = a.charts, G = a.extend, E = a.noop, h = a.pick;
        G(a.Pointer.prototype, {
            pinchTranslate: function (a, h, u, v, w, n) {
                ...
                var c = this.chart, p = a ? "x" : "y", b = a ? "X" : "Y", l = "chart" + b, f = a ? "width" : "height",
                    x = c["plot" + (a ? "Left" : "Top")], t, r, F = d || 1, z = c.inverted, k = c.bounds[a ? "h" : "v"],
                    A = 1 === h.length, D = h[0][l], B = u[0][l], e = !A && h[1][l], q = !A && u[1][l], L;
                u = function () {
                ...
                u();
                h = r;
                h < k.min ? (h = k.min, L = !0) : h + t > k.max && (h =
                    k.max - t, L = !0);
                ...
                var c = this, u = c.chart, v = c.pinchDown, w = a.touches, n = w.length, g = c.lastValidTouch,
                    d = c.hasZoom, m = c.selectionMarker, p = {},
                ...
                "touchstart" === a.type ? ([].forEach.call(w, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = u.bounds[a.horiz ? "h" : "v"], f = a.minPixelPadding,
                            d = a.toPixels(h(a.options.min, a.dataMin)), c = a.toPixels(h(a.options.max, a.dataMax)),
                            l = Math.max(d, c);
                        b.min = Math.min(a.pos, Math.min(d, c) - f);
                        b.max = Math.max(a.pos + a.len, l + f)
                    }
                }), c.res = !0) : c.followTouchMove && 1 === n ? this.runPointActions(c.normalize(a)) :
                    v.length && (m || (c.selectionMarker = m = G({
                        destroy: E,
                        touch: !0
                    }, u.plotBox)), c.pinchTranslate(v, w, p, m, l, g), c.hasPinched = d, c.scaleGroups(p, l), c.res && (c.res = !1, this.reset(!1, 0)))
            }, touch: function (c, r) {
                var u = this.chart, v, w;
                if (u.index !== a.hoverChartIndex) this.onContainerMouseLeave({relatedTarget: !0});
                a.hoverChartIndex = u.index;
                1 === c.touches.length ? (c = this.normalize(c), (w = u.isInsidePlot(c.chartX - u.plotLeft, c.chartY - u.plotTop)) && !u.openMenu ? (r && this.runPointActions(c), "touchmove" === c.type && (r = this.pinchDown, v = r[0] ?
                    4 <= Math.sqrt(Math.pow(r[0].chartX - c.chartX, 2) + Math.pow(r[0].chartY - c.chartY, 2)) : !1), h(v, !0) && this.pinch(c)) : r && this.reset()) : 2 === c.touches.length && this.pinch(c)
    ...
    (function (a) {
        var y = a.addEvent, G = a.charts, E = a.css, h = a.doc, c = a.extend, r = a.noop, u = a.Pointer,
            v = a.removeEvent, w = a.win, n = a.wrap;
        if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var g = {}, d = !!w.PointerEvent, m = function () {
                var b = [];
                b.item = function (a) {
                    return this[a]
                };
    ...
    (function (a) {
        var y = a.addEvent,
            G = a.css, E = a.discardElement, h = a.defined, c = a.fireEvent, r = a.isFirefox, u = a.marginNames,
            v = a.merge, w = a.pick, n = a.setAnimation, g = a.stableSort, d = a.win, m = a.wrap;
        ...
        a.Legend.prototype = {
            init: function (a, b) {
                ...
                if (!this.chart.styledMode) {
                    var d = this.options, f = a.legendItem, g = a.legendLine, p = a.legendSymbol,
                        m = this.itemHiddenStyle.color, d = b ? d.itemStyle.color : m, h = b ? a.color || m : m,
                        n = a.options && a.options.marker, k = {fill: h};
                    f && f.css({fill: d, color: d});
                    g && g.attr({stroke: h});
                ...
                var b = this.options, d = b.symbolPadding, b = !b.rtl, f = a._legendItemPos, c = f[0], f = f[1],
                    g = a.checkbox;
                ...
                var a = this.group && this.group.alignAttr, b, d = this.clipHeight || this.legendHeight,
                    f = this.titleHeight;
                a && (b = a.translateY, this.allItems.forEach(function (c) {
                    var g = c.checkbox, l;
                    g && (l = b + f + g.y + (this.scrollOffset ||
                        0) + 3, G(g, {
                ...
                d.text && (this.title || (this.title = this.chart.renderer.label(d.text, b - 3, b - 4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}), this.chart.styledMode || this.title.css(d.style), this.title.add(this.group)), a = this.title.getBBox(), f = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: f}));
                this.titleHeight = f
            }, setText: function (d) {
                var b = this.options;
                d.legendItem.attr({text: b.labelFormat ? a.format(b.labelFormat, d, this.chart.time) : b.labelFormatter.call(d)})
            }, renderItem: function (a) {
                var b = this.chart, d = b.renderer, f = this.options, c = this.symbolWidth, g = f.symbolPadding,
                    p = this.itemStyle, m = this.itemHiddenStyle,
                    h = "horizontal" === f.layout ? w(f.itemDistance, 20) : 0, k = !f.rtl, A = a.legendItem,
                    D = !a.series, B = !D && a.series.drawLegendSymbol ? a.series : a, e = B.options,
                    e = this.createCheckboxForItem && e && e.showCheckbox, h =
                    c + g + h + (e ? 20 : 0), q = f.useHTML, n = a.options.className;
                A || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + B.type + "-series highcharts-color-" + a.colorIndex + (n ? " " + n : "") + (D ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = A = d.text("", k ? c + g : -g, this.baseline || 0, q), b.styledMode || A.css(v(a.visible ? p : m)), A.attr({
                    align: k ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.baseline || (this.fontMetrics = d.fontMetrics(b.styledMode ? 12 : p.fontSize, A), this.baseline = this.fontMetrics.f +
                    3 + this.itemMarginTop, A.attr("y", this.baseline)), this.symbolHeight = f.symbolHeight || this.fontMetrics.f, B.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, A, q), e && this.createCheckboxForItem(a));
                this.colorizeItem(a, a.visible);
                !b.styledMode && p.width || A.css({width: (f.itemWidth || f.width || b.spacingBox.width) - h});
                this.setText(a);
                b = A.getBBox();
                ...
                var b = this.options, d = this.padding, f = "horizontal" === b.layout, c = a.itemHeight,
                    g = b.itemMarginBottom || 0, p = this.itemMarginTop, m = f ? w(b.itemDistance, 20) : 0, h = b.width,
            ...
            getAlignment: function () {
                ...
                var d = this.chart, f = this.options, c = this.getAlignment();
                c && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (g, l) {
                    g.test(c) && !h(a[l]) && (d[u[l]] = Math.max(d[u[l]], d.legend[(l + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][l] * f[l % 2 ? "x" : "y"] + w(f.margin, 12) + b[l] + (0 === l && void 0 !== d.options.title.margin ?
                        d.titleOffset + d.options.title.margin : 0)))
                })
            }, proximatePositions: function () {
                var d = this.chart, b = [], c = "left" === this.options.align;
                ...
                var a = this.chart, b = a.renderer, d = this.group, f, c, m, h = this.box, n = this.options,
                    z = this.padding;
                this.itemX = z;
                ...
                m += z;
                h || (this.box = h = b.rect().addClass("highcharts-legend-box").attr({r: n.borderRadius}).add(d), h.isNew = !0);
                a.styledMode || h.attr({
                    stroke: n.borderColor, "stroke-width": n.borderWidth ||
                    0, fill: n.backgroundColor || "none"
                }).shadow(n.shadow);
                ...
                this.legendWidth = f;
                this.legendHeight = m;
                c && (b = a.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) && (b = v(b, {y: b.y + a.titleOffset + a.options.title.margin})), d.align(v(n, {
                    width: f,
                    height: m,
            ...
            handleOverflow: function (a) {
                var b = this, d = this.chart, f = d.renderer, c = this.options, g = c.y, m = this.padding,
                    g = d.spacingBox.height + ("top" === c.verticalAlign ? -g : g) - m, p = c.maxHeight, h,
                    k = this.clipRect, A = c.navigation, D = w(A.animation, !0), n = A.arrowSize || 12, e = this.nav,
                    q = this.pages, r, u = this.allItems, v = function (a) {
                ...
                "horizontal" !== c.layout ||
                "middle" === c.verticalAlign || c.floating || (g /= 2);
                p && (g = Math.min(g, p));
                q.length = 0;
                a > g && !1 !== A.enabled ? (this.clipHeight = h = Math.max(g - 20 - this.titleHeight - m, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, u.forEach(function (a, b) {
                    var e = a._legendItemPos[1], d = Math.round(a.legendItem.getBBox().height), f = q.length;
                    if (!f || e - q[f - 1] > h && (r || e) !== q[f - 1]) q.push(r || e), f++;
                    a.pageIx = f - 1;
                    r && (u[b - 1].pageIx = f - 1);
                    b === u.length - 1 && e + d - q[f - 1] > h && e !== r && (q.push(e), a.pageIx = f);
                    e !== r && (r = e)
                }), k || (k = b.clipRect = f.clipRect(0,
                    m, 9999, 0), b.contentGroup.clip(k)), v(h), e || (this.nav = e = f.g().attr({zIndex: 1}).add(this.group), this.up = f.symbol("triangle", 0, 0, n, n).on("click", function () {
                    b.scroll(-1, D)
                    ...
                    b.scroll(1, D)
                }).add(e)), b.scroll(0), a = g) : e && (v(), this.nav = e.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            },
            scroll: function (a, b) {
                var d = this.pages, f = d.length;
                a = this.currentPage + a;
                var c = this.clipHeight, g = this.options.navigation, m = this.pager, p = this.padding;
                a > f && (a = f);
                0 < a && (void 0 !== b && n(b, this.chart), this.nav.attr({
                    translateX: p,
                    translateY: c + this.padding + 7 + this.titleHeight,
                    visibility: "visible"
                }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), m.attr({text: a + "/" + f}), this.down.attr({
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                var d = a.symbolHeight, f = a.options.squareSymbol;
                ...
                var b = this.options, d = b.marker, f = a.symbolWidth, c = a.symbolHeight, g = c / 2,
                    m = this.chart.renderer, p = this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                var h = {};
                this.chart.styledMode || (h = {"stroke-width": b.lineWidth || 0}, b.dashStyle && (h.dashstyle = b.dashStyle));
    ...
    (function (a) {
        var y = a.addEvent, G = a.animate, E = a.animObject, h = a.attr, c = a.doc, r =
                a.Axis, u = a.createElement, v = a.defaultOptions, w = a.discardElement, n = a.charts, g = a.css,
            d = a.defined, m = a.extend, p = a.find, b = a.fireEvent, l = a.isNumber, f = a.isObject, x = a.isString,
            t = a.Legend, H = a.marginNames, F = a.merge, z = a.objectEach, k = a.Pointer, A = a.pick, D = a.pInt,
            B = a.removeEvent, e = a.seriesTypes, q = a.splat, L = a.syncTimeout, I = a.win, R = a.Chart = function () {
        ...
        m(R.prototype, {
            callbacks: [], getArgs: function () {
                ...
                if (x(a[0]) ||
                    a[0].nodeName) this.renderTo = a.shift();
                this.init(a[0], a[1])
            }, init: function (e, d) {
                var f, k, c = e.series, g = e.plotOptions || {};
                b(this, "init", {args: arguments}, function () {
                    e.series = null;
                    f = F(v, e);
                    for (k in f.plotOptions) f.plotOptions[k].tooltip = g[k] && F(g[k].tooltip) || void 0;
                    f.tooltip.userOptions = e.chart && e.chart.forExport && e.tooltip.userOptions || e.tooltip;
                    f.series = e.series = c;
                    this.userOptions = e;
                    var q = f.chart, l = q.events;
                    this.margin = [];
                    this.spacing = [];
                    this.bounds = {h: {}, v: {}};
                ...
                b(this, "beforeRedraw");
                var d = this.axes, f = this.series, k = this.pointer, c = this.legend, g = this.userOptions.legend,
                    q = this.isDirtyLegend, l, p, A = this.hasCartesianSeries, h = this.isDirtyBox, D,
                    t = this.renderer, n = t.isHidden(), B = [];
                this.setResponsive &&
                this.setResponsive(!1);
                a.setAnimation(e, this);
                n && this.temporaryDisplay();
                this.layOutTitles();
                for (e = f.length; e--;) if (D = f[e], D.options.stacking && (l = !0, D.isDirty)) {
                    p = !0;
                    break
                }
                if (p) for (e = f.length; e--;) D = f[e], D.options.stacking && (D.isDirty = !0);
                ...
                var e, d = this.series, f;
                e = p(this.axes, b) || p(this.series, b);
                for (f = 0; !e && f < d.length; f++) e = p(d[f].points || [], b);
                return e
            }, getAxes: function () {
                var a = this, e = this.options, d = e.xAxis = q(e.xAxis || {}), e = e.yAxis = q(e.yAxis || {});
                b(this, "getAxes");
                ...
                var d = this, f = d.options, k = d.styledMode, c;
                c = f.title = F(!k && {style: {color: "#333333", fontSize: f.isStock ? "16px" : "18px"}}, f.title, a);
                f = f.subtitle = F(!k && {style: {color: "#666666"}}, f.subtitle, b);
                [["title", a, c], ["subtitle", b,
                    f]].forEach(function (a, b) {
                    var e = a[0], f = d[e], c = a[1];
                    a = a[2];
                    f && c && (d[e] = f = f.destroy());
                ...
                var b = 0, e, d = this.renderer, f = this.spacingBox;
                ["title", "subtitle"].forEach(function (a) {
                    var e = this[a], k = this.options[a];
                ...
                var b = this.options.chart, e = b.width, b = b.height, f = this.renderTo;
                d(e) || (this.containerWidth = a.getStyle(f,
                    "width"));
                ...
                var e = this.renderTo;
                if (b) for (; e && e.style;) e.hcOrigStyle && (a.css(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (c.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode; else for (; e && e.style;) {
                ...
                this.container = e = u("div", {id: p}, A, e);
                ...
                if (this.styledMode) for (t in d.defs) this.renderer.definition(d.defs[t]); else this.renderer.setStyle(f.style);
                this.renderer.chartIndex = this.index;
                b(this, "afterGetContainer")
            }, getMargins: function (a) {
                var e =
                    this.spacing, f = this.margin, k = this.titleOffset;
                this.resetMargins();
                ...
                var e =
                        this, f = e.options.chart, k = e.renderTo, g = d(f.width) && d(f.height),
                    q = f.width || a.getStyle(k, "width"), f = f.height || a.getStyle(k, "height"),
                    k = b ? b.target : I;
                ...
                !1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) :
                    (this.unbindReflow = y(I, "resize", function (a) {
                        b.reflow(a)
                    }), y(this, "destroy", this.unbindReflow))
            }, setSize: function (e, f, d) {
                var k = this, c = k.renderer, q;
                k.isResizing += 1;
                a.setAnimation(d, k);
                ...
                k.setChartSize(!0);
                c.setSize(k.chartWidth, k.chartHeight,
                    d);
                ...
                var e = this.inverted, f = this.renderer, d = this.chartWidth, k = this.chartHeight,
                    c = this.options.chart, g = this.spacing, q = this.clipOffset, l, m, p, A;
                this.plotLeft = l = Math.round(this.plotLeft);
                this.plotTop = m = Math.round(this.plotTop);
                this.plotWidth =
                    p = Math.max(0, Math.round(d - l - this.marginRight));
                ...
                this.spacingBox = f.spacingBox = {x: g[3], y: g[0], width: d - g[3] - g[1], height: k - g[0] - g[2]};
                this.plotBox = f.plotBox = {x: l, y: m, width: p, height: A};
                d = 2 * Math.floor(this.plotBorderWidth / 2);
                e = Math.ceil(Math.max(d, q[3]) / 2);
                f = Math.ceil(Math.max(d, q[0]) / 2);
                this.clipBox = {
                    x: e, y: f, width: Math.floor(this.plotSizeX - Math.max(d, q[1]) /
                        2 - e), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(d, q[2]) / 2 - f))
                };
                ...
                var a = this.options.chart, e = this.renderer, d = this.chartWidth, f = this.chartHeight,
                    k = this.chartBackground, c = this.plotBackground, g = this.plotBorder, q, l = this.styledMode,
                    m = this.plotBGImage, p = a.backgroundColor, A = a.plotBackgroundColor, h = a.plotBackgroundImage,
                    D, t = this.plotLeft, n = this.plotTop, B = this.plotWidth, x = this.plotHeight, r = this.plotBox,
                    z = this.clipRect, u = this.clipBox, v = "animate";
                k || (this.chartBackground = k = e.rect().addClass("highcharts-background").add(), v = "attr");
                if (l) q =
                    D = k.strokeWidth(); else {
                    q = a.borderWidth || 0;
                    D = q + (a.shadow ? 8 : 0);
                    p = {fill: p || "none"};
                ...
                k[v]({x: D / 2, y: D / 2, width: d - D - q % 2, height: f - D - q % 2, r: a.borderRadius});
                v = "animate";
                c || (v = "attr", this.plotBackground = c = e.rect().addClass("highcharts-plot-background").add());
                c[v](r);
                l || (c.attr({fill: A || "none"}).shadow(a.plotShadow), h && (m ? m.animate(r) : this.plotBGImage = e.image(h, t, n, B, x).add()));
                z ? z.animate({width: u.width, height: u.height}) :
                    this.clipRect = e.clipRect(u);
                v = "animate";
                g || (v = "attr", this.plotBorder = g = e.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                l || g.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                g[v](g.crisp({x: t, y: n, width: B, height: x}, -g.strokeWidth()));
                this.isDirtyBox = !1;
                b(this, "afterDrawChartBox")
            }, propFromSeries: function () {
                var a = this, b = a.options.chart, d, f = a.options.series, k, c;
                ["inverted", "angular", "polar"].forEach(function (g) {
                    d = e[b.type || b.defaultSeriesType];
                    c = b[g] ||
                        d && d.prototype[g];
                    for (k = f && f.length; !c && k--;) (d = e[f[k].type]) && d.prototype[g] && (c = !0);
                    a[g] = c
                })
            }, linkSeries: function () {
                var a = this, e = a.series;
                ...
                b.items && b.items.forEach(function (e) {
                    var d = m(b.style, e.style), f = D(d.left) + a.plotLeft, k = D(d.top) + a.plotTop + 12;
                    delete d.left;
                    delete d.top;
                    a.renderer.text(e.html, f, k).attr({zIndex: 2}).css(d).add()
                })
            }, render: function () {
                var a = this.axes, b = this.renderer, e = this.options, d, f, k;
                this.setTitle();
            ...
            addCredits: function (a) {
                ...
                var e = this, d = e.axes, f = e.series, k = e.container,
                    c, g = k && k.parentNode;
                b(e, "destroy");
                ...
                B(e);
                for (c = d.length; c--;) d[c] = d[c].destroy();
    ...
    (function (a) {
        ...
        G.prototype.applyFixed = function () {
            var y = this.container, h, c, r = !this.fixedDiv;
            r && (this.fixedDiv = a.createElement("div", {className: "highcharts-fixed"}, {
                position: "absolute",
                overflow: "hidden",
                pointerEvents: "none",
                zIndex: 2
            }, null, !0), this.renderTo.insertBefore(this.fixedDiv, this.renderTo.firstChild), this.renderTo.style.overflow =
                "visible", this.fixedRenderer = h = new a.Renderer(this.fixedDiv, 0, 0), this.scrollableMask = h.path().attr({
            ...
            r && (c = this.options.chart.scrollablePlotArea, c.scrollPositionX && (this.scrollingContainer.scrollLeft =
                this.scrollablePixels * c.scrollPositionX));
            r = this.axisOffset;
            c = this.plotTop - r[0] - 1;
            var r = this.plotTop + this.plotHeight + r[2], u = this.plotLeft + this.plotWidth - this.scrollablePixels;
            this.scrollableMask.attr({d: this.scrollablePixels ? ["M", 0, c, "L", this.plotLeft - 1, c, "L", this.plotLeft - 1, r, "L", 0, r, "Z", "M", u, c, "L", this.chartWidth, c, "L", this.chartWidth, r, "L", u, r, "Z"] : ["M", 0, 0]})
        }
    })(J);
    (function (a) {
        var y, G = a.extend, E = a.erase, h = a.fireEvent, c = a.format, r = a.isArray, u = a.isNumber, v = a.pick,
        ...
        a.Point.prototype = {
            init: function (a, c, g) {
                ...
                return this
            }, setNestedProperty: function (d, c, g) {
                ...
                var c = {}, g = this.series, b = g.options.keys, l = b || g.pointArrayMap || ["y"], f = l.length, h = 0,
                    t = 0;
                if (u(d) || null === d) c[l[0]] = d; else if (r(d)) for (!b && d.length > f && (g = typeof d[0], "string" === g ? c.name = d[0] : "number" === g && (c.x = d[0]), h++); t < f;) b && void 0 === d[h] || (0 < l[t].indexOf(".") ? a.Point.prototype.setNestedProperty(c,
                    d[h], l[t]) : c[l[t]] = d[h]), h++, t++; else "object" === typeof d && (c = d, d.dataLabels && (g._hasPointLabels = !0), d.marker && (g._hasPointMarkers = !0));
                return c
            }, getClassName: function () {
                return "highcharts-point" + (this.selected ? " highcharts-point-select" : "") + (this.negative ? " highcharts-negative" : "") + (this.isNull ? " highcharts-null-point" : "") + (void 0 !== this.colorIndex ? " highcharts-color-" + this.colorIndex : "") + (this.options.className ? " " + this.options.className : "") + (this.zone && this.zone.className ? " " + this.zone.className.replace("highcharts-negative",
                    "") : "")
            }, getZone: function () {
                var a = this.series, c = a.zones, a = a.zoneAxis || "y", g = 0, b;
                for (b = c[g]; this[a] >= b.value;) b = c[++g];
                ...
                for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], c, g = 6; g--;) c = a[g], this[c] && (this[c] = this[c].destroy());
                ...
                var d = this.series, g = d.tooltipOptions, b = v(g.valueDecimals, ""), l = g.valuePrefix || "",
                    f = g.valueSuffix || "";
                ...
                var b = this, d = this.series.options;
    ...
    (function (a) {
        var y = a.addEvent, G = a.animObject, E = a.arrayMax, h = a.arrayMin, c = a.correctFloat, r = a.defaultOptions,
            u = a.defaultPlotOptions, v = a.defined, w = a.erase, n = a.extend,
            g = a.fireEvent, d = a.isArray, m = a.isNumber, p = a.isString, b = a.merge, l = a.objectEach, f = a.pick,
            x = a.removeEvent, t = a.splat, H = a.SVGElement, F = a.syncTimeout, z = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            init: function (a, b) {
                ...
                var d = this, k, e = a.series, c;
                d.chart = a;
                d.options = b = d.setOptions(b);
                d.linkedSeries = [];
                d.bindAxes();
                n(d, {name: b.name, state: "", visible: !1 !== b.visible, selected: !0 === b.selected});
                k = b.events;
                l(k, function (a, b) {
                    y(d, b, a)
                });
            ...
            bindAxes: function () {
                var b = this, d = b.options, f = b.chart, c;
            ...
            updateParallelArrays: function (a, b) {
                var d = a.series, f = arguments, e = m(b) ? function (e) {
            ...
            autoIncrement: function () {
                var a = this.options, b = this.xIncrement, d, c = a.pointIntervalUnit,
                    e = this.chart.time, b = f(b, a.pointStart, 0);
            ...
            setOptions: function (a) {
                var d = this.chart, c = d.options, k = c.plotOptions, e = (d.userOptions || {}).plotOptions || {},
                    q = k[this.type], l = d.styledMode;
                this.userOptions = a;
                d = b(q, k.series, a);
                this.tooltipOptions =
                    b(r.tooltip, r.plotOptions.series && r.plotOptions.series.tooltip, r.plotOptions[this.type].tooltip, c.tooltip.userOptions, k.series && k.series.tooltip, k[this.type].tooltip, a.tooltip);
                ...
                a.length && v(a[a.length - 1].value) && a.push(l ? {} : {color: this.color, fillColor: this.fillColor});
                g(this, "afterSetOptions", {options: d});
                return d
            },
            getName: function () {
            ...
            getCyclic: function (a, b, d) {
                var c, e = this.chart, k = this.userOptions, g = a + "Index", l = a + "Counter",
                    m = d ? d.length : f(e.options.chart[a + "Count"],
                        e[a + "Count"]);
            ...
            updateData: function (b) {
                var d = this.options, f = this.points, c = [], e, k, g, l = this.requireSorting;
                ...
                if (e) for (b = f.length; b--;) k =
                    f[b], k.touched || k.remove(!1), k.touched = !1; else if (b.length === f.length) b.forEach(function (a, b) {
            ...
            setData: function (b, c, g, l) {
                var e = this, k = e.points, h = k && k.length || 0, A, t = e.options, n = e.chart, D = null,
                    B = e.xAxis, x = t.turboThreshold, z = this.xData, r = this.yData,
                    u = (A = e.pointArrayMap) && A.length, v;
                b = b || [];
                A = b.length;
                c = f(c, !0);
                !1 !== l && A && h && !e.cropped && !e.hasGroupedData && e.visible && !e.isSeriesBoosting &&
                (v = this.updateData(b));
                if (!v) {
                    e.xIncrement = null;
                    e.colorCounter = 0;
                    ...
                    if (x && A > x) {
                        for (g = 0; null === D && g < A;) D = b[g], g++;
                        if (m(D)) for (g = 0; g < A; g++) z[g] = this.autoIncrement(), r[g] = b[g]; else if (d(D)) if (u) for (g = 0; g < A; g++) D = b[g], z[g] = D[0], r[g] = D.slice(1, u + 1); else for (g = 0; g < A; g++) D = b[g], z[g] = D[0], r[g] = D[1]; else a.error(12, !1, n)
                    } else for (g = 0; g < A; g++) void 0 !== b[g] && (D = {series: e}, e.pointClass.prototype.applyOptions.apply(D, [b[g]]), e.updateParallelArrays(D,
                        g));
                    r && p(r[0]) && a.error(14, !0, n);
                    e.data = [];
                    e.options.data = e.userOptions.data = b;
                    for (g = h; g--;) k[g] && k[g].destroy && k[g].destroy();
            ...
            processData: function (b) {
                var d = this.xData, f = this.yData, c = d.length, e;
                e = 0;
                var k, g, l = this.xAxis, m, h = this.options;
                m = h.cropThreshold;
                var p = this.getExtremesFromAll || h.getExtremesFromAll, t = this.isCartesian, h = l && l.val2lin,
                    n = l && l.isLog, x = this.requireSorting, r, z;
                ...
                for (m = d.length || 1; --m;) c = n ? h(d[m]) - h(d[m - 1]) : d[m] - d[m - 1], 0 < c && (void 0 === g || c < g) ? g = c : 0 > c && x && (a.error(15, !1, this.chart), x = !1);
                this.cropped = k;
                this.cropStart = e;
                this.processedXData =
                    d;
            ...
            cropData: function (a, b, d, c, e) {
                var k = a.length, g = 0, l = k, m;
                e = f(e, this.cropShoulder, 1);
                for (m = 0; m < k; m++) if (a[m] >= d) {
                    g = Math.max(0, m - e);
                    break
                }
                for (d = m; d < k; d++) if (a[d] > c) {
                    l = d + e;
                    break
                }
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, d = this.data, f, e = this.processedXData, c = this.processedYData,
                    g = this.pointClass, l = e.length, m = this.cropStart || 0, h, p = this.hasGroupedData, a = a.keys,
                    x, r = [], z;
                d || p || (d = [], d.length =
                    b.length, d = this.data = d);
                a && p && (this.options.keys = !1);
                for (z = 0; z < l; z++) h = m + z, p ? (x = (new g).init(this, [e[z]].concat(t(c[z]))), x.dataGroup = this.groupMap[z], x.dataGroup.options && (x.options = x.dataGroup.options, n(x, x.dataGroup.options))) : (x = d[h]) || void 0 === b[h] || (d[h] = x = (new g).init(this, b[h], e[z])), x && (x.index = h, r[z] = x);
                this.options.keys = a;
                if (d && (l !== (f = d.length) || p)) for (z = 0; z < f; z++) z !== m || p || (z += l), d[z] && (d[z].destroyElements(), d[z].plotX = void 0);
                this.data = d;
                this.points = r
            },
            getExtremes: function (a) {
                var b =
                    this.yAxis, f = this.processedXData, c, e = [], k = 0;
                c = this.xAxis.getExtremes();
                var g = c.min, l = c.max, p, t, n = this.requireSorting ? 1 : 0, x, z;
                a = a || this.stackedYData || this.processedYData || [];
                c = a.length;
                for (z = 0; z < c; z++) if (t = f[z], x = a[z], p = (m(x, !0) || d(x)) && (!b.positiveValuesOnly || x.length || 0 < x), t = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (f[z + n] || t) >= g && (f[z - n] || t) <= l, p && t) if (p = x.length) for (; p--;) "number" === typeof x[p] && (e[k++] = x[p]); else e[k++] = x;
                this.dataMin = h(e);
                this.dataMax = E(e)
            },
            translate: function () {
                ...
                this.processData();
                this.generatePoints();
                var a = this.options, b = a.stacking, d = this.xAxis, l = d.categories, e = this.yAxis, q = this.points,
                    h = q.length, p = !!this.modifyValue, t = a.pointPlacement, n = "between" === t || m(t),
                    x = a.threshold, z = a.startFromThreshold ? x : 0, r, u, F, H, w = Number.MAX_VALUE;
                "between" === t && (t = .5);
                m(t) && (t *= f(a.pointRange || d.pointRange));
                for (a = 0; a < h; a++) {
                    var y = q[a], E = y.x, G = y.y;
                    u = y.low;
                    var J = b && e.stacks[(this.negStacks && G < (z ? 0 : x) ? "-" : "") + this.stackKey], U;
            ...
            setClip: function (a) {
                var b = this.chart, d = this.options, f = b.renderer, e = b.inverted, c = this.clipBox,
                    ...
                    l = b[g], m = b[g + "m"];
                l || (a && (k.width = 0, e && (k.x = b.plotSizeX), b[g + "m"] = m = f.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[g] = l = f.clipRect(k), l.count = {length: 0});
                a && !l.count[this.index] && (l.count[this.index] =
                    !0, l.count.length += 1);
            ...
            animate: function (a) {
                var b = this.chart, d = G(this.options.animation), f;
                a ? this.setClip(d) : (f = this.sharedClipKey, (a = b[f]) && a.animate({
                    width: b.plotSizeX,
                    x: 0
                }, d), b[f + "m"] && b[f + "m"].animate({width: b.plotSizeX + 99, x: 0}, d), this.animate =
                    null)
            },
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, d, c, e, g, l = this.options.marker, m, h, p,
                ...
                if (!1 !== l.enabled || this._hasPointMarkers) for (d = 0; d < a.length; d++) c = a[d], g = c.graphic, m = c.marker || {}, h = !!c.marker, e = x && void 0 === m.enabled || m.enabled, p = !1 !== c.isInside,
            ...
            markerAttribs: function (a, b) {
                var d = this.options.marker, c = a.marker || {}, e = c.symbol || d.symbol, k = f(c.radius, d.radius);
                b && (d = d.states[b], b = c.states && c.states[b],
                    k = f(b && b.radius, d && d.radius, k + (d && d.radiusPlus || 0)));
            ...
            pointAttribs: function (a, b) {
                var d = this.options.marker, c = a && a.options, e = c && c.marker || {}, k = this.color,
                    g = c && c.color, l = a && a.color, c = f(e.lineWidth, d.lineWidth);
                a = a && a.zone && a.zone.color;
                k = g || a || l || k;
                a = e.fillColor || d.fillColor || k;
                k = e.lineColor || d.lineColor || k;
                b && (d = d.states[b], b = e.states && e.states[b] || {}, c = f(b.lineWidth, d.lineWidth,
                    c + f(b.lineWidthPlus, d.lineWidthPlus, 0)), a = b.fillColor || d.fillColor || a, k = b.lineColor || d.lineColor || k);
                return {stroke: k, "stroke-width": c, fill: a}
            },
            destroy: function () {
                var b = this, d = b.chart, f = /AppleWebKit\/533/.test(z.navigator.userAgent), c, e, q = b.data || [],
                    m, h;
                g(b, "destroy");
                x(b);
                ...
                for (e = q.length; e--;) (m = q[e]) && m.destroy && m.destroy();
                b.points = null;
            ...
            drawGraph: function () {
                var a = this, b = this.options, d = (this.gappedPath || this.getGraphPath).call(this),
                    f = this.chart.styledMode, e = [["graph",
                        "highcharts-graph"]];
                f || e[0].push(b.lineColor || this.color, b.dashStyle);
                e = a.getZonesGraphs(e);
                e.forEach(function (e, c) {
                    var g = e[0], k = a[g];
                    k ? (k.endX = a.preventGraphAnimation ? null : d.xMap, k.animate({d: d})) : d.length && (a[g] = a.chart.renderer.path(d).addClass(e[1]).attr({zIndex: 1}).add(a.group), f || (k = {
                        stroke: e[2],
            ...
            applyZones: function () {
                var a = this, b = this.chart, d = b.renderer, c = this.zones, e, g, l = this.clips || [], m,
                    h = this.graph, p = this.area, t = Math.max(b.chartWidth, b.chartHeight),
                    n = this[(this.zoneAxis || "y") + "Axis"], x, z, r = b.inverted,
                    u, v, F, H, w = !1;
            ...
            render: function () {
                var a = this, b = a.chart, d, f = a.options,
                    ...
                    c = a.visible ? "inherit" : "hidden", l = f.zIndex, m = a.hasRendered, h = b.seriesGroup,
                    p = b.inverted;
                d = a.plotGroup("group", "series", c, l, h);
                a.markerGroup =
                    a.plotGroup("markerGroup", "markers", c, l, h);
                e && a.animate(!0);
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty ||
                    this.isDirtyData, d = this.group, c = this.xAxis, e = this.yAxis;
                d && (a.inverted && d.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), d.animate({translateX: f(c && c.left, a.plotLeft), translateY: f(e && e.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchKDTree: function (a, b) {
                function d(a, b, k, l) {
                    var m = b.point, h = f.kdAxisArray[k % l], q, p, t = m;
                    p = v(a[e]) && v(m[e]) ?
                        Math.pow(a[e] - m[e], 2) : null;
                ...
                var f = this, e = this.kdAxisArray[0], c = this.kdAxisArray[1], g = b ? "distX" : "dist";
    ...
    (function (a) {
        var y = a.Axis, G = a.Chart, E = a.correctFloat, h = a.defined, c = a.destroyObjectProperties, r = a.format,
            u = a.objectEach, v = a.pick, w = a.Series;
        ...
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var c = this.axis.chart, d = this.options, m = d.format,
                ...
                this.label.labelrank =
                    c.plotHeight
            }, setOffset: function (a, c) {
                var d = this.axis, g = d.chart, p = d.translate(d.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                    b = d.translate(0), b = h(p) && Math.abs(p - b);
                ...
                var f = c.axis.reversed, g = a.inverted;
        ...
        y.prototype.buildStacks = function () {
            var a = this.series, c = v(this.options.reversedStacks, !0), d = a.length, m;
            if (!this.isXAxis) {
                this.usePercentage =
                    !1;
        ...
        y.prototype.renderStackTotals = function () {
            var a = this.chart, c = a.renderer, d = this.stacks, m = this.stackTotalGroup;
            m || (this.stackTotalGroup = m = c.g("stack-labels").attr({visibility: "visible", zIndex: 6}).add());
        ...
        w.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var c = this.processedXData, g = this.processedYData, d = [], m = g.length, p = this.options,
                    b = p.threshold, l = v(p.startFromThreshold && b, 0), f = p.stack, p = p.stacking,
                    x = this.stackKey,
                    t = "-" + x, r = this.negStacks, u = this.yAxis, z = u.stacks, k = u.oldStacks, A, D, B, e, q, w, y;
                u.stacksTouched += 1;
                for (q = 0; q < m; q++) w = c[q], y = g[q], A = this.getStackIndicator(A, w, this.index), e = A.key, B = (D = r && y < (l ? 0 : b)) ? t : x, z[B] || (z[B] = {}), z[B][w] || (k[B] && k[B][w] ? (z[B][w] = k[B][w], z[B][w].total = null) : z[B][w] = new a.StackItem(u, u.options.stackLabels, D, w, f)), B = z[B][w], null !== y ? (B.points[e] = B.points[this.index] = [v(B.cumulative, l)], h(B.cumulative) || (B.base = e), B.touched = u.stacksTouched, 0 < A.index && !1 === this.singleStacks && (B.points[e][0] =
                    B.points[this.index + "," + w + ",0"][0])) : B.points[e] = B.points[this.index] = null, "percent" === p ? (D = D ? x : t, r && z[D] && z[D][w] ? (D = z[D][w], B.total = D.total = Math.max(D.total, B.total) + Math.abs(y) || 0) : B.total = E(B.total + (Math.abs(y) || 0))) : B.total = E(B.total + (y || 0)), B.cumulative = v(B.cumulative, l) + (y || 0), null !== y && (B.points[e].push(B.cumulative), d[q] = B.cumulative);
        ...
        w.prototype.modifyStacks = function () {
            var a = this, c = a.stackKey, d = a.yAxis.stacks, m = a.processedXData,
                h, b = a.options.stacking;
            a[b + "Stacker"] && [c, "-" + c].forEach(function (c) {
                for (var f = m.length, g, l; f--;) if (g = m[f], h = a.getStackIndicator(h, g, a.index, c), l = (g = d[c] && d[c][g]) && g.points[h.key]) a[b + "Stacker"](l, g, f)
            })
        };
        ...
        w.prototype.getStackIndicator = function (a, c, d, m) {
            !h(a) || a.x !== c || m && a.key !== m ? a = {x: c, index: 0, key: m} : a.index++;
    ...
    (function (a) {
        var y = a.addEvent,
            G = a.animate, E = a.Axis, h = a.Chart, c = a.createElement, r = a.css, u = a.defined, v = a.erase,
            w = a.extend, n = a.fireEvent, g = a.isNumber, d = a.isObject, m = a.isArray, p = a.merge, b = a.objectEach,
            l = a.pick, f = a.Point, x = a.Series, t = a.seriesTypes, H = a.setAnimation, F = a.splat;
        ...
        w(h.prototype, {
            addSeries: function (a, b, d) {
                var c, f = this;
                a && (b = l(b, !0),
                    n(f, "addSeries", {options: a}, function () {
                        c = f.initSeries(a);
                        f.isDirtyLegend = !0;
                        f.linkSeries();
                        n(f, "afterAddSeries");
            ...
            addAxis: function (a, b, d, c) {
                var f = b ? "xAxis" : "yAxis", e = this.options;
                a = p(a, {index: this[f].length, isX: b});
                b = new E(this, a);
                e[f] = F(e[f] || {});
                e[f].push(a);
                l(d, !0) && this.redraw(c);
            ...
            showLoading: function (a) {
                var b = this, d = b.options, f = b.loadingDiv, g = d.loading, e = function () {
                    f && r(f, {
                        left: b.plotLeft + "px",
                        top: b.plotTop + "px",
                ...
                f || (b.loadingDiv = f = c("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = c("span", {className: "highcharts-loading-inner"}, null, f), y(b, "redraw", e));
                f.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || d.lang.loading;
                b.styledMode || (r(f, w(g.style, {zIndex: 10})), r(b.loadingSpan, g.labelStyle), b.loadingShown || (r(f, {
                    opacity: 0,
                    display: ""
                }), G(f, {opacity: g.style.opacity || .5}, {duration: g.showDuration || 0})));
                b.loadingShown = !0;
                e()
            },
            hideLoading: function () {
                ...
                b && (b.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || G(b, {opacity: 0}, {
            ...
            update: function (d, c, f, m) {
                var k = this, e = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, h, t, x, r = [];
                n(k, "update", {options: d});
                ...
                if (h = d.chart) {
                    ...
                    if ("inverted" in
                        h || "polar" in h || "type" in h) k.propFromSeries(), t = !0;
                    "alignTicks" in h && (t = !0);
                    b(h, function (a, b) {
        ...
        w(f.prototype, {
            update: function (a, b, c, f) {
                ...
                var e = this, k = e.series,
                    h = e.graphic, m, p = k.chart, t = k.options;
                b = l(b, !0);
                !1 === f ? g() : e.firePointEvent("update", {options: a}, g)
            }, remove: function (a, b) {
        ...
        w(x.prototype, {
            addPoint: function (a, b, d, c) {
                var f = this.options, e = this.data, g = this.chart, k = this.xAxis, k = k && k.hasNames && k.names,
                    h = f.data, m, p, t = this.xData, n, x;
                b = l(b, !0);
                m = {series: this};
                this.pointClass.prototype.applyOptions.apply(m, [a]);
                x = m.x;
                n = t.length;
                if (this.requireSorting && x < t[n - 1]) for (p = !0; n && t[n - 1] > x;) n--;
                this.updateParallelArrays(m,
                    "splice", n, 0, 0);
                ...
                var c = this, f = c.data, e = f[a], g = c.points, k = c.chart, h = function () {
                ...
                var f = this, e = f.chart;
                !1 !== d ? n(f, "remove", null, c) : c()
            }, update: function (b, d) {
                b = a.cleanRecursively(b, this.userOptions);
                var c = this, f = c.chart, g = c.userOptions, e = c.oldType || c.type,
                    k = b.type || g.type || f.options.chart.type, h = t[e].prototype,
                    m, x = ["group", "markerGroup", "dataLabelsGroup"], r = ["navigatorSeries", "baseSeries"],
                    u = c.finishedAnimating && {animation: !1}, z = ["data", "name", "turboThreshold"],
                    v = Object.keys(b), F = 0 < v.length;
                ...
                if (F) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1); else {
                    ...
                    b = p(g, u, {index: c.index, pointStart: l(g.pointStart, c.xData[0])}, {data: c.options.data}, b);
                    c.remove(!1, null, !1);
                    for (m in h) c[m] = void 0;
                    t[k ||
                    e] ? w(c, t[k || e].prototype) : a.error(17, !0, f);
                    r.forEach(function (a) {
                        c[a] = r[a]
                    });
                    c.init(f, b);
        ...
        w(E.prototype, {
            update: function (a, d) {
                var c = this.chart, f = a && a.events || {};
                a = p(this.userOptions, a);
                c.options[this.coll].indexOf && (c.options[this.coll][c.options[this.coll].indexOf(this.userOptions)] =
                    a);
                b(c.options[this.coll].events, function (a, b) {
                    "undefined" === typeof f[b] && (f[b] = void 0)
                });
                this.destroy(!0);
                this.init(c, w(a, {events: f}));
                c.isDirtyBox = !0;
                l(d, !0) && c.redraw()
            }, remove: function (a) {
    ...
    (function (a) {
        var y = a.color, G = a.pick, E = a.Series, h = a.seriesType;
        h("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (c) {
                var h = [], u = [], v = this.xAxis, w = this.yAxis, n = w.stacks[this.stackKey], g = {}, d = this.index,
                    m = w.series, p = m.length, b, l = G(w.options.reversedStacks, !0) ? 1 : -1, f;
                c = c || this.points;
                if (this.options.stacking) {
                    for (f = 0; f < c.length; f++) c[f].leftNull = c[f].rightNull =
                        null, g[c[f].x] = c[f];
                    ...
                    u.forEach(function (a, c) {
                        ...
                        if (g[a] && !g[a].isNull) h.push(g[a]), [-1, 1].forEach(function (k) {
                            var h = 1 === k ? "rightNull" : "leftNull", m = 0, r = n[u[c + k]];
                            if (r) for (f = d; 0 <= f && f < p;) t = r.points[f], t || (f === d ? g[a][h] = !0 : b[f] && (x = n[a].points[f]) && (m -= x[1] - x[0])), f += l;
                            ...
                            h.push({isNull: !0, plotX: v.translate(a, 0, 0, 0, 1), x: a, plotY: m, yBottom: m})
                        }
                    })
                }
                return h
            }, getGraphPath: function (a) {
                var c = E.prototype.getGraphPath, h = this.options, v = h.stacking, w = this.yAxis, n, g, d = [],
                    m = [], p = this.index, b, l = w.stacks[this.stackKey], f = h.threshold,
                    x = w.getThreshold(h.threshold), t, h = h.connectNulls || "percent" === v, H = function (c, g, k) {
                        var h = a[c];
                        c = v && l[h.x].points[p];
                        var t = h[k + "Null"] || 0;
                        k = h[k + "Cliff"] || 0;
                        var n, e, h = !0;
                        k || t ? (n = (t ? c[0] : c[1]) + k, e = c[0] + k, h = !!t) : !v && a[g] && a[g].isNull &&
                            (n = e = f);
                        void 0 !== n && (m.push({
                            plotX: b,
                            ...
                            isNull: h,
                            isCliff: !0
                        }), d.push({plotX: b, plotY: null === e ? x : w.getThreshold(e), doCurve: !1}))
                    };
                a = a || this.points;
                v && (a = this.getStackPoints(a));
                for (n = 0; n < a.length; n++) if (g = a[n].isNull, b = G(a[n].rectPlotX, a[n].plotX), t = G(a[n].yBottom, x), !g || h) h || H(n, n - 1, "left"), g && !v && h || (m.push(a[n]), d.push({
                    x: n,
                    plotX: b,
                    plotY: t
                })), h || H(n, n + 1, "right");
                ...
                var a = this, h = this.areaPath, u = this.options,
                ...
                v.forEach(function (c) {
                    var n = c[0], g = a[n];
                    g ? (g.endX = a.preventGraphAnimation ? null : h.xMap, g.animate({d: h})) : (g = {zIndex: 0}, a.chart.styledMode ||
                    (g.fill = G(c[3], y(c[2]).setOpacity(G(u.fillOpacity, .75)).get())), g = a[n] = a.chart.renderer.path(h).addClass(c[1]).attr(g).add(a.group), g.isArea = !0);
                    g.startX = h.xMap;
    ...
    (function (a) {
        ...
        a = a.seriesType;
        a("spline", "line", {}, {
            getPointSpline: function (a, E, h) {
                var c = E.plotX, r = E.plotY, u = a[h - 1];
                h = a[h + 1];
                var v, w, n, g;
    ...
    (function (a) {
        var y = a.seriesTypes.area.prototype, G = a.seriesType;
        G("areaspline",
    ...
    (function (a) {
        var y = a.animObject, G = a.color, E = a.extend, h = a.defined, c = a.isNumber, r = a.merge, u = a.pick,
            v = a.Series, w = a.seriesType, n = a.svg;
        w("column", "line", {
            borderRadius: 0,
            crisp: !0,
            groupPadding: .2,
            ...
            getColumnMetrics: function () {
                var a = this, d = a.options, c = a.xAxis, h = a.yAxis, b =
                    c.options.reversedStacks, b = c.reversed && !b || !c.reversed && b, l, f = {}, n = 0;
                !1 === d.grouping ? n = 1 : a.chart.series.forEach(function (b) {
                    var d = b.options, c = b.yAxis, g;
                ...
                var t = Math.min(Math.abs(c.transA) * (c.ordinalSlope || d.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                    r = t * d.groupPadding, v = (t - 2 * r) / (n ||
                    1), d = Math.min(d.maxPointWidth || c.len, u(d.pointWidth, v * (1 - 2 * d.pointPadding)));
                a.columnMetrics = {
                    width: d,
            ...
            crispCol: function (a, d, c, h) {
                var b = this.chart, g = this.borderWidth, f = -(g % 2 ? .5 : 0), g = g % 2 ? .5 : 1;
                ...
                h -= d;
                f && h && (--d, h += 1);
                return {x: a, y: d, width: c, height: h}
            },
            translate: function () {
                var a =
                        this, d = a.chart, c = a.options, p = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
                    p = a.borderWidth = u(c.borderWidth, p ? 0 : 1), b = a.yAxis, l = c.threshold,
                    f = a.translatedThreshold = b.getThreshold(l), n = u(c.minPointLength, 5), t = a.getColumnMetrics(),
                    r = t.width, F = a.barW = Math.max(r, 1 + 2 * p), z = a.pointXOffset = t.offset;
                d.inverted && (f -= .5);
                c.pointPadding && (F = Math.ceil(F));
                v.prototype.translate.apply(a);
                a.points.forEach(function (c) {
                    var g = u(c.yBottom, f), k = 999 + Math.abs(g), m = r,
                        k = Math.min(Math.max(-k, c.plotY), b.len + k), e = c.plotX + z, q = F,
                        p = Math.min(k, g), t, x = Math.max(k, g) - p;
            ...
            pointAttribs: function (a, d) {
                var c = this.options, g, b = this.pointAttrToOptions || {};
                g = b.stroke || "borderColor";
                var l = b["stroke-width"] || "borderWidth", f = a && a.color || this.color,
                    h = a && a[g] || c[g] || this.color || f, t = a && a[l] || c[l] || this[l] || 0, b = c.dashStyle;
                a && this.zones.length && (f = a.getZone(), f = a.options.color || f && f.color || this.color);
                d && (a = r(c.states[d], a.options.states &&
                    a.options.states[d] || {}), d = a.brightness, f = a.color || void 0 !== d && G(f).brighten(a.brightness).get() || f, h = a[g] || h, t = a[l] || t, b = a.dashStyle || b);
                g = {fill: f, stroke: h, "stroke-width": t};
                b && (g.dashstyle = b);
                return g
            },
            drawPoints: function () {
                var a = this, d = this.chart, h = a.options, p = d.renderer, b = h.animationLimit || 250, l;
                a.points.forEach(function (f) {
                    var g = f.graphic, m = g && d.pointCount < b ? "animate" : "attr";
                    if (c(f.plotY) && null !== f.y) {
                        l = f.shapeArgs;
                        if (g) g[m](r(l)); else f.graphic = g = p[f.shapeType](l).add(f.group || a.group);
                        h.borderRadius &&
                        g.attr({r: h.borderRadius});
            ...
            animate: function (a) {
                var d = this, c = this.yAxis, g = d.options, b = this.chart.inverted, h = {},
                    f = b ? "translateX" : "translateY", x;
                n && (a ? (h.scaleY = .001, a = Math.min(c.pos + c.len, Math.max(c.pos, c.toPixels(g.threshold))), b ? h.translateX = a - c.len : h.translateY = a, d.group.attr(h)) : (x = d.group.attr(f), d.group.animate({scaleY: 1},
    ...
    (function (a) {
        var y = a.deg2rad, G = a.isNumber, E = a.pick, h = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, r = this.chart, u = 2 * (a.slicedOffset || 0), v = r.plotWidth - 2 * u,
                    r = r.plotHeight - 2 * u, w = a.center,
                    w = [E(w[0], "50%"), E(w[1], "50%"), a.size || "100%", a.innerSize || 0], n = Math.min(v, r), g, d;
                for (g = 0; 4 > g; ++g) d = w[g], a = 2 > g || 2 === g && /%$/.test(d), w[g] = h(d, [v, r, n, w[2]][g]) + (a ? u : 0);
                w[3] > w[2] && (w[3] = w[2]);
                return w
            }, getStartAndEndRadians: function (a, h) {
                a = G(a) ? a : 0;
                h = G(h) && h > a && 360 > h - a ? h : a + 360;
                return {start: y * (a + -90), end: y * (h + -90)}
            }
        }
    })(J);
    (function (a) {
        var y = a.addEvent, G = a.CenteredSeriesMixin, E = a.defined, h = a.extend, c = G.getStartAndEndRadians,
            r = a.noop, u = a.pick, v = a.Point, w = a.Series, n = a.seriesType,
            g = a.setAnimation;
        n("pie", "line", {
            center: [null, null],
            clip: !1,
            ...
            animate: function (a) {
                var d = this, c = d.points, b = d.startAngleRad;
                a || (c.forEach(function (a) {
                    var c = a.graphic, g = a.shapeArgs;
                    c && (c.attr({r: a.startR || d.center[3] / 2, start: b, end: b}), c.animate({
                        r: g.r,
                        start: g.start,
                        end: g.end
                    }, d.options.animation))
            ...
            updateTotals: function () {
                var a, c = 0, g = this.points, b = g.length, h, f = this.options.ignoreHiddenPoint;
                for (a = 0; a < b; a++) h = g[a], c += f && !h.visible ? 0 : h.isNull ? 0 : h.y;
                this.total = c;
                for (a = 0; a < b; a++) h = g[a], h.percentage = 0 < c && (h.visible || !f) ? h.y / c * 100 : 0, h.total = c
            },
            generatePoints: function () {
            ...
            getX: function (a, c, g) {
                var b = this.center, d = this.radii ? this.radii[g.index] : b[2] / 2;
            ...
            translate: function (a) {
                this.generatePoints();
                var d = 0, g = this.options, b = g.slicedOffset, h = b + (g.borderWidth || 0), f, n,
                    t = c(g.startAngle, g.endAngle), r = this.startAngleRad = t.start,
                    t = (this.endAngleRad = t.end) - r, v = this.points, z, k, A = g.dataLabels.distance,
                    g = g.ignoreHiddenPoint, w, B = v.length, e;
                ...
                for (w = 0; w < B; w++) {
                    ...
                    e.labelPosition = {
                        natural: {
                            x: a[0] + z + Math.cos(n) * e.labelDistance, y: a[1] + k +
                            Math.sin(n) * e.labelDistance
                        },
                        "final": {},
                        alignment: 0 > e.labelDistance ? "center" : e.half ? "right" : "left",
                        connectorPosition: {
                            breakAt: {x: a[0] + z + Math.cos(n) * f, y: a[1] + k + Math.sin(n) * f},
                            touchingSliceAt: {x: a[0] + z, y: a[1] + k}
                        }
                    }
                }
            },
            drawGraph: null,
            drawPoints: function () {
                var a = this, c = a.chart, g = c.renderer, b, l, f, n, t = a.options.shadow;
                ...
                a.points.forEach(function (d) {
                    ...
                    if (d.isNull) l && (d.graphic = l.destroy()); else {
                        ...
                        l ? (l.setRadialReference(a.center), c.styledMode || l.attr(f), l.animate(h(n, b))) : (d.graphic = l = g[d.shapeType](n).setRadialReference(a.center).attr(b).add(a.group), c.styledMode || l.attr(f).attr({"stroke-linejoin": "round"}).shadow(t, m));
                        l.attr({visibility: d.visible ? "inherit" : "hidden"});
            ...
            init: function () {
                ...
                var d = this, b = d.series, g = b.chart, f = b.options.ignoreHiddenPoint;
                c = u(c, f);
                a !== d.visible && (d.visible = d.options.visible =
                    a = void 0 === a ? !d.visible : a, b.options.data[b.data.indexOf(d)] = d.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function (b) {
                ...
                fixedOffset: function (a, c, g) {
                    var b = c.breakAt;
                    c = c.touchingSliceAt;
                    return ["M", a.x, a.y].concat(g.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 *
                    b.x - c.x, 2 * b.y - c.y, b.x, b.y] : ["L", b.x, b.y]).concat(["L", c.x, c.y])
                }, straight: function (a, c) {
                    c = c.touchingSliceAt;
                    return ["M", a.x, a.y, "L", c.x, c.y]
                }, crookedLine: function (d, c, g) {
                    c = c.touchingSliceAt;
                    var b = this.series, h = b.center[0], f = b.chart.plotWidth, m = b.chart.plotLeft, b = d.alignment,
                        t = this.shapeArgs.r;
    ...
    (function (a) {
        var y = a.addEvent, G = a.arrayMax, E = a.defined, h = a.extend, c = a.format, r = a.merge, u = a.noop,
            v = a.pick, w = a.relativeLength, n = a.Series, g = a.seriesTypes, d = a.stableSort, m = a.isArray,
            p = a.splat;
        a.distribute = function (b, c, f) {
            ...
            var n = m.reducedLen ||
                c;
            for (h = b.length; h--;) k += b[h].size;
            if (k > n) {
                d(b, function (a, b) {
                    return (b.rank || 0) - (a.rank || 0)
                });
                for (k = h = 0; k <= n;) k += b[h].size, h++;
            ...
            for (b = b.map(function (a) {
                ...
                for (h = b.length; h--;) l = b[h], k = (Math.min.apply(0, l.targets) + Math.max.apply(0, l.targets)) / 2, l.pos = Math.min(Math.max(0, k - l.size * l.align), c - l.size);
                h = b.length;
                for (l = !1; h--;) 0 < h && b[h - 1].pos + b[h - 1].size > b[h].pos && (b[h - 1].size += b[h].size, b[h - 1].targets = b[h - 1].targets.concat(b[h].targets),
                    b[h - 1].align = .5, b[h - 1].pos + b[h - 1].size > c && (b[h - 1].pos = c - b[h - 1].size), b.splice(h, 1), l = !0)
            }
            m.push.apply(m, p);
            h = 0;
            b.some(function (b) {
        ...
        n.prototype.drawDataLabels = function () {
            ...
            function d(a, b) {
                ...
                if (m(a) && !m(b)) c = a.map(function (a) {
                    ...
                    return r(a, b)
                }); else if (m(a) || m(b)) for (d = Math.max(a.length, b.length); d--;) c[d] = r(a[d], b[d]); else c = r(a, b);
                return c
            }

            var f = this, g = f.chart, h = f.options, n = h.dataLabels, u = f.points, z, k = f.hasRendered || 0, A,
                w = v(n.defer, !!h.animation), B = g.renderer,
            ...
            if (m(n) || n.enabled || f._hasPointLabels) A = f.plotGroup("dataLabelsGroup", "data-labels", w && !k ? "hidden" : "visible", n.zIndex || 6), w && (A.attr({opacity: +k}), k || y(f, "afterAnimate", function () {
                f.visible && A.show(!0);
                A[h.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), u.forEach(function (e) {
                z =
                    p(d(n, e.dlOptions || e.options && e.options.dataLabels));
                z.forEach(function (d, k) {
                    var l = d.enabled && !e.isNull && b(e, d), m, q, t, p,
                        n = e.dataLabels ? e.dataLabels[k] : e.dataLabel,
                        r = e.connectors ? e.connectors[k] : e.connector, u = !n;
                    l && (m = e.getLabelConfig(), q = d[e.formatPrefix + "Format"] || d.format, m = E(q) ? c(q, m, g.time) : (d[e.formatPrefix + "Formatter"] || d.formatter).call(m, d), q = d.style, t = d.rotation, g.styledMode || (q.color = v(d.color, q.color, f.color, "#000000"), "contrast" === q.color && (e.contrastColor = B.getContrast(e.color || f.color),
                        q.color = d.inside || 0 > v(d.distance, e.labelDistance) || h.stacking ? e.contrastColor : "#000000"), h.cursor && (q.cursor = h.cursor)), p = {
                        r: d.borderRadius || 0,
                        rotation: t,
                        padding: d.padding,
                        zIndex: 1
                    ...
                    !n || l && E(m) ? l && E(m) && (n ? p.text = m : (e.dataLabels = e.dataLabels || [], n = e.dataLabels[k] = t ? B.text(m, 0, -9999).addClass("highcharts-data-label") : B.label(m, 0, -9999, d.shape, null,
        ...
        n.prototype.alignDataLabel = function (a, d, c, g, m) {
            var b = this.chart, f = this.isCartesian && b.inverted, l = v(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                k = v(a.plotY, -9999), n = d.getBBox(), p, t = c.rotation, e = c.align,
            ...
            if (q && (p = b.renderer.fontMetrics(b.styledMode ? void 0 : c.style.fontSize,
                d).b, g = h({
                ...
                y: g.y + c.y + {top: 0, middle: .5, bottom: 1}[c.verticalAlign] * g.height
            }, d[m ? "attr" : "animate"](l).attr({align: e}), k = (t + 720) % 360, k = 180 < k && 360 > k, "left" === e ? l.y -= k ? n.height : 0 : "center" === e ? (l.x -= n.width / 2, l.y -= n.height / 2) : "right" === e && (l.x -= n.width, l.y -= k ? 0 : n.height), d.placed = !0, d.alignAttr = l) : (d.align(c, null, g), l = d.alignAttr),
                r && 0 <= g.height ? a.isLabelJustified = this.justifyDataLabel(d, c, l, n, g, m) : v(c.crop, !0) && (q = b.isInsidePlot(l.x, l.y) && b.isInsidePlot(l.x + n.width, l.y + n.height)), c.shape && !t)) d[m ? "attr" : "animate"]({
                anchorX: f ? b.plotWidth - a.plotY : a.plotX,
                anchorY: f ? b.plotHeight - a.plotX : a.plotY
            });
            q || (d.attr({y: -9999}), d.placed = !1)
        };
        n.prototype.justifyDataLabel = function (a, d, c, g, h, m) {
            var b = this.chart, f = d.align, k = d.verticalAlign, l, n, p = a.box ? 0 : a.padding || 0;
            l = c.x + p;
            0 > l && ("right" === f ? d.align = "left" : d.x = -l, n = !0);
            l = c.x + g.width - p;
            l > b.plotWidth &&
            ("left" === f ? d.align = "right" : d.x = b.plotWidth - l, n = !0);
            l = c.y + p;
        ...
        g.pie && (g.pie.prototype.dataLabelPositioners = {
            ...
            var b = this, d = b.data, c, g = b.chart, h = b.options.dataLabels, m = h.connectorPadding,
                p = v(h.connectorWidth, 1), r = g.plotWidth, k = g.plotHeight, u = g.plotLeft,
                w = Math.round(g.chartWidth / 3), B, e = b.center, q = e[2] / 2, y = e[1], I, J, K, M, S = [[], []], C,
                N, P, T, Q =
                    [0, 0, 0, 0], O = b.dataLabelPositioners;
            b.visible && (h.enabled || b._hasPointLabels) && (d.forEach(function (a) {
                ...
                if (p) for (b.sortByAngle(d, f - .5), 0 < b.maxLabelDistance && (l = Math.max(0, y - q - b.maxLabelDistance), n = Math.min(y + q + b.maxLabelDistance, g.plotHeight), d.forEach(function (a) {
                    0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, y - q - a.labelDistance), a.bottom = Math.min(y + q + a.labelDistance, g.plotHeight), x = a.dataLabel.getBBox().height ||
                        21, a.distributeBox = {
                    ...
                    if (h.justify) C = O.justify(c, q, e); else switch (h.alignTo) {
                        ...
                        case "plotEdges":
                            C =
                                O.alignToPlotEdges(I, f, r, u);
                            break;
                        default:
                            C = O.radialDistributionX(b, c, N, l)
                    }
                    I._attr = {visibility: P, align: K.alignment};
                    I._pos = {x: C + h.x + ({left: m, right: -m}[K.alignment] || 0), y: N + h.y - 10};
                    K.final.x = C;
                    K.final.y = N;
            ...
            }), 0 === G(Q) || this.verifyDataLabelOverflow(Q)) &&
            ...
            var b =
                this.center, d = this.options, c = d.center, g = d.minSize || 80, h, m = null !== d.size;
        ...
        g.column && (g.column.prototype.alignDataLabel = function (a, d, c, g, h) {
            var b =
                    this.chart.inverted, f = a.series, l = a.dlBox || a.shapeArgs,
            ...
            c.verticalAlign = v(c.verticalAlign, b || m ? "middle" : k ? "top" :
                "bottom");
    ...
    (function (a) {
        var y = a.Chart, G = a.isArray, E = a.objectEach, h = a.pick, c = a.addEvent, r = a.fireEvent;
        c(y, "render", function () {
            var a = [];
        ...
        y.prototype.hideOverlappingLabels = function (a) {
            var c = this, h = a.length, n = c.renderer, g, d, m, p, b, l, f = function (a, b, c, d, f, g, h, l) {
                return !(f > a + c || f + h < a || g > b + d || g + l < b)
            };
            m = function (a) {
                var b,
                    c, d, f = a.box ? 0 : a.padding || 0;
                d = 0;
            ...
            for (d = 0; d < h; d++) if (g = a[d]) g.oldOpacity = g.opacity, g.newOpacity = 1, g.absoluteBox = m(g);
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (d = 0; d < h; d++) for (l = (m = a[d]) && m.absoluteBox,
                                             g = d + 1; g < h; ++g) if (b = (p = a[g]) && p.absoluteBox, l && b && m !== p && 0 !== m.newOpacity && 0 !== p.newOpacity && (b = f(l.x, l.y, l.width, l.height, b.x, b.y, b.width, b.height))) (m.labelrank < p.labelrank ? m : p).newOpacity = 0;
            a.forEach(function (a) {
                var b, d;
    ...
    (function (a) {
        var y = a.addEvent, G = a.Chart,
            E = a.createElement, h = a.css, c = a.defaultOptions, r = a.defaultPlotOptions, u = a.extend,
            v = a.fireEvent, w = a.hasTouch, n = a.isObject, g = a.Legend, d = a.merge, m = a.pick, p = a.Point,
            b = a.Series, l = a.seriesTypes, f = a.svg, x;
        x = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                a.points.forEach(function (a) {
                    ...
                    a.dataLabel && (a.dataLabel.div ? a.dataLabel.div.point = a : a.dataLabel.element.point =
                        a)
                });
                a._hasTracking || (a.trackerGroups.forEach(function (f) {
                    if (a[f]) {
                        ...
                        !b.styledMode && a.options.cursor && a[f].css(h).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking = !0);
                v(this, "afterDrawTracker")
            }, drawTrackerGraph: function () {
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                    g = d.length, h = a.chart, l = h.pointer, m = h.renderer, e = h.options.tooltip.snap,
                    q = a.tracker, p, n = function () {
                        if (h.hoverSeries !== a) a.onMouseOver()
                    }, r = "rgba(192,192,192," + (f ? .0001 : .002) + ")";
                if (g && !c) for (p = g + 1; p--;) "M" === d[p] && d.splice(p + 1, 0, d[p + 1] - e, d[p + 2], "L"), (p && "M" === d[p] || p === g) && d.splice(p, 0, "L", d[p - 2] + e, d[p - 1]);
                q ? q.attr({d: d}) : a.graph && (a.tracker = m.path(d).attr({
                    ...
                    "stroke-linejoin": "round", stroke: r, fill: c ? r : "none", "stroke-width": a.graph.strokeWidth() +
                    (c ? 0 : 2 * e)
        ...
        u(g.prototype, {
            setItemEvents: function (a, b, c) {
                var f =
                        this, g = f.chart.renderer.boxWrapper,
        ...
        u(G.prototype, {
            showResetZoom: function () {
                ...
                var b = this, d = c.lang, f = b.options.chart.resetZoomButton, g = f.theme, h =
                    g.states, l = "chart" === f.relativeTo ? null : "plotBox";
                ...
                ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                    b = c[b ? "xAxis" : "yAxis"][0];
                    var d = b.horiz, g = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", e = c[d],
                        h = (b.pointRange ||
                            0) / 2, k = b.reversed && !c.inverted || !b.reversed && c.inverted ? -1 : 1,
                        l = b.getExtremes(), m = b.toValue(e - g, !0) + h * k, k = b.toValue(e + b.len - g, !0) - h * k,
                        p = k < m, e = p ? k : m, m = p ? m : k,
                    ...
                    p = m - h;
                    0 < p && (m = h, e -= p);
                    b.series.length && e !== l.min && m !== l.max && (b.setExtremes(e, m, !1, !1, {trigger: "pan"}), f = !0);
                    c[d] = g
                });
                f && c.redraw(!1);
        ...
        u(p.prototype,
            {
                select: function (a, b) {
                    ...
                    var c = Math.floor(this.plotX), d = this.plotY, f = this.series,
                        g = f.options.states[a || "normal"] || {}, h = r[f.type].marker && f.options.marker,
                        l = h && !1 === h.enabled, e = h && h.states && h.states[a || "normal"] || {},
                        p = !1 === e.enabled, n = f.stateMarkerGraphic, t = this.marker || {}, w = f.chart, x = f.halo,
                        y, E = h && f.markerAttribs;
                    a = a || "";
                    if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (p || l && !1 === e.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                        ...
                        a && this.graphic.addClass("highcharts-point-" + a), w.styledMode || this.graphic.animate(f.pointAttribs(this, a), m(w.options.chart.animation, g.animation)), y && this.graphic.animate(y, m(w.options.chart.animation, e.animation, h.animation)), n && n.hide(); else {
                            if (a && e) {
                                h = t.symbol || f.symbol;
                                ...
                                !w.styledMode && n && n.attr(f.pointAttribs(this,
                                    a))
                            }
                            n && (n[a && w.isInsidePlot(c, d, w.inverted) ? "show" : "hide"](), n.element.point = this)
                        }
                        (c = g.halo) && c.size ? (x || (f.halo = x = w.renderer.path().add((this.graphic || n).parentGroup)), x.show()[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), x.attr({
                        ...
                        }, c.attributes))) : x && x.point && x.point.haloPath && x.animate({d: x.point.haloPath(0)},
                            null, x.hide);
                        this.state = a;
    ...
    (function (a) {
        var y = a.Chart, G = a.isArray, E = a.isObject, h = a.pick, c = a.splat;
        y.prototype.setResponsive = function (c) {
            var h = this.options.responsive, r = [], w = this.currentResponsive;
            ...
            r !== (w && w.ruleIds) && (w && this.update(w.undoOptions, c), r ? (this.currentResponsive = {
                ruleIds: r,
                mergedOptions: n, undoOptions: this.currentOptions(n)
        ...
        y.prototype.currentOptions = function (h) {
            function r(h, n, g, d) {
                ...
                a.objectEach(h, function (a, b) {
                    if (!d && -1 < ["series",
                        "xAxis", "yAxis"].indexOf(b)) for (a = c(a), g[b] = [], m = 0; m < a.length; m++) n[b][m] && (g[b][m] = {}, r(a[m], n[b][m], g[b][m], d + 1)); else E(a) ? (g[b] = G(a) ? [] : {}, r(a, n[b] || {}, g[b], d + 1)) : g[b] = n[b] || null
                })
            }
