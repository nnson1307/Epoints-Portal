      ...
      success: function (result) {
        if (Object.keys(result).length === 0) {
          $(obj)
            .closest("tr")
            .find($(".object_price"))
            .val(formatNumber(Number(0).toFixed(decimal_number)));
          $(obj)
            .closest("tr")
            .find($(".object_amount"))
            .val(formatNumber(Number(0).toFixed(decimal_number)));
          ...
          if (object_type == "product") {
            ...
            $(obj)
              ...
              .val(
                formatNumber(
                  Number(amount > 0 ? amount : 0).toFixed(decimal_number)
                )
              );
            ...
            $(obj)
              ...
              .val(
                formatNumber(
                  Number(result.price_standard).toFixed(decimal_number)
                )
              );
            $(obj).closest("tr").find(".object_quantity").val(1);
