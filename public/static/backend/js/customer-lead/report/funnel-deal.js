var funnel = {
    chartLead : function (){
        ...
        $.ajax({
            url: laroute.route('customer-lead.report.getDataChartDeal'),
            method: 'POST',
            dataType: 'JSON',
    ...
    tableLeadSearch : function (page = 1){
        $.ajax({
            url: laroute.route('customer-lead.report.tableDealSearch'),
            method: 'POST',
            dataType: 'JSON',
    ...
    tableSourceSearch : function (page = 1){
        $.ajax({
            url: laroute.route('customer-lead.report.tableSourceSearchDeal'),
            method: 'POST',
            dataType: 'JSON',
            data: $('#search-report').serialize()+'&page='+page,
            success: function (res) {
