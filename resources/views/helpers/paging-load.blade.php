    ...
    <div class="m-datatable__pager m-datatable--paging-loaded clearfix">
    	@if ($paginator->hasPages())
            <ul class="m-datatable__pager-nav" style="float: right">
                ...
                @else
                    <li><a href="{{ \Request::url()}}" title="First" class="m-datatable__pager-link m-datatable__pager-link--first" data-page="1"><i class="la la-angle-double-left"></i></a></li>
                ...
                @else
                    ...
                    <li><a href="{{ \Request::url().'?page='.$paginator->lastPage() }}" title="Last" class="m-datatable__pager-link m-datatable__pager-link--last" data-page="{{ $paginator->lastPage() }}"><i class="la la-angle-double-right"></i></a></li>
                @endif
            </ul>
        @endif
