...
<script src="{{asset('static/backend/js/on-call/popup-calling/script.js?v='.time())}}" type="text/javascript"></script>
...
<head>
    ...
    <script type="text/javascript" id="zsiqchat">var $zoho = $zoho || {};
        $zoho.salesiq = $zoho.salesiq || {
            widgetcode: "a714fe1f96e5f84ed851ae3caae2623c1950ae356a1e3478d4911b6c8c033325",
            values: {},
            ready: function () {
            }
        };
...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <!-- BEGIN: Header -->
    @include('components.inc.header-full')
...
--}}
    ...
    <!-- begin::Call Center -->
    <div id="modal-call-center-search"></div>
...
<script>
    $(document).ready(function () {
        ...
        //     });
        // }
        if (!localStorage.getItem('numberNotiChatHub')) {
            var numberNotiChatHub = localStorage.getItem('numberNotiChatHub');
            if (numberNotiChatHub > 0) {
                $(".chathub_inbox")
                    .find(".noti-chathub")
                    .html(numberNotiChatHub)
                    .css("display", "block");
            } else {
                $(".chathub_inbox")
                    .find(".noti-chathub")
...
<script src="{{ asset('static/backend/js/chathub/inbox/index.js?v=' . time()) }}"
        type="text/javascript"></script>
...
<script src="{{ asset('static/backend/js/call-center/script.js?v=' . time()) }}"
        type="text/javascript"></script>
...
//     var pusher = new Pusher('c812da9a676fe9408f79', {
//         cluster: 'ap1'
//     });
//     var channel = pusher.subscribe('qc-chathub');
//     channel.bind('push-notification', function (data) {
//         console.log('notification-in', JSON.stringify(data));
//         if (data.totalNotification > 0) {
//             localStorage.setItem('numberNotiChatHub', data.totalNotification);
//             $(".chathub_inbox")
//                 .find(".noti-chathub")
//                 .html(data.totalNotification)
//                 .css("display", "block");
//         } else {
//             $(".chathub_inbox")
//                 .find(".noti-chathub")
